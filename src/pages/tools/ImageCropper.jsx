...
import { Upload, Download, RefreshCw, ZoomIn, Info, Image as ImageIcon, Move, Maximize } from 'lucide-react'
...
const ImageCropper = () => {
    ...
    return (
        <>
            <Helmet>
                <title>Image Cropper - Free Online Image Cropping Tool</title>
                <meta name="description" content="Free online image cropper. Crop JPG, PNG, and WebP images to exact pixel dimensions. Live preview and custom aspect ratios." />
            </Helmet>

            <div className="container" style={{ padding: '3rem 1.5rem' }}>
                <div style={{ maxWidth: '1200px', margin: '0 auto' }}>
                    <header style={{ marginBottom: '2rem', textAlign: 'center' }}>
                        <h1 style={{ fontSize: '2.5rem', fontWeight: '800', marginBottom: '0.5rem' }}>Image Cropper</h1>
                        <p style={{ color: '#64748b' }}>Crop your images to any size or aspect ratio.</p>
                    </header>
