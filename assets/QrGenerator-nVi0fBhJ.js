import { r as _, j as u } from "./index-BtmU1OS0.js";
import { R as Pe } from "./RelatedTools-GVPazTWJ.js";
import { T as Me } from "./ToolLayout-CgcEif7J.js";
import { D as he } from "./download-Cb6qc09_.js";
import { Z as Le } from "./zap-DZ5cj3rv.js";
import { o as je } from "./tools-DOXC7sEs.js";
...
S.getSymbolSize = function(e) {
  if (!e) throw new Error('"version" cannot be null or undefined');
  if (e < 1 || e > 40) throw new Error('"version" should be in range from 1 to 40');
  return e * 4 + 17;
};
S.getSymbolTotalCodewords = function(e) {
  return Ue[e];
};
S.getBCHDigit = function(t) {
  let e = 0;
  for (; t !== 0; ) e++, t >>>= 1;
  return e;
};
S.setToSJISFunction = function(e) {
...
(function(t) {
  const e = S, i = O, o = Q, n = P, r = ce, s = 7973, l = e.getBCHDigit(s);
  function a(p, h, y) {
...
var Se = {};
const oe = S, xe = 1335, Oe = 21522, ge = oe.getBCHDigit(xe);
Se.getEncodedBits = function(e, i) {
  const o = e.bit << 3 | i;
  let n = o << 10;
  for (; oe.getBCHDigit(n) - ge >= 0; ) n ^= xe << oe.getBCHDigit(n) - ge;
  return (o << 10 | n) ^ Oe;
};
var Ne = {};
const Ye = P;
...
var rt = Ie.exports;
(function(t) {
  const e = P, i = Ge, o = Xe, n = et, r = ot, s = I, l = S, a = rt;
  function d(m) {
  ...
  function C(m) {
    ...
    let f, E;
    return l.isKanjiModeEnabled() ? (f = c(s.BYTE, e.BYTE, m), E = c(s.KANJI, e.KANJI, m)) : (f = c(s.BYTE_KANJI, e.BYTE, m), E = []), b.concat(g, f, E).sort(function(v, x) {
      return v.index - x.index;
    }).map(function(v) {
  ...
  function w(m, b) {
    ...
    for (let B = 0; B < m.length; B++) {
      ...
      for (let A = 0; A < v.length; A++) {
        const N = v[A], U = "" + B + A;
        x.push(U), g[U] = { node: N, lastCount: 0 }, f[U] = {};
 ...
 Suggested mode is: ` + e.toString(f));
  ...
  t.fromArray = function(b) {
    ...
    const f = C(b, l.isKanjiModeEnabled()), E = y(f), B = w(E, g), v = a.find_path(B.map, "start", "end"), x = [];
    for (let A = 1; A < v.length - 1; A++) x.push(B.table[v[A]].node);
    return t.fromArray(h(x));
  }, t.rawSplit = function(b) {
    return t.fromArray(C(b, l.isKanjiModeEnabled()));
  };
})(Ne);
const G = S, $ = Q, it = _e, st = Fe, at = we, lt = be, re = Ce, ie = O, ct = qe, J = ve, dt = Se, ut = P, ee = Ne;
function ht(t, e) {
...
function wt(t, e, i) {
  ...
  for (let v = 0; v < s; v++) {
    const x = v < a ? c : C;
    w[v] = b.slice(y, y + x), T[v] = h.encode(w[v]), y += x, m = Math.max(m, x);
  }
