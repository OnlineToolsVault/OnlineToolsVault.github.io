import { c as re, d as xe, r as K, j as o, L as ve } from "./index-DsTeKLg-.js";
import { R as be } from "./RelatedTools-Dai5N42q.js";
import { T as Pe } from "./ToolLayout-DdnzCrcK.js";
import { u as Ce } from "./index-Bpm0RpmP.js";
import { F as we } from "./FileSaver.min-DaXhTG4A.js";
import { a4 as Z } from "./toolPageSchema-BVedbqe3.js";
import { C as ie } from "./camera-s4vCNLgr.js";
import { S as ce } from "./save-DQlLSClm.js";
...
*/
const Ie = re("Calendar", [["path", { d: "M8 2v4", key: "1cmpym" }], ["path", { d: "M16 2v4", key: "4m81vk" }], ["rect", { width: "18", height: "18", x: "3", y: "4", rx: "2", key: "1hopcy" }], ["path", { d: "M3 10h18", key: "8toen8" }]]);
/**
* @license lucide-react v0.344.0 - ISC
*
* This source code is licensed under the ISC license.
* See the LICENSE file in the root directory of this source tree.
*/
const fe = re("Copyright", [["circle", { cx: "12", cy: "12", r: "10", key: "1mglay" }], ["path", { d: "M14.83 14.83a4 4 0 1 1 0-5.66", key: "1i56pz" }]]);
/**
* @license lucide-react v0.344.0 - ISC
*
* This source code is licensed under the ISC license.
* See the LICENSE file in the root directory of this source tree.
*/
const Re = re("User", [["path", { d: "M19 21v-2a4 4 0 0 0-4-4H9a4 4 0 0 0-4 4v2", key: "975kel" }], ["circle", { cx: "12", cy: "7", r: "4", key: "17ys0d" }]]);
var ne = { exports: {} };
(function(I, L) {
  (function() {
    var c = {};
    c.version = "1.0.4", c.remove = function(e) {
      ...
      var a = { "0th": {}, Exif: {}, GPS: {}, Interop: {}, "1st": {}, thumbnail: null }, n = new W(t);
      ...
      var T = D(d, "0th", 0), P = T[0].length + r * 12 + i * 12 + 4 + T[1].length, C, Y = "", w = 0, V, $ = "", _ = 0, oe, ee = "", te = 0, N, se = "", q;
      if (r && (C = D(l, "Exif", P), w = C[0].length + s * 12 + C[1].length), i && (V = D(g, "GPS", P + w), $ = V.join(""), _ = $.length), s) {
        var ae = P + w + _;
        oe = D(y, "Interop", ae), ee = oe.join(""), te = ee.length;
      }
      if (p) {
        var ae = P + w + _ + te;
        if (N = D(B, "1st", ae), q = A(a.thumbnail), q.length > 64e3) throw new Error("Given thumbnail is too large. max 64kB");
      }
      var le = "", me = "", de = "", he = "\0\0\0\0";
      if (r) {
        var R = t + P, O = h(">L", [R]), H = 34665, X = h(">H", [H]), U = h(">H", [S.Long]), z = h(">L", [1]);
        le = X + U + z + O;
      }
      if (i) {
        var R = t + P + w, O = h(">L", [R]), H = 34853, X = h(">H", [H]), U = h(">H", [S.Long]), z = h(">L", [1]);
        me = X + U + z + O;
      }
      if (s) {
        var R = t + P + w + _, O = h(">L", [R]), H = 40965, X = h(">H", [H]), U = h(">H", [S.Long]), z = h(">L", [1]);
        de = X + U + z + O;
      }
      if (p) {
        var R = t + P + w + _ + te;
        he = h(">L", [R]);
        var ge = R + N[0].length + 24 + 4 + N[1].length, ye = "\0\0\0\0" + h(">L", [ge]), ue = "\0\0\0\0" + h(">L", [q.length]);
        se = N[0] + ye + ue + "\0\0\0\0" + N[1] + q;
      }
      var Se = T[0] + le + me + he + T[1];
      return r && (Y = C[0] + de + C[1]), n + Se + Y + $ + ee + se;
    };
    function v(e) {
    ...
    function Q(e, t, a) {
      ...
      else if (t == "Long") i = e.length, i <= 1 ? r = J(e) : (r = h(">L", [a]), n = J(e));
    ...
    function D(e, t, a) {
      ...
      for (var l in e) if (typeof l == "string" && (l = parseInt(l)), !(t == "0th" && [34665, 34853].indexOf(l) > -1)) {
        ...
        typeof y == "number" && (y = [y]);
        var P = n + s + a + d.length, C = Q(y, B, P), Y = C[0], w = C[1], V = C[2];
        p += g + T + Y + w, d += V;
      }
      return [i + p, d];
    }
    ...
    if (W.prototype = { get_ifd: function(e, t) {
