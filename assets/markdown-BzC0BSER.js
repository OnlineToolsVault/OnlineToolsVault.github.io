...
var _u2, _so_instances, e_fn, _a;
var Vt = Object.create, Se = Object.defineProperty, Wt = Object.getOwnPropertyDescriptor, Ht = Object.getOwnPropertyNames, Gt = Object.getPrototypeOf, Jt = Object.prototype.hasOwnProperty, I = (u, e) => () => (e || u((e = { exports: {} }).exports, e), e.exports), at = (u, e) => {
  for (var t in e) Se(u, t, { get: e[t], enumerable: true });
}, Yt = (u, e, t, r) => {
  if (e && typeof e == "object" || typeof e == "function") for (let n of Ht(e)) !Jt.call(u, n) && n !== t && Se(u, n, { get: () => e[n], enumerable: !(r = Wt(e, n)) || r.enumerable });
  return u;
}, zu = (u, e, t) => (t = u != null ? Vt(Gt(u)) : {}, Yt(Se(t, "default", { value: u, enumerable: true }), u)), Le = I((u, e) => {
  e.exports = t;
  function t(r) {
  ...
  function x(h, F) {
    ...
    function _(N, P, V) {
      for (var W = this, Y = W.interruptFootnoteDefinition, Q = W.offset, tu = P.length + 1, H = 0, uu = [], cu, lu, eu, G, Z, hu, yu, Fu, Cu, iu, du, ru, X; H < tu && (G = P.charCodeAt(H), !(G !== t && G !== n)); ) H++;
      if (P.charCodeAt(H++) === o && P.charCodeAt(H++) === s) {
        for (lu = H; H < tu; ) {
        ...
        if (!(eu === void 0 || lu === eu || P.charCodeAt(H++) !== a)) {
          if (V) return true;
          for (cu = P.slice(lu, eu), Z = N.now(), Cu = 0, iu = 0, du = H, ru = []; H < tu; ) {
            if (G = P.charCodeAt(H), G !== G || G === r) X = { start: Cu, contentStart: du || H, contentEnd: H, end: H }, ru.push(X), G === r && (Cu = H + 1, iu = 0, du = void 0, X.end = Cu);
              ...
              if (iu < C && X && (X.contentStart === X.contentEnd || p(Y, w, W, [N, P.slice(H, d), true]))) break;
              iu = void 0, du = H;
            }
            H++;
          }
          for (H = -1, tu = ru.length; tu > 0 && (X = ru[tu - 1], X.contentStart === X.contentEnd); ) tu--;
          for (hu = N(P.slice(0, X.contentEnd)); ++H < tu; ) X = ru[H], Q[Z.line + H] = (Q[Z.line + H] || 0) + (X.contentStart - X.start), uu.push(P.slice(X.contentStart, X.end));
    ...
    function q(N, P, V) {
      var W = P.length + 1, Y = 0, Q, tu, H, uu;
      if (P.charCodeAt(Y++) === o && P.charCodeAt(Y++) === s) {
        ...
        if (!(H === void 0 || tu === H)) return V ? true : (Q = P.slice(tu, H), N(P.slice(0, Y))({ type: "footnoteReference", identifier: Q.toLowerCase(), label: Q }));
      }
    }
    function J(N, P, V) {
      var W = this, Y = P.length + 1, Q = 0, tu = 0, H, uu, cu, lu, eu, G, Z;
      if (P.charCodeAt(Q++) === s && P.charCodeAt(Q++) === o) {
        for (cu = Q; Q < Y; ) {
          if (uu = P.charCodeAt(Q), uu !== uu) return;
          if (G === void 0) if (uu === D) Q += 2;
          else if (uu === o) tu++, Q++;
          else if (uu === l) if (tu === 0) {
            lu = Q, Q++;
            break;
          } else tu--, Q++;
          else if (uu === c) {
            for (eu = Q, G = 1; P.charCodeAt(eu + G) === c; ) G++;
            Q += G;
          } else Q++;
          else if (uu === c) {
            for (eu = Q, Z = 1; P.charCodeAt(eu + Z) === c; ) Z++;
            Q += Z, G === Z && (G = void 0), Z = void 0;
          } else Q++;
        }
        if (lu !== void 0) return V ? true : (H = N.now(), H.column += 2, H.offset += 2, N(P.slice(0, Q))({ type: "footnote", children: W.tokenizeInline(P.slice(cu, lu), H) }));
      }
    }
    function z(N, P, V) {
      var W = 0;
      if (P.charCodeAt(W) === i && W++, P.charCodeAt(W) === o && P.charCodeAt(W + 1) !== s) return R.call(this, N, P, V);
    }
    function O(N, P, V) {
      for (var W = 0, Y = P.charCodeAt(W); Y === n || Y === t; ) Y = P.charCodeAt(++W);
      if (Y === o && P.charCodeAt(W + 1) !== s) return L.call(this, N, P, V);
    }
    function $(N, P) {
      return N.indexOf("[", P);
    }
...
`);
  ...
  function p(h, F, A, y) {
    for (var w = h.length, T = -1; ++T < w; ) if (F[h[T][0]].apply(A, y)) return true;
    return false;
  }
}), Dt = I((u) => {
  ...
  function C(E, m) {
    ...
    function B(p, h, F) {
      let A = h.length, y = false, w = false, T = 0, b, k, L, R, v, S, U;
      if (h.charCodeAt(T) === D && (w = true, T++), h.charCodeAt(T) === i) {
        if (T++, w) return F ? true : p(h.slice(0, T))({ type: "text", value: "$" });
        if (h.charCodeAt(T) === i && (y = true, T++), L = h.charCodeAt(T), !(L === n || L === r)) {
          for (R = T; T < A; ) {
          ...
          if (S !== void 0) return F ? true : (U = h.slice(R, v + 1), p(h.slice(0, S))({ type: "inlineMath", value: U, data: { hName: "span", hProperties: { className: l.concat(y && m.inlineMathDouble ? [s] : []) }, hChildren: [{ type: "text", value: U }] } }));
        }
      }
    }
  }
      ...
      if (R = y - L, !(R < D)) {
        ...
        if (h.charCodeAt(y) === r) {
          ...
          for (T = [], v !== y && T.push(h.slice(v, y)), y++, b = h.indexOf(a, y + 1), b = b === -1 ? A : b; y < A; ) {
            for (S = false, j = y, _ = b, k = b, U = 0; k > j && h.charCodeAt(k - 1) === n; ) k--;
            for (; k > j && h.charCodeAt(k - 1) === i; ) U++, k--;
            for (R <= U && h.indexOf(o, j) === k && (S = true, _ = k); j <= _ && j - y < L && h.charCodeAt(j) === n; ) j++;
...
$$`;
  ...
  function t(r) {
    ...
    function o(l) {
      ...
      if (l > -1 && l < i[i.length - 1]) {
        for (; ++s < i.length; ) if (i[s] > l) return { line: s + 1, column: l - (i[s - 1] || 0) + 1, offset: l };
      }
      return {};
    }
    function D(l) {
  ...
  function r(n, i) {
    return a;
    function a(o) {
      for (var D = 0, l = o.indexOf(t), s = n[i], c = [], C; l !== -1; ) c.push(o.slice(D, l)), D = l + 1, C = o.charAt(D), (!C || s.indexOf(C) === -1) && c.push(t), l = o.indexOf(t, D + 1);
...
arr: "\u27F5", xmap: "\u27FC", xnis: "\u22FB", xodot: "\u2A00", xopf: "\u{1D569}", xoplus: "\u2A01", xotime: "\u2A02", xrArr: "\u27F9", xrarr: "\u27F6", xscr: "\u{1D4CD}", xsqcup: "\u2A06", xuplus: "\u2A04", xutri: "\u25B3", xvee: "\u22C1", xwedge: "\u22C0", yacut: "\xFD", yacute: "\xFD", yacy: "\u044F", ycirc: "\u0177", ycy: "\u044B", ye: "\xA5", yen: "\xA5", yfr: "\u{1D536}", yicy: "\u0457", yopf: "\u{1D56A}", yscr: "\u{1D4CE}", yucy: "\u044E", yum: "\xFF", yuml: "\xFF", zacute: "\u017A", zcaron: "\u017E", zcy: "\u0437", zdot: "\u017C", zeetrf: "\u2128", zeta: "\u03B6", zfr: "\u{1D537}", zhcy: "\u0436", zigrarr: "\u21DD", zopf: "\u{1D56B}", zscr: "\u{1D4CF}", zwj: "\u200D", zwnj: "\u200C" };
  ...
  function n(i) {
    return r.call(t, i) ? t[i] : false;
  }
}), Ae = I((u, e) => {
  var t = ir(), r = or(), n = Uu(), i = ar(), a = Dr(), o = lr();
  e.exports = J;
  var D = {}.hasOwnProperty, l = String.fromCharCode, s = Function.prototype, c = { warning: null, reference: null, text: null, warningContext: null, referenceContext: null, textContext: null, position: {}, additional: null, attribute: false, nonTerminated: true }, C = 9, d = 10, E = 12, m = 32, g = 38, x = 59, f = 60, B = 61, p = 35, h = 88, F = 120, A = 65533, y = "named", w = "hexadecimal", T = "decimal", b = {};
  b[w] = 16, b[T] = 10;
  var k = {};
  k[y] = a, k[T] = n, k[w] = i;
  ...
  function z(M, N) {
    var P = N.additional, V = N.nonTerminated, W = N.text, Y = N.reference, Q = N.warning, tu = N.textContext, H = N.referenceContext, uu = N.warningContext, cu = N.position, lu = N.indent || [], eu = M.length, G = 0, Z = -1, hu = cu.column || 1, yu = cu.line || 1, Fu = "", Cu = [], iu, du, ru, X, wu, ou, nu, gu, De, ve, Tu, Gu, Ou, vu, $e, Ju, se, Eu, au;
    for (typeof P == "string" && (P = P.charCodeAt(0)), Ju = Yu(), gu = Q ? _t : s, G--, eu++; ++G < eu; ) if (wu === d && (hu = lu[Z] || 1), wu = M.charCodeAt(G), wu === g) {
      if (nu = M.charCodeAt(G + 1), nu === C || nu === d || nu === E || nu === m || nu === g || nu === f || nu !== nu || P && nu === P) {
        Fu += l(wu), hu++;
        continue;
      }
      for (Ou = G + 1, Gu = Ou, au = Ou, nu === p ? (au = ++Gu, nu = M.charCodeAt(au), nu === h || nu === F ? (vu = w, au = ++Gu) : vu = T) : vu = y, iu = "", Tu = "", X = "", $e = k[vu], au--; ++au < eu && (nu = M.charCodeAt(au), !!$e(nu)); ) X += l(nu), vu === y && D.call(t, X) && (iu = X, Tu = t[X]);
      ru = M.charCodeAt(au) === x, ru && (au++, du = vu === y ? o(X) : false, du && (iu = X, Tu = du)), Eu = 1 + au - Ou, !ru && !V || (X ? vu === y ? (ru && !Tu ? gu(U, 1) : (iu !== X && (au = Gu + iu.length, Eu = 1 + au - Gu, ru = false), ru || (De = iu ? L : v, N.attribute ? (nu = M.charCodeAt(au), nu === B ? (gu(De, Eu), Tu = null) : a(nu) ? Tu = null : gu(De, Eu)) : gu(De, Eu))), ou = Tu) : (ru || gu(R, Eu), ou = parseInt(X, b[vu]), O(ou) ? (gu(_, Eu), ou = l(A)) : ou in r ? (gu(j, Eu), ou = r[ou]) : (ve = "", $(ou) && gu(j, Eu), ou > 65535 && (ou -= 65536, ve += l(ou >>> 10 | 55296), ou = 56320 | ou & 1023), ou = ve + l(ou))) : vu !== y && gu(S, Eu)), ou ? (Ue(), Ju = Yu(), G = au - 1, hu += au - Ou + 1, Cu.push(ou), se = Yu(), se.offset++, Y && Y.call(H, ou, { start: Ju, end: se }, M.slice(Ou - 1, au)), Ju = se) : (X = M.slice(Ou - 1, au), Fu += X, hu += X.length, G = au - 1);
    } else wu === 10 && (yu++, Z++, hu = 0), wu === wu ? (Fu += l(wu), hu++) : Ue();
    return Cu.join("");
    function Yu() {
    ...
    function _t(Me, _e) {
      var xe = Yu();
      xe.column += _e, xe.offset += _e, Q.call(uu, q[Me], xe, Me);
    }
    function Ue() {
  ...
  function n(i) {
    return o.raw = D, o;
    function a(s) {
      for (var c = i.offset, C = s.line, d = []; ++C && C in c; ) d.push((c[C] || 0) + 1);
  ...
  function t(a) {
    ...
    function o(D, l) {
      ...
      for (R.now = w, R.file = s.file, A(""); D; ) {
        for (x = -1, f = d.length, h = false; ++x < f && (p = d[x], B = E[p], !(B && (!B.onlyAtStart || s.atStart) && (!B.notInList || !s.inList) && (!B.notInBlock || !s.inBlock) && (!B.notInLink || !s.inLink) && (F = D.length, B.apply(s, [R, D]), h = F !== D.length, h))); ) ;
...
`, U + 1);
  ...
  function r(a) {
    var o, D;
    return a.type !== "text" || !a.position ? true : (o = a.position.start, D = a.position.end, o.line !== D.line || D.column - o.column === a.value.length);
  }
  function n(a, o) {
...
`, '"', "$", "%", "&", "'", ",", "/", ":", ";", "<", "=", "?", "@", "^"]);
  ...
  e.exports = { position: true, gfm: true, commonmark: false, pedantic: false, blocks: hr() };
}), Fr = I((u, e) => {
  var t = $u(), r = pr(), n = st();
  e.exports = i;
  function i(a) {
    ...
    for (l in n) {
      if (s = a[l], s == null && (s = D[l]), l !== "blocks" && typeof s != "boolean" || l === "blocks" && typeof s != "object") throw new Error("Invalid value `" + s + "` for setting `options." + l + "`");
      a[l] = s;
    }
  ...
  function r(o) {
    ...
    function D(l) {
      var s;
      for (s in o) if (l[s] !== o[s]) return false;
      return true;
    }
  }
  function n(o) {
    for (var D = [], l = -1; ++l < o.length; ) D[l] = t(o[l]);
    return s;
    function s() {
      for (var c = -1; ++c < D.length; ) if (D[c].apply(this, arguments)) return true;
      return false;
    }
  }
  function i(o) {
  ...
  e.exports = o;
  var t = dr(), r = Cr(), n = true, i = "skip", a = false;
  ...
  function o(l, s, c, C) {
    ...
    function m(g, x, f) {
      ...
      function h() {
        ...
        if ((!s || E(g, x, f[f.length - 1] || null)) && (A = D(c(g, f)), A[0] === a)) return A;
  ...
  e.exports = a;
  var t = Ar(), r = t.CONTINUE, n = t.SKIP, i = t.EXIT;
...
`, i = /\r\n|\r/g;
  function a() {
    ...
    return D = D.replace(i, n), D.charCodeAt(0) === 65279 && (D = D.slice(1), s.column++, s.offset++), c = { type: "root", children: o.tokenizeBlock(D, s), position: { start: l, end: o.eof || t(l) } }, o.options.position || r(c, true), c;
  }
}), vr = I((u, e) => {
  var t = /^[ \t]*(\n|$)/;
  e.exports = r;
  function r(n, i, a) {
    for (var o, D = "", l = 0, s = i.length; l < s && (o = t.exec(i.slice(l)), o != null); ) l += o[0].length, D += o[0];
    if (D !== "") {
      if (a) return true;
      n(D);
    }
...
`, i = "	", a = " ", o = 4, D = t(a, o);
  function l(s, c, C) {
    for (var d = -1, E = c.length, m = "", g = "", x = "", f = "", B, p, h; ++d < E; ) if (B = c.charAt(d), h) if (h = false, m += x, g += f, x = "", f = "", B === n) x = B, f = B;
    ...
    else if (B === a && c.charAt(d + 1) === B && c.charAt(d + 2) === B && c.charAt(d + 3) === B) x += D, d += 3, h = true;
    else if (B === i) x += B, h = true;
    else {
      for (p = ""; B === i || B === a; ) p += B, B = c.charAt(++d);
      if (B !== n) break;
      x += p + B, f += B;
    }
    if (g) return C ? true : s(m)({ type: "code", lang: null, meta: null, value: r(g) });
  }
}), Br = I((u, e) => {
  e.exports = l;
  var t = `
`, r = "	", n = " ", i = "~", a = "`", o = 3, D = 4;
        ...
        if (!(f < o)) {
          ...
          if (p = c.charAt(g), !(p && p !== t)) {
            ...
            for (var v = true; g < m; ) {
              ...
              for (v ? (x += p, v = false) : (b += p, k += p), y = "", g++; g < m && (p = c.charAt(g), p === n); ) y += p, g++;
  ...
  e.exports = t;
  function t(r, n, i, a) {
    for (var o = r.length, D = -1, l, s; ++D < o; ) if (l = r[D], s = l[1] || {}, !(s.pedantic !== void 0 && s.pedantic !== i.options.pedantic) && !(s.commonmark !== void 0 && s.commonmark !== i.options.commonmark) && n[l[0]].apply(i, a)) return true;
    return false;
  }
}), br = I((u, e) => {
  var t = Mu(), r = Oe();
...
`, i = "	", a = " ", o = ">";
  function D(l, s, c) {
    for (var C = this, d = C.offset, E = C.blockTokenizers, m = C.interruptBlockquote, g = l.now(), x = g.line, f = s.length, B = [], p = [], h = [], F, A = 0, y, w, T, b, k, L, R, v; A < f && (y = s.charAt(A), !(y !== a && y !== i)); ) A++;
    if (s.charAt(A) === o) {
      if (c) return true;
      for (A = 0; A < f; ) {
        for (T = s.indexOf(n, A), L = A, R = false, T === -1 && (T = f); A < f && (y = s.charAt(A), !(y !== a && y !== i)); ) A++;
        if (s.charAt(A) === o ? (A++, R = true, s.charAt(A) === a && A++) : A = L, b = s.slice(A, T), !R && !t(b)) {
          A = L;
          break;
        }
        if (!R && (w = s.slice(A), r(m, E, C, [l, w, true]))) break;
        k = L === A ? b : s.slice(L, T), h.push(A - L), B.push(k), p.push(b), A = T + 1;
      }
      for (A = -1, f = h.length, F = l(B.join(n)); ++A < f; ) d[x] = (d[x] || 0) + h[A], x++;
    ...
    if (!(p > a) && !(!p || !C && l.charAt(E + 1) === i)) {
      ...
      if (!(!C && B.length === 0 && f && f !== t)) {
        ...
        for (g += B, B = "", x = ""; ++E < d && (f = l.charAt(E), !(!f || f === t)); ) {
          ...
          for (; f === n || f === r; ) B += f, f = l.charAt(++E);
          if (!C && x && !B && f === i) {
            x += f;
            continue;
          }
          for (; f === i; ) B += f, f = l.charAt(++E);
          for (; f === n || f === r; ) B += f, f = l.charAt(++E);
          E--;
        }
...
`, n = " ", i = "*", a = "-", o = "_", D = 3;
  function l(s, c, C) {
    ...
    else return f >= D && (!g || g === r) ? (m += B, C ? true : s(m)({ type: "thematicBreak" })) : void 0;
  }
}), ct = I((u, e) => {
  e.exports = a;
  var t = "	", r = " ", n = 1, i = 4;
  function a(o) {
    for (var D = 0, l = 0, s = o.charAt(D), c = {}, C, d = 0; s === t || s === r; ) {
      for (C = s === t ? i : n, l += C, C > 1 && (l = Math.floor(l / C) * C); d < l; ) c[++d] = D;
      s = o.charAt(++D);
    }
...
`, a = " ", o = "!";
  function D(l, s) {
    ...
    for (c.unshift(r(a, s) + o); C--; ) if (g = n(c[C]), E[C] = g.stops, t(c[C]).length !== 0) if (g.indent) g.indent > 0 && g.indent < d && (d = g.indent);
    else {
      d = 1 / 0;
      break;
    }
  ...
  var t = Mu(), r = Te(), n = Uu(), i = ct(), a = kr(), o = Oe();
  e.exports = y;
  var D = "*", l = "_", s = "+", c = "-", C = ".", d = " ", E = `
`, m = "	", g = ")", x = "x", f = 4, B = /\n\n(?!\s*$)/, p = /^\[([ X\tx])][ \t]/, h = /^([ \t]*)([*+-]|\d+[.)])( {1,4}(?! )| |\t|$|(?=\n))([^\n]*)/, F = /^([ \t]*)([*+-]|\d+[.)])([ \t]+)/, A = /^( {1,4}|\t)?/gm;
  function y(k, L, R) {
    for (var v = this, S = v.options.commonmark, U = v.options.pedantic, j = v.blockTokenizers, _ = v.interruptList, q = 0, J = L.length, z = null, O, $, M, N, P, V, W, Y, Q, tu, H, uu, cu, lu, eu, G, Z, hu, yu, Fu = false, Cu, iu, du, ru; q < J && (N = L.charAt(q), !(N !== m && N !== d)); ) q++;
    if (N = L.charAt(q), N === D || N === s || N === c) P = N, M = false;
    else {
      for (M = true, $ = ""; q < J && (N = L.charAt(q), !!n(N)); ) $ += N, q++;
    ...
    if (N = L.charAt(++q), !(N !== d && N !== m && (U || N !== E && N !== ""))) {
      if (R) return true;
      for (q = 0, lu = [], eu = [], G = []; q < J; ) {
        for (V = L.indexOf(E, q), W = q, Y = false, ru = false, V === -1 && (V = J), O = 0; q < J; ) {
          if (N = L.charAt(q), N === m) O += f - O % f;
          else if (N === d) O++;
          else break;
          q++;
        }
        if (Z && O >= Z.indent && (ru = true), N = L.charAt(q), Q = null, !ru) {
          if (N === D || N === s || N === c) Q = N, q++, O++;
          else {
            for ($ = ""; q < J && (N = L.charAt(q), !!n(N)); ) $ += N, q++;
            N = L.charAt(q), q++, $ && (N === C || S && N === g) && (Q = N, O += $.length + 1);
          }
          if (Q) if (N = L.charAt(q), N === m) O += f - O % f, q++;
          else if (N === d) {
        ...
        if (Q) {
          if (!U && P !== Q) break;
          Y = true;
        } else !S && !ru && L.charAt(W) === d ? ru = true : S && Z && (ru = O >= Z.indent || O > f), Y = false, q = W;
        if (H = L.slice(W, V), tu = W === q ? H : L.slice(q, V), (Q === D || Q === l || Q === c) && j.thematicBreak.call(v, k, H, true)) break;
        if (uu = cu, cu = !Y && !t(tu).length, ru && Z) Z.value = Z.value.concat(G, H), eu = eu.concat(G, H), G = [];
        else if (Y) G.length !== 0 && (Fu = true, Z.value.push(""), Z.trail = G.concat()), Z = { value: [H], indent: O, trail: [] }, lu.push(Z), eu = eu.concat(G, H), G = [];
        else if (cu) {
          if (uu && !S) break;
          G.push(H);
        } else {
          if (uu || o(_, j, v, [k, H, true])) break;
          Z.value = Z.value.concat(G, H), eu = eu.concat(G, H), G = [];
        }
        q = V + 1;
      }
      for (Cu = k(eu.join(E)).reset({ type: "list", ordered: M, start: z, spread: Fu, children: [] }), hu = v.enterList(), yu = v.enterBlock(), q = -1, J = lu.length; ++q < J; ) Z = lu[q].value.join(E), iu = k.now(), k(Z)(w(v, Z, iu), Cu), Z = lu[q].trail.join(E), q !== J - 1 && (Z += E), k(Z);
      return hu(), yu(), Cu;
    }
  }
  function w(k, L, R) {
...
`, r = "	", n = " ", i = "=", a = "-", o = 3, D = 1, l = 2;
  function s(c, C, d) {
    ...
    if (m.column += f.length, m.offset += f.length, f += B + p, h = C.charAt(++x), F = C.charAt(++x), !(h !== t || F !== i && F !== a)) {
      ...
      return d ? true : c(f + p)({ type: "heading", depth: A, children: E.tokenizeInline(B, m) });
    }
  }
}), ft = I((u) => {
  ...
  var t = ft().openCloseTag;
  e.exports = B;
  var r = "	", n = " ", i = `
`, a = "<", o = /^<(script|pre|style)(?=(\s|>|$))/i, D = /<\/(script|pre|style)>/i, l = /^<!--/, s = /-->/, c = /^<\?/, C = /\?>/, d = /^<![A-Za-z]/, E = />/, m = /^<!\[CDATA\[/, g = /]]>/, x = /^$/, f = new RegExp(t.source + "\\s*$");
  function B(p, h, F) {
    for (var A = this, y = A.options.blocks.join("|"), w = new RegExp("^</?(" + y + ")(?=(\\s|/?>|$))", "i"), T = h.length, b = 0, k, L, R, v, S, U, j, _ = [[o, D, true], [l, s, true], [c, C, true], [d, E, true], [m, g, true], [w, x, true], [f, x, false]]; b < T && (v = h.charAt(b), !(v !== r && v !== n)); ) b++;
    if (h.charAt(b) === a) {
...
`, D = "	", l = " ", s = "[", c = "]", C = "(", d = ")", E = ":", m = "<", g = ">";
  function x(p, h, F) {
    for (var A = this, y = A.options.commonmark, w = 0, T = h.length, b = "", k, L, R, v, S, U, j, _; w < T && (v = h.charAt(w), !(v !== l && v !== D)); ) b += v, w++;
    if (v = h.charAt(w), v === s) {
      for (w++, b += v, R = ""; w < T && (v = h.charAt(w), v !== c); ) v === a && (R += v, w++, v = h.charAt(w)), R += v, w++;
      if (!(!R || h.charAt(w) !== c || h.charAt(w + 1) !== E)) {
        for (U = R, b += R + c + E, w = b.length, R = ""; w < T && (v = h.charAt(w), !(v !== D && v !== l && v !== o)); ) b += v, w++;
        ...
        if (R) {
          for (j = R, R = ""; w < T && (v = h.charAt(w), !(v !== D && v !== l && v !== o)); ) R += v, w++;
          ...
          for (; w < T && (v = h.charAt(w), !(v !== D && v !== l)); ) b += v, w++;
          if (v = h.charAt(w), !v || v === o) return F ? true : (k = p(k).test().end, j = A.decode.raw(A.unescape(j), k, { nonTerminated: false }), _ && (L = p(L).test().end, _ = A.decode.raw(A.unescape(_), L)), p(b)({ type: "definition", identifier: r(U), label: U, title: _ || null, url: j }));
        }
      }
    }
  }
...
`, i = " ", a = "-", o = ":", D = "\\", l = "|", s = 1, c = 2, C = "left", d = "center", E = "right";
  function m(g, x, f) {
    ...
    if (B.options.gfm) {
      ...
      for (A = T.join(n), h = T.splice(1, 1)[0] || [], p = 0, w = h.length, _--, F = false, R = []; p < w; ) {
        if (k = h.charAt(p), k === l) {
          if (L = null, F === false) {
            if (M === false) return;
          } else R.push(F), F = false;
          M = false;
        } else if (k === a) L = true, F = F || null;
        else if (k === o) F === C ? F = d : L && F === null ? F = E : F = C;
        else if (!t(k)) return;
        p++;
      }
      if (F !== false && R.push(F), !(R.length < s)) {
        if (f) return true;
        for (j = -1, J = [], z = g(A).reset({ type: "table", align: R, children: J }); ++j < _; ) {
          for (q = T[j], y = { type: "tableRow", children: [] }, j && g(n), g(q).reset(y, z), w = q.length + 1, p = 0, b = "", v = "", S = true; p < w; ) {
            if (k = q.charAt(p), k === r || k === i) {
              v ? b += k : g(k), p++;
              continue;
            }
            k === "" || k === l ? S ? g(k) : ((v || k) && !S && (A = v, b.length > 1 && (k ? (A += b.slice(0, -1), b = b.charAt(b.length - 1)) : (A += b, b = "")), U = g.now(), g(A)({ type: "tableCell", children: B.tokenizeInline(v, U) }, y)), g(b + k), b = "", v = "") : (b && (v += b, b = ""), v += k, k === D && p !== w - 2 && (v += q.charAt(p + 1), p++)), S = false, p++;
          }
          j || g(n + h);
        }
        return z;
...
`, o = " ", D = 4;
  function l(s, c, C) {
    for (var d = this, E = d.options, m = E.commonmark, g = d.blockTokenizers, x = d.interruptParagraph, f = c.indexOf(a), B = c.length, p, h, F, A, y; f < B; ) {
      ...
      if (h = c.slice(f + 1), n(x, g, d, [s, h, true])) break;
      if (p = f, f = c.indexOf(a, f + 1), f !== -1 && t(c.slice(p, f)) === "") {
        f = p;
        break;
      }
    }
    return h = c.slice(0, f), C ? true : (y = s.now(), h = r(h), s(h)({ type: "paragraph", children: d.tokenizeInline(h, y) }));
  }
}), Rr = I((u, e) => {
  e.exports = t;
  function t(r, n) {
...
`, n = "\\";
  function i(a, o, D) {
    var l = this, s, c;
    if (o.charAt(0) === n && (s = o.charAt(1), l.escape.indexOf(s) !== -1)) return D ? true : (s === r ? c = { type: "break" } : c = { type: "text", value: s }, a(n + s)(c));
  }
}), ht = I((u, e) => {
  e.exports = t;
  function t(r, n) {
  ...
  var t = Bu(), r = Ae(), n = ht();
  e.exports = c, c.locator = n, c.notInLink = true;
  var i = "<", a = ">", o = "@", D = "/", l = "mailto:", s = l.length;
  function c(C, d, E) {
    var m = this, g = "", x = d.length, f = 0, B = "", p = false, h = "", F, A, y, w, T;
    if (d.charAt(0) === i) {
      for (f++, g = i; f < x && (F = d.charAt(f), !(t(F) || F === a || F === o || F === ":" && d.charAt(f + 1) === D)); ) B += F, f++;
      if (B) {
        if (h += B, B = "", F = d.charAt(f), h += F, f++, F === o) p = true;
        else {
          if (F !== ":" || d.charAt(f + 1) !== D) return;
          h += D, f++;
        }
        for (; f < x && (F = d.charAt(f), !(t(F) || F === a)); ) B += F, f++;
        if (F = d.charAt(f), !(!B || F !== a)) return E ? true : (h += B, y = h, g += h + F, A = C.now(), A.column++, A.offset++, p && (h.slice(0, s).toLowerCase() === l ? (y = y.slice(s), A.column += s, A.offset += s) : h = l + h), w = m.inlineTokenizers, m.inlineTokenizers = { text: w.text }, T = m.enterLink(), y = m.tokenizeInline(y, A), m.inlineTokenizers = w, T(), C(g)({ type: "link", title: null, url: r(h, { nonTerminated: false }), children: y }));
      }
    }
  }
}), jr = I((u, e) => {
  ...
  function r(n, i) {
    ...
    for (D = t.length, o = -1; ++o < D; ) l = n.indexOf(t[o], i), l !== -1 && (a === -1 || l < a) && (a = l);
    return a;
  }
}), $r = I((u, e) => {
  var t = jr(), r = Ae(), n = Uu(), i = te(), a = Bu(), o = zr();
  e.exports = A, A.locator = o, A.notInLink = true;
  var D = 33, l = 38, s = 41, c = 42, C = 44, d = 45, E = 46, m = 58, g = 59, x = 63, f = 60, B = 95, p = 126, h = "(", F = ")";
  function A(y, w, T) {
    var b = this, k = b.options.gfm, L = b.inlineTokenizers, R = w.length, v = -1, S = false, U, j, _, q, J, z, O, $, M, N, P, V, W, Y;
    if (k) {
      if (w.slice(0, 4) === "www.") S = true, q = 4;
      ...
      if (O === E && (U.pop(), q--), U[0] !== void 0 && (j = U.length < 2 ? _ : U[U.length - 2] + 1, w.slice(j, q).indexOf("_") === -1)) {
        ...
        if (q = $, w.charCodeAt(q - 1) === s) for (z = w.slice(J, q), M = t(z, h), N = t(z, F); N > M; ) q = J + z.lastIndexOf(F), z = w.slice(J, q), N--;
        if (w.charCodeAt(q - 1) === g && (q--, i(w.charCodeAt(q - 1)))) {
          for ($ = q - 2; i(w.charCodeAt($)); ) $--;
          w.charCodeAt($) === l && (q = $);
        }
        return P = w.slice(0, q), W = r(P, { nonTerminated: false }), S && (W = "http://" + W), Y = b.enterLink(), b.inlineTokenizers = { text: L.text }, V = b.tokenizeInline(P, y.now()), b.inlineTokenizers = L, Y(), y(P)({ type: "link", title: null, url: W, children: V });
      }
    }
  }
}), Ur = I((u, e) => {
  ...
  function D(s, c) {
    var C = this, d, E;
    if (!this.options.gfm || (d = s.indexOf("@", c), d === -1)) return -1;
    if (E = d, E === c || !l(s.charCodeAt(E - 1))) return D.call(C, s, d + 1);
    for (; E > c && l(s.charCodeAt(E - 1)); ) E--;
    return E;
  }
  function l(s) {
  ...
  function c(C, d, E) {
    ...
    if (g) {
      for (h = d.charCodeAt(f); r(h) || n(h) || h === a || h === o || h === D || h === s; ) h = d.charCodeAt(++f);
      if (f !== 0 && h === l) {
        for (f++; f < B; ) {
        ...
        if (!(p === -1 || p === f || h === o || h === s)) return h === D && f--, F = d.slice(0, f), E ? true : (y = m.enterLink(), m.inlineTokenizers = { text: x.text }, A = m.tokenizeInline(F, C.now()), m.inlineTokenizers = x, y(), C(F)({ type: "link", title: null, url: "mailto:" + t(F, { nonTerminated: false }), children: A }));
      }
    }
  }
}), _r = I((u, e) => {
  var t = te(), r = ht(), n = ft().tag;
  e.exports = c, c.locator = r;
  var i = "<", a = "?", o = "!", D = "/", l = /^<a /i, s = /^<\/a>/i;
  function c(C, d, E) {
    var m = this, g = d.length, x, f;
    if (!(d.charAt(0) !== i || g < 3) && (x = d.charAt(1), !(!t(x) && x !== a && x !== o && x !== D) && (f = d.match(n), !!f))) return E ? true : (f = f[0], !m.inLink && l.test(f) ? m.inLink = true : m.inLink && s.test(f) && (m.inLink = false), C(f)({ type: "html", value: f }));
  }
}), Ft = I((u, e) => {
  e.exports = t;
  function t(r, n) {
...
`, i = "!", a = '"', o = "'", D = "(", l = ")", s = "<", c = ">", C = "[", d = "\\", E = "]", m = "`";
  function g(x, f, B) {
    ...
    if (A === i && (j = true, h = A, A = f.charAt(++F)), A === C && !(!j && p.inLink)) {
      ...
      if (b) {
        ...
        if (A = f.charAt(F), h += $, $ && (A === a || A === o || w && A === D)) if (F++, h += A, $ = "", q = A === D ? l : A, v = h, w) {
          for (; F < J && (A = f.charAt(F), A !== q); ) A === d && ($ += d, A = f.charAt(++F)), F++, $ += A;
          if (A = f.charAt(F), A !== q) return;
          for (z = $, h += $ + A, F++; F < J && (A = f.charAt(F), !!t(A)); ) h += A, F++;
        } else for (S = ""; F < J; ) {
          if (A = f.charAt(F), A === q) U && ($ += q + S, S = ""), U = true;
          else if (!U) $ += A;
          else if (A === l) {
            h += $ + q + S, z = $;
            break;
          } else t(A) ? S += A : ($ += q + S + A, S = "", U = false);
          F++;
        }
        if (f.charAt(F) === l) return B ? true : (h += l, M = p.decode.raw(p.unescape(M), x(R).test().end, { nonTerminated: false }), z && (v = x(v).test().end, z = p.decode.raw(p.unescape(z), v)), V = { type: j ? "image" : "link", title: z || null, url: M }, j ? V.alt = p.decode.raw(p.unescape(_), N) || null : (P = p.enterLink(), V.children = p.tokenizeInline(_, N), P()), x(h)(V));
      }
    }
  }
}), Wr = I((u, e) => {
  ...
  function E(m, g, x) {
    ...
    if (p === s && (w = a, y = p, p = g.charAt(++h)), p === c) {
      ...
      if (A = S, b = S, p = g.charAt(h), p === d) {
        ...
        if (!(T !== l && U)) return A = y + A, w === i && f.inLink ? null : x ? true : (L = m.now(), L.column += y.length, L.offset += y.length, k = T === l ? k : b, R = { type: w + "Reference", identifier: n(k), label: k, referenceType: T }, w === i ? (v = f.enterLink(), R.children = f.tokenizeInline(b, L), v()) : R.alt = f.decode.raw(f.unescape(b), L) || null, m(A)(R));
      }
    }
  }
}), Hr = I((u, e) => {
  ...
  function D(l, s, c) {
    ...
    if (!(E !== a && E !== o || s.charAt(++d) !== E) && (g = C.options.pedantic, x = E, B = x + x, p = s.length, d++, f = "", E = "", !(g && r(s.charAt(d))))) for (; d < p; ) {
      if (h = E, E = s.charAt(d), E === x && s.charAt(d + 1) === x && (!g || !r(h)) && (E = s.charAt(d + 2), E !== x)) return t(f) ? c ? true : (m = l.now(), m.column += 2, m.offset += 2, l(B + f + B)({ type: "strong", children: C.tokenizeInline(f, m) })) : void 0;
    ...
    if (!(m !== a && m !== o) && (x = d.options.pedantic, p = m, f = m, h = c.length, E++, B = "", m = "", !(x && n(c.charAt(E))))) for (; E < h; ) {
      if (F = m, m = c.charAt(E), m === f && (!x || !n(F))) {
        if (m = c.charAt(++E), m !== f) {
          ...
          return C ? true : (g = s.now(), g.column++, g.offset++, s(p + B + f)({ type: "emphasis", children: d.tokenizeInline(B, g) }));
        }
        B += f;
      }
  ...
  function a(o, D, l) {
    ...
    if (!(!s.options.gfm || D.charAt(0) !== n || D.charAt(1) !== n || t(D.charAt(2)))) for (m = 1, g = D.length, x = o.now(), x.column += 2, x.offset += 2; ++m < g; ) {
      if (c = D.charAt(m), c === n && C === n && (!d || !t(d))) return l ? true : o(i + E + i)({ type: "delete", children: s.tokenizeInline(E, x) });
      E += C, d = C, C = c;
    }
  }
}), Xr = I((u, e) => {
  ...
  var r = 10, n = 32, i = 96;
  function a(o, D, l) {
    for (var s = D.length, c = 0, C, d, E, m, g, x; c < s && D.charCodeAt(c) === i; ) c++;
    if (!(c === 0 || c === s)) {
      ...
      if (x) {
        if (l) return true;
        if (c = C, s = d, m = D.charCodeAt(c), g = D.charCodeAt(s - 1), x = false, s - c > 2 && (m === n || m === r) && (g === n || g === r)) {
          for (c++, s--; c < s; ) {
...
`, i = 2;
  function a(o, D, l) {
    for (var s = D.length, c = -1, C = "", d; ++c < s; ) {
      if (d = D.charAt(c), d === n) return c < i ? void 0 : l ? true : (C += d, o(C)({ type: "break" }));
      if (d !== r) return;
      C += d;
    }
  }
  ...
  function t(r, n, i) {
    ...
    if (i) return true;
    for (o = a.inlineMethods, s = o.length, D = a.inlineTokenizers, l = -1, m = n.length; ++l < s; ) E = o[l], !(E === "text" || !D[E]) && (d = D[E].locator, d || r.file.fail("Missing locator: `" + E + "`"), C = d.call(a, n, 1), C !== -1 && C < m && (m = C));
  ...
  var t = $u(), r = tr(), n = rr(), i = nr(), a = cr(), o = fr();
  e.exports = D;
  function D(c, C) {
    this.file = C, this.offset = {}, this.options = t(this.options), this.setOptions({}), this.inList = false, this.inBlock = false, this.inLink = false, this.atStart = true, this.toOffset = n(C).toOffset, this.unescape = i(this, "escape"), this.decode = a(this);
  }
  var l = D.prototype;
  l.setOptions = Fr(), l.parse = mr(), l.options = st(), l.exitStart = r("atStart", true), l.enterList = r("inList", false), l.enterLink = r("inLink", false), l.enterBlock = r("inBlock", false), l.interruptParagraph = [["thematicBreak"], ["list"], ["atxHeading"], ["fencedCode"], ["blockquote"], ["html"], ["setextHeading", { commonmark: false }], ["definition", { commonmark: false }]], l.interruptList = [["atxHeading", { pedantic: false }], ["fencedCode", { pedantic: false }], ["thematicBreak", { pedantic: false }], ["definition", { commonmark: false }]], l.interruptBlockquote = [["indentedCode", { commonmark: true }], ["fencedCode", { commonmark: true }], ["atxHeading", { commonmark: true }], ["setextHeading", { commonmark: true }], ["thematicBreak", { commonmark: true }], ["html", { commonmark: true }], ["list", { commonmark: true }], ["definition", { commonmark: false }]], l.blockTokenizers = { blankLine: vr(), indentedCode: xr(), fencedCode: Br(), blockquote: br(), atxHeading: yr(), thematicBreak: wr(), list: qr(), setextHeading: Sr(), html: Lr(), definition: Tr(), table: Or(), paragraph: Nr() }, l.inlineTokenizers = { escape: Ir(), autoLink: Pr(), url: $r(), email: Mr(), html: _r(), link: Vr(), reference: Wr(), strong: Gr(), emphasis: Qr(), deletion: Zr(), code: un(), break: tn(), text: rn() }, l.blockMethods = s(l.blockTokenizers), l.inlineMethods = s(l.inlineTokenizers), l.tokenizeBlock = o("block"), l.tokenizeInline = o("inline"), l.tokenizeFactory = o;
  function s(c) {
    var C = [], d;
    for (d in c) C.push(d);
    return C;
  ...
  var t = Object.prototype.hasOwnProperty, r = Object.prototype.toString, n = Object.defineProperty, i = Object.getOwnPropertyDescriptor, a = function(s) {
    ...
    if (!s || r.call(s) !== "[object Object]") return false;
    var c = t.call(s, "constructor"), C = s.constructor && s.constructor.prototype && t.call(s.constructor.prototype, "isPrototypeOf");
    if (s.constructor && !c && !C) return false;
    var d;
    for (d in s) ;
    return typeof d > "u" || t.call(s, d);
  }, D = function(s, c) {
    n && c.name === "__proto__" ? n(s, c.name, { enumerable: true, configurable: true, value: c.newValue, writable: true }) : s[c.name] = c.newValue;
  }, l = function(s, c) {
  ...
  e.exports = function s() {
    var c, C, d, E, m, g, x = arguments[0], f = 1, B = arguments.length, p = false;
    for (typeof x == "boolean" && (p = x, x = arguments[1] || {}, f = 2), (x == null || typeof x != "object" && typeof x != "function") && (x = {}); f < B; ++f) if (c = arguments[f], c != null) for (C in c) d = l(x, C), E = l(c, C), x !== E && (p && E && (o(E) || (m = a(E))) ? (m ? (m = false, g = d && a(d) ? d : []) : g = d && o(d) ? d : {}, D(x, { name: C, newValue: s(p, g, E) })) : typeof E < "u" && D(x, { name: C, newValue: E }));
    return x;
  };
}), sn = I((u, e) => {
  e.exports = (t) => {
  ...
  function r(n, i) {
    ...
    function D() {
      a || (a = true, i.apply(null, arguments));
    }
    function l(s) {
      D(null, s);
    }
  ...
  function n() {
    ...
    function o() {
      ...
      function C(d) {
        ...
        for (; ++f < x; ) (g[f] === null || g[f] === void 0) && (g[f] = s[f]);
        s = g, E ? t(E, C).apply(null, s) : c.apply(null, [null].concat(s));
      }
    }
    function D(l) {
      if (typeof l != "function") throw new Error("Expected `fn` to be a function, not " + l);
      return i.push(l), a;
    }
  }
}), fn = I((u, e) => {
  ...
  function e(D, l) {
    ...
    if (o(D), C = D.length, l === void 0 || !l.length || l.length > D.length) {
      ...
      } else c < 0 && (E = true, c = C + 1);
      return c < 0 ? "" : D.slice(s, c);
    }
    if (l === D) return "";
    for (d = -1, m = l.length - 1; C--; ) if (D.charCodeAt(C) === 47) {
      if (E) {
        s = C + 1;
        break;
      }
    } else d < 0 && (E = true, d = C + 1), m > -1 && (D.charCodeAt(C) === l.charCodeAt(m--) ? m < 0 && (c = C) : (m = -1, c = d));
    return s === c ? c = d : c < 0 && (c = D.length), D.slice(s, c);
  }
  function t(D) {
    var l, s, c;
    if (o(D), !D.length) return ".";
    for (l = -1, c = D.length; --c; ) if (D.charCodeAt(c) === 47) {
      if (s) {
        l = c;
        break;
      }
  ...
  function r(D) {
    ...
    for (o(D), m = D.length; m--; ) {
      ...
      c < 0 && (d = true, c = m + 1), E === 46 ? l < 0 ? l = m : C !== 1 && (C = 1) : l > -1 && (C = -1);
    }
    return l < 0 || c < 0 || C === 0 || C === 1 && l === c - 1 && l === s + 1 ? "" : D.slice(l, c);
  }
  function n() {
    for (var D = -1, l; ++D < arguments.length; ) o(arguments[D]), arguments[D] && (l = l === void 0 ? arguments[D] : l + "/" + arguments[D]);
    return l === void 0 ? "." : i(l);
  }
  function i(D) {
    var l, s;
    ...
    for (var s = "", c = 0, C = -1, d = 0, E = -1, m, g; ++E <= D.length; ) {
      ...
      if (m === 47) {
        if (!(C === E - 1 || d === 1)) if (C !== E - 1 && d === 2) {
          ...
          l && (s = s.length ? s + "/.." : "..", c = 2);
        } else s.length ? s += "/" + D.slice(C + 1, E) : s = D.slice(C + 1, E), c = E - C - 1;
        C = E, d = 0;
      } else m === 46 && d > -1 ? d++ : d = -1;
    }
    return s;
  ...
  var t = an(), r = dt(), n = Dn(), i = sn(), a = cn(), o = An();
  e.exports = E().freeze();
  ...
  function E() {
    ...
    function b() {
      ...
      return z.data(n(true, {}, y)), z;
    }
    function k() {
      var z, O;
      if (T) return b;
      for (; ++w < F.length; ) z = F[w], z[1] !== false && (z[1] === true && (z[1] = void 0), O = z[0].apply(b, z.slice(1)), typeof O == "function" && A.use(O));
      return T = true, w = 1 / 0, b;
    }
    function L(z, O) {
    ...
    function R(z) {
      ...
      function P(V, W) {
        var Y = v(V);
        Y ? (i(Y[1]) && i(W) && (W = n(true, Y[1], W)), Y[1] = W) : F.push(D.call(arguments));
      }
    }
    function v(z) {
...
at(En, { languages: () => Io, options: () => jo, parsers: () => Pt, printers: () => ia });
var Ne = (u, e) => (t, r, ...n) => t | 1 && r == null ? void 0 : (e.call(r) ?? r[u]).apply(r, n);
function mn(u) {
  return this[u < 0 ? this.length + u : u];
}
var vn = Ne("at", function() {
  if (Array.isArray(this) || typeof this == "string") return mn;
}), Au = vn, xn = String.prototype.replaceAll ?? function(u, e) {
  return u.global ? this.replace(u, e) : this.split(u).join(e);
}, Bn = Ne("replaceAll", function() {
  if (typeof this == "string") return xn;
}), su = Bn, bn = zu(Le());
function ge(u) {
...
var yn = () => {
}, wn = yn, Ru = "string", qu = "array", Ee = "cursor", _u = "indent", Vu = "align", re = "trim", Su = "group", Iu = "fill", ku = "if-break", ne = "indent-if-break", ie = "line-suffix", oe = "line-suffix-boundary", bu = "line", ae = "label", Wu = "break-parent", Ct = /* @__PURE__ */ new Set([Ee, _u, Vu, re, Su, Iu, ku, ne, ie, oe, bu, ae, Wu]);
function kn(u) {
...
var Lu = kn, qn = (u) => new Intl.ListFormat("en-US", { type: "disjunction" }).format(u);
function Sn(u) {
...
function Tn(u, e, t, r) {
  ...
  for (; n.length > 0; ) {
    ...
    let a = Lu(i);
    if (!a) throw new pe(i);
    if ((e == null ? void 0 : e(i)) !== false) switch (a) {
      case qu:
      case Iu: {
        let o = a === qu ? i : i.parts;
        for (let D = o.length, l = D - 1; l >= 0; --l) n.push(o[l]);
        break;
      }
      case ku:
...
function Rn(u) {
  ...
  function r(i) {
    if (i.type === Wu && We(t), i.type === Su) {
      if (t.push(i), e.has(i)) return false;
      e.add(i);
    }
  }
  function n(i) {
...
function Pu(u, e = ke) {
  return Nn(u, (t) => typeof t == "string" ? At(e, t.split(`
`)) : t);
}
var In = wn;
function ye(u) {
...
function ce(u, e = {}) {
  return In(e.expandedStates), { type: Su, id: e.id, contents: u, break: !!e.shouldBreak, expandedStates: e.expandedStates };
}
function Pn(u, e = "", t = {}) {
...
var gt = { type: bu }, Et = { type: bu, soft: true }, Ie = { type: bu, hard: true }, Du = [Ie, he], jn = { type: bu, hard: true, literal: true }, ke = [jn, he], zn = "cr", $n = "crlf", Un = "\r", Mn = `\r
`, _n = `
`, Vn = _n;
function Wn(u) {
  return u === zn ? Un : u === $n ? Mn : Vn;
}
var Hn = () => /[#*0-9]\uFE0F?\u20E3|[\xA9\xAE\u203C\u2049\u2122\u2139\u2194-\u2199\u21A9\u21AA\u231A\u231B\u2328\u23CF\u23ED-\u23EF\u23F1\u23F2\u23F8-\u23FA\u24C2\u25AA\u25AB\u25B6\u25C0\u25FB\u25FC\u25FE\u2600-\u2604\u260E\u2611\u2614\u2615\u2618\u2620\u2622\u2623\u2626\u262A\u262E\u262F\u2638-\u263A\u2640\u2642\u2648-\u2653\u265F\u2660\u2663\u2665\u2666\u2668\u267B\u267E\u267F\u2692\u2694-\u2697\u2699\u269B\u269C\u26A0\u26A7\u26AA\u26B0\u26B1\u26BD\u26BE\u26C4\u26C8\u26CF\u26D1\u26E9\u26F0-\u26F5\u26F7\u26F8\u26FA\u2702\u2708\u2709\u270F\u2712\u2714\u2716\u271D\u2721\u2733\u2734\u2744\u2747\u2757\u2763\u27A1\u2934\u2935\u2B05-\u2B07\u2B1B\u2B1C\u2B55\u3030\u303D\u3297\u3299]\uFE0F?|[\u261D\u270C\u270D](?:\uD83C[\uDFFB-\uDFFF]|\uFE0F)?|[\u270A\u270B](?:\uD83C[\uDFFB-\uDFFF])?|[\u23E9-\u23EC\u23F0\u23F3\u25FD\u2693\u26A1\u26AB\u26C5\u26CE\u
?:\u200D(?:[\u2695\u2696\u2708]\uFE0F?|\u2764\uFE0F?\u200D\uD83D(?:\uDC8B\u200D\uD83D)?\uDC68|\uD83C[\uDF3E\uDF73\uDF7C\uDF93\uDFA4\uDFA8\uDFEB\uDFED]|\uD83D(?:[\uDC68\uDC69]\u200D\uD83D(?:\uDC66(?:\u200D\uD83D\uDC66)?|\uDC67(?:\u200D\uD83D[\uDC66\uDC67])?)|[\uDCBB\uDCBC\uDD27\uDD2C\uDE80\uDE92]|\uDC66(?:\u200D\uD83D\uDC66)?|\uDC67(?:\u200D\uD83D[\uDC66\uDC67])?)|\uD83E(?:[\uDDAF\uDDBC\uDDBD](?:\u200D\u27A1\uFE0F?)?|[\uDDB0-\uDDB3]))|\uD83C(?:\uDFFB(?:\u200D(?:[\u2695\u2696\u2708]\uFE0F?|\u2764\uFE0F?\u200D\uD83D(?:\uDC8B\u200D\uD83D)?\uDC68\uD83C[\uDFFB-\uDFFF]|\uD83C[\uDF3E\uDF73\uDF7C\uDF93\uDFA4\uDFA8\uDFEB\uDFED]|\uD83D(?:[\uDCBB\uDCBC\uDD27\uDD2C\uDE80\uDE92]|\uDC30\u200D\uD83D\uDC68\uD83C[\uDFFC-\uDFFF])|\uD83E(?:[\uDD1D\uDEEF]\u200D\uD83D\uDC68\uD83C[\uDFFC-\uDFFF]|[\uDDAF\uDDBC\uDDBD](?:\u200D\u27A1\uFE0F?)?|[\uDDB0-\uDDB3])))?|\uDFFC(?:\u200D(?:[\u2695\u2696\u2708]\uFE0F?|\u2764\uFE0F?\u200D\uD83D(?:\uDC8B\u200D\uD83D)?\uDC68\uD83C[\uDFFB-\uDFFF]|\uD83C[\uDF3E\uDF73\uDF7C\uDF93\uDFA4\uDFA8\uDFEB\uDFED]|\uD83D(?:[\uDCBB\uDCBC\uDD27\uDD2C\uDE80\uDE92]|\uDC30\u200D\uD83D\uDC68\uD83C[\uDFFB\uDFFD-\uDFFF])|\uD83E(?:[\uDD1D\uDEEF]\u200D\uD83D\uDC68\uD83C[\uDFFB\uDFFD-\uDFFF]|[\uDDAF\uDDBC\uDDBD](?:\u200D\u27A1\uFE0F?)?|[\uDDB0-\uDDB3])))?|\uDFFD(?:\u200D(?:[\u2695\u2696\u2708]\uFE0F?|\u2764\uFE0F?\u200D\uD83D(?:\uDC8B\u200D\uD83D)?\uDC68\uD83C[\uDFFB-\uDFFF]|\uD83C[\uDF3E\uDF73\uDF7C\uDF93\uDFA4\uDFA8\uDFEB\uDFED]|\uD83D(?:[\uDCBB\uDCBC\uDD27\uDD2C\uDE80\uDE92]|\uDC30\u200D\uD83D\uDC68\uD83C[\uDFFB\uDFFC\uDFFE\uDFFF])|\uD83E(?:[\uDD1D\uDEEF]\u200D\uD83D\uDC68\uD83C[\uDFFB\uDFFC\uDFFE\uDFFF]|[\uDDAF\uDDBC\uDDBD](?:\u200D\u27A1\uFE0F?)?|[\uDDB0-\uDDB3])))?|\uDFFE(?:\u200D(?:[\u2695\u2696\u2708]\uFE0F?|\u2764\uFE0F?\u200D\uD83D(?:\uDC8B\u200D\uD83D)?\uDC68\uD83C[\uDFFB-\uDFFF]|\uD83C[\uDF3E\uDF73\uDF7C\uDF93\uDFA4\uDFA8\uDFEB\uDFED]|\uD83D(?:[\uDCBB\uDCBC\uDD27\uDD2C\uDE80\uDE92]|\uDC30\u200D\uD83D\uDC68\uD83C[\uDFFB-\uDFFD\uDFFF])|\uD83E(?:[\uDD1D\uDEEF]\u200D\uD83D\uDC68\uD83C[\uDFFB-\uDFFD\uDFFF]|[\uDDAF\uDDBC\uDDBD](?:\u200D\u27A1\uFE0F?)?|[\uDDB0-\uDDB3])))?|\uDFFF(?:\u200D(?:[\u2695\u2696\u2708]\uFE0F?|\u2764\uFE0F?\u200D\uD83D(?:\uDC8B\u200D\uD83D)?\uDC68\uD83C[\uDFFB-\uDFFF]|\uD83C[\uDF3E\uDF73\uDF7C\uDF93\uDFA4\uDFA8\uDFEB\uDFED]|\uD83D(?:[\uDCBB\uDCBC\uDD27\uDD2C\uDE80\uDE92]|\uDC30\u200D\uD83D\uDC68\uD83C[\uDFFB-\uDFFE])|\uD83E(?:[\uDD1D\uDEEF]\u200D\uD83D\uDC68\uD83C[\uDFFB-\uDFFE]|[\uDDAF\uDDBC\uDDBD](?:\u200D\u27A1\uFE0F?)?|[\uDDB0-\uDDB3])))?))?|\uDC69(?:\u200D(?:[\u2695\u2696\u2708]\uFE0F?|\u2764\uFE0F?\u200D\uD83D(?:\uDC8B\u200D\uD83D)?[\uDC68\uDC69]|\uD83C[\uDF3E\uDF73\uDF7C\uDF93\uDFA4\uDFA8\uDFEB\uDFED]|\uD83D(?:[\uDCBB\uDCBC\uDD27\uDD2C\uDE80\uDE92]|\uDC66(?:\u200D\uD83D\uDC66)?|\uDC67(?:\u200D\uD83D[\uDC66\uDC67])?|\uDC69\u200D\uD83D(?:\uDC66(?:\u200D\uD83D\uDC66)?|\uDC67(?:\u200D\uD83D[\uDC66\uDC67])?))|\uD83E(?:[\uDDAF\uDDBC\uDDBD](?:\u200D\u27A1\uFE0F?)?|[\uDDB0-\uDDB3]))|\uD83C(?:\uDFFB(?:\u200D(?:[\u2695\u2696\u2708]\uFE0F?|\u2764\uFE0F?\u200D\uD83D(?:[\uDC68\uDC69]|\uDC8B\u200D\uD83D[\uDC68\uDC69])\uD83C[\uDFFB-\uDFFF]|\uD83C[\uDF3E\uDF73\uDF7C\uDF93\uDFA4\uDFA8\uDFEB\uDFED]|\uD83D(?:[\uDCBB\uDCBC\uDD27\uDD2C\uDE80\uDE92]|\uDC30\u200D\uD83D\uDC69\uD83C[\uDFFC-\uDFFF])|\uD83E(?:[\uDDAF\uDDBC\uDDBD](?:\u200D\u27A1\uFE0F?)?|[\uDDB0-\uDDB3]|\uDD1D\u200D\uD83D[\uDC68\uDC69]\uD83C[\uDFFC-\uDFFF]|\uDEEF\u200D\uD83D\uDC69\uD83C[\uDFFC-\uDFFF])))?|\uDFFC(?:\u200D(?:[\u2695\u2696\u2708]\uFE0F?|\u2764\uFE0F?\u200D\uD83D(?:[\uDC68\uDC69]|\uDC8B\u200D\uD83D[\uDC68\uDC69])\uD83C[\uDFFB-\uDFFF]|\uD83C[\uDF3E\uDF73\uDF7C\uDF93\uDFA4\uDFA8\uDFEB\uDFED]|\uD83D(?:[\uDCBB\uDCBC\uDD27\uDD2C\uDE80\uDE92]|\uDC30\u200D\uD83D\uDC69\uD83C[\uDFFB\uDFFD-\uDFFF])|\uD83E(?:[\uDDAF\uDDBC\uDDBD](?:\u200D\u27A1\uFE0F?)?|[\uDDB0-\uDDB3]|\uDD1D\u200D\uD83D[\uDC68\uDC69]\uD83C[\uDFFB\uDFFD-\uDFFF]|\uDEEF\u200D\uD83D\uDC69\uD83C[\uDFFB\uDFFD-\uDFFF])))?|\uDFFD(?:\u200D(?:[\u2695\u2696\u2708]\uFE0F?|\u2764\uFE0F?\u200D\uD83D(?:[\uDC68\uDC69]|\uDC8B\u200D\uD83D[\uDC68\uDC69])\uD83C[\uDFFB-\uDFFF]|\uD83C[\uDF3E\uDF73\uDF7C\uDF93\uDFA4\uDFA8\uDFEB\uDFED]|\uD83D(?:[\uDCBB\uDCBC\uDD27\uDD2C\uDE80\uDE92]|\uDC30\u200D\uD83D\uDC69\uD83C[\uDFFB\uDFFC\uDFFE\uDFFF])|\uD83E(?:[\uDDAF\uDDBC\uDDBD](?:\u200D\u27A1\uFE0F?)?|[\uDDB0-\uDDB3]|\uDD1D\u200D\uD83D[\uDC68\uDC69]\uD83C[\uDFFB\uDFFC\uDFFE\uDFFF]|\uDEEF\u200D\uD83D\uDC69\uD83C[\uDFFB\uDFFC\uDFFE\uDFFF])))?|\uDFFE(?:\u200D(?:[\u2695\u2696\u2708]\uFE0F?|\u2764\uFE0F?\u200D\uD83D(?:[\uDC68\uDC69]|\uDC8B\u200D\uD83D[\uDC68\uDC69])\uD83C[\uDFFB-\uDFFF]|\uD83C[\uDF3E\uDF73\uDF7C\uDF93\uDFA4\uDFA8\uDFEB\uDFED]|\uD83D(?:[\uDCBB\uDCBC\uDD27\uDD2C\uDE80\uDE92]|\uDC30\u200D\uD83D\uDC69\uD83C[\uDFFB-\uDFFD\uDFFF])|\uD83E(?:[\uDDAF\uDDBC\uDDBD](?:\u200D\u27A1\uFE0F?)?|[\uDDB0-\uDDB3]|\uDD1D\u200D\uD83D[\uDC68\uDC69]\uD83C[\uDFFB-\uDFFD\uDFFF]|\uDEEF\u200D\uD83D\uDC69\uD83C[\uDFFB-\uDFFD\uDFFF])))?|\uDFFF(?:\u200D(?:[\u2695\u2696\u2708]\uFE0F?|\u2764\uFE0F?\u200D\uD83D(?:[\uDC68\uDC69]|\uDC8B\u200D\uD83D[\uDC68\uDC69])\uD83C[\uDFFB-\uDFFF]|\uD83C[\uDF3E\uDF73\uDF7C\uDF93\uDFA4\uDFA8\uDFEB\uDFED]|\uD83D(?:[\uDCBB\uDCBC\uDD27\uDD2C\uDE80\uDE92]|\uDC30\u200D\uD83D\uDC69\uD83C[\uDFFB-\uDFFE])|\uD83E(?:[\uDDAF\uDDBC\uDDBD](?:\u200D\u27A1\uFE0F?)?|[\uDDB0-\uDDB3]|\uDD1D\u200D\uD83D[\uDC68\uDC69]\uD83C[\uDFFB-\uDFFE]|\uDEEF\u200D\uD83D\uDC69\uD83C[\uDFFB-\uDFFE])))?))?|\uDD75(?:\uD83C[\uDFFB-\uDFFF]|\uFE0F)?(?:\u200D[\u2640\u2642]\uFE0F?)?|\uDE2E(?:\u200D\uD83D\uDCA8)?|\uDE35(?:\u200D\uD83D\uDCAB)?|\uDE36(?:\u200D\uD83C\uDF2B\uFE0F?)?|\uDE42(?:\u200D[\u2194\u2195]\uFE0F?)?|\uDEB6(?:\uD83C[\uDFFB-\uDFFF])?(?:\u200D(?:[\u2640\u2642]\uFE0F?(?:\u200D\u27A1\uFE0F?)?|\u27A1\uFE0F?))?)|\uD83E(?:[\uDD0C\uDD0F\uDD18-\uDD1F\uDD30-\uDD34\uDD36\uDD77\uDDB5\uDDB6\uDDBB\uDDD2\uDDD3\uDDD5\uDEC3-\uDEC5\uDEF0\uDEF2-\uDEF8](?:\uD83C[\uDFFB-\uDFFF])?|[\uDD26\uDD35\uDD37-\uDD39\uDD3C-\uDD3E\uDDB8\uDDB9\uDDCD\uDDCF\uDDD4\uDDD6-\uDDDD](?:\uD83C[\uDFFB-\uDFFF])?(?:\u200D[\u2640\u2642]\uFE0F?)?|[\uDDDE\uDDDF](?:\u200D[\u2640\u2642]\uFE0F?)?|[\uDD0D\uDD0E\uDD10-\uDD17\uDD20-\uDD25\uDD27-\uDD2F\uDD3A\uDD3F-\uDD45\uDD47-\uDD76\uDD78-\uDDB4\uDDB7\uDDBA\uDDBC-\uDDCC\uDDD0\uDDE0-\uDDFF\uDE70-\uDE7C\uDE80-\uDE8A\uDE8E-\uDEC2\uDEC6\uDEC8\uDECD-\uDEDC\uDEDF-\uDEEA\uDEEF]|\uDDCE(?:\uD83C[\uDFFB-\uDFFF])?(?:\u200D(?:[\u2640\u2642]\uFE0F?(?:\u200D\u27A1\uFE0F?)?|\u27A1\uFE0F?))?|\uDDD1(?:\u200D(?:[\u2695\u2696\u2708]\uFE0F?|\uD83C[\uDF3E\uDF73\uDF7C\uDF84\uDF93\uDFA4\uDFA8\uDFEB\uDFED]|\uD83D[\uDCBB\uDCBC\uDD27\uDD2C\uDE80\uDE92]|\uD83E(?:[\uDDAF\uDDBC\uDDBD](?:\u200D\u27A1\uFE0F?)?|[\uDDB0-\uDDB3\uDE70]|\uDD1D\u200D\uD83E\uDDD1|\uDDD1\u200D\uD83E\uDDD2(?:\u200D\uD83E\uDDD2)?|\uDDD2(?:\u200D\uD83E\uDDD2)?))|\uD83C(?:\uDFFB(?:\u200D(?:[\u2695\u2696\u2708]\uFE0F?|\u2764\uFE0F?\u200D(?:\uD83D\uDC8B\u200D)?\uD83E\uDDD1\uD83C[\uDFFC-\uDFFF]|\uD83C[\uDF3E\uDF73\uDF7C\uDF84\uDF93\uDFA4\uDFA8\uDFEB\uDFED]|\uD83D(?:[\uDCBB\uDCBC\uDD27\uDD2C\uDE80\uDE92]|\uDC30\u200D\uD83E\uDDD1\uD83C[\uDFFC-\uDFFF])|\uD83E(?:[\uDDAF\uDDBC\uDDBD](?:\u200D\u27A1\uFE0F?)?|[\uDDB0-\uDDB3\uDE70]|\uDD1D\u200D\uD83E\uDDD1\uD83C[\uDFFB-\uDFFF]|\uDEEF\u200D\uD83E\uDDD1\uD83C[\uDFFC-\uDFFF])))?|\uDFFC(?:\u200D(?:[\u2695\u2696\u2708]\uFE0F?|\u2764\uFE0F?\u200D(?:\uD83D\uDC8B\u200D)?\uD83E\uDDD1\uD83C[\uDFFB\uDFFD-\uDFFF]|\uD83C[\uDF3E\uDF73\uDF7C\uDF84\uDF93\uDFA4\uDFA8\uDFEB\uDFED]|\uD83D(?:[\uDCBB\uDCBC\uDD27\uDD2C\uDE80\uDE92]|\uDC30\u200D\uD83E\uDDD1\uD83C[\uDFFB\uDFFD-\uDFFF])|\uD83E(?:[\uDDAF\uDDBC\uDDBD](?:\u200D\u27A1\uFE0F?)?|[\uDDB0-\uDDB3\uDE70]|\uDD1D\u200D\uD83E\uDDD1\uD83C[\uDFFB-\uDFFF]|\uDEEF\u200D\uD83E\uDDD1\uD83C[\uDFFB\uDFFD-\uDFFF])))?|\uDFFD(?:\u200D(?:[\u2695\u2696\u2708]\uFE0F?|\u2764\uFE0F?\u200D(?:\uD83D\uDC8B\u200D)?\uD83E\uDDD1\uD83C[\uDFFB\uDFFC\uDFFE\uDFFF]|\uD83C[\uDF3E\uDF73\uDF7C\uDF84\uDF93\uDFA4\uDFA8\uDFEB\uDFED]|\uD83D(?:[\uDCBB\uDCBC\uDD27\uDD2C\uDE80\uDE92]|\uDC30\u200D\uD83E\uDDD1\uD83C[\uDFFB\uDFFC\uDFFE\uDFFF])|\uD83E(?:[\uDDAF\uDDBC\uDDBD](?:\u200D\u27A1\uFE0F?)?|[\uDDB0-\uDDB3\uDE70]|\uDD1D\u200D\uD83E\uDDD1\uD83C[\uDFFB-\uDFFF]|\uDEEF\u200D\uD83E\uDDD1\uD83C[\uDFFB\uDFFC\uDFFE\uDFFF])))?|\uDFFE(?:\u200D(?:[\u2695\u2696\u2708]\uFE0F?|\u2764\uFE0F?\u200D(?:\uD83D\uDC8B\u200D)?\uD83E\uDDD1\uD83C[\uDFFB-\uDFFD\uDFFF]|\uD83C[\uDF3E\uDF73\uDF7C\uDF84\uDF93\uDFA4\uDFA8\uDFEB\uDFED]|\uD83D(?:[\uDCBB\uDCBC\uDD27\uDD2C\uDE80\uDE92]|\uDC30\u200D\uD83E\uDDD1\uD83C[\uDFFB-\uDFFD\uDFFF])|\uD83E(?:[\uDDAF\uDDBC\uDDBD](?:\u200D\u27A1\uFE0F?)?|[\uDDB0-\uDDB3\uDE70]|\uDD1D\u200D\uD83E\uDDD1\uD83C[\uDFFB-\uDFFF]|\uDEEF\u200D\uD83E\uDDD1\uD83C[\uDFFB-\uDFFD\uDFFF])))?|\uDFFF(?:\u200D(?:[\u2695\u2696\u2708]\uFE0F?|\u2764\uFE0F?\u200D(?:\uD83D\uDC8B\u200D)?\uD83E\uDDD1\uD83C[\uDFFB-\uDFFE]|\uD83C[\uDF3E\uDF73\uDF7C\uDF84\uDF93\uDFA4\uDFA8\uDFEB\uDFED]|\uD83D(?:[\uDCBB\uDCBC\uDD27\uDD2C\uDE80\uDE92]|\uDC30\u200D\uD83E\uDDD1\uD83C[\uDFFB-\uDFFE])|\uD83E(?:[\uDDAF\uDDBC\uDDBD](?:\u200D\u27A1\uFE0F?)?|[\uDDB0-\uDDB3\uDE70]|\uDD1D\u200D\uD83E\uDDD1\uD83C[\uDFFB-\uDFFF]|\uDEEF\u200D\uD83E\uDDD1\uD83C[\uDFFB-\uDFFE])))?))?|\uDEF1(?:\uD83C(?:\uDFFB(?:\u200D\uD83E\uDEF2\uD83C[\uDFFC-\uDFFF])?|\uDFFC(?:\u200D\uD83E\uDEF2\uD83C[\uDFFB\uDFFD-\uDFFF])?|\uDFFD(?:\u200D\uD83E\uDEF2\uD83C[\uDFFB\uDFFC\uDFFE\uDFFF])?|\uDFFE(?:\u200D\uD83E\uDEF2\uD83C[\uDFFB-\uDFFD\uDFFF])?|\uDFFF(?:\u200D\uD83E\uDEF2\uD83C[\uDFFB-\uDFFE])?))?)/g;
function Gn(u) {
...
var Yn = "\xA9\xAE\u203C\u2049\u2122\u2139\u2194\u2195\u2196\u2197\u2198\u2199\u21A9\u21AA\u2328\u23CF\u23F1\u23F2\u23F8\u23F9\u23FA\u25AA\u25AB\u25B6\u25C0\u25FB\u25FC\u2600\u2601\u2602\u2603\u2604\u260E\u2611\u2618\u261D\u2620\u2622\u2623\u2626\u262A\u262E\u262F\u2638\u2639\u263A\u2640\u2642\u265F\u2660\u2663\u2665\u2666\u2668\u267B\u267E\u2692\u2694\u2695\u2696\u2697\u2699\u269B\u269C\u26A0\u26A7\u26B0\u26B1\u26C8\u26CF\u26D1\u26D3\u26E9\u26F1\u26F7\u26F8\u26F9\u2702\u2708\u2709\u270C\u270D\u270F\u2712\u2714\u2716\u271D\u2721\u2733\u2734\u2744\u2747\u2763\u2764\u27A1\u2934\u2935\u2B05\u2B06\u2B07", Qn = /[^\x20-\x7F]/u, Kn = new Set(Yn);
function Zn(u) {
  if (!u) return 0;
  if (!Qn.test(u)) return u.length;
  u = u.replace(Hn(), (t) => Kn.has(t) ? " " : "  ");
  let e = 0;
  for (let t of u) {
    let r = t.codePointAt(0);
    r <= 31 || r >= 127 && r <= 159 || r >= 768 && r <= 879 || r >= 65024 && r <= 65039 || (e += Gn(r) || Jn(r) ? 2 : 1);
  }
  return e;
}
var Pe = Zn, Xn = { type: 0 }, ui = { type: 1 }, mt = { value: "", length: 0, queue: [], get root() {
  return mt;
} };
function vt(u, e, t) {
...
function ei(u, e, t) {
  ...
  let r;
  return typeof e == "number" ? e < 0 ? r = ui : r = { type: 2, width: e } : r = { type: 3, string: e }, vt(u, r, t);
}
function ti(u, e) {
  return vt(u, Xn, e);
}
...
var pu = Symbol("MODE_BREAK"), mu = Symbol("MODE_FLAT"), qe = Symbol("DOC_FILL_PRINTED_LENGTH");
function le(u, e, t, r, n, i) {
  if (t === Number.POSITIVE_INFINITY) return true;
  let a = e.length, o = false, D = [u], l = "";
  for (; t >= 0; ) {
    if (D.length === 0) {
      if (a === 0) return true;
      D.push(e[--a]);
    ...
    let { mode: s, doc: c } = D.pop(), C = Lu(c);
    switch (C) {
      case Ru:
        c && (o && (l += " ", t -= 1, o = false), l += c, t -= Pe(c));
        break;
      case qu:
      case Iu: {
        let d = C === qu ? c : c.parts, E = c[qe] ?? 0;
        for (let m = d.length - 1; m >= E; m--) D.push({ mode: s, doc: d[m] });
        break;
      }
      case _u:
      case Vu:
      ...
      case ae:
        ...
        break;
      case re: {
        let { text: d, count: E } = xt(l);
        l = d, t += E;
        break;
      }
      case Su: {
        if (i && c.break) return false;
        let d = c.break ? pu : s, E = c.expandedStates && d === pu ? Au(0, c.expandedStates, -1) : c.contents;
        D.push({ mode: d, doc: E });
        break;
      }
      case ku: {
        let d = (c.groupId ? n[c.groupId] || mu : s) === pu ? c.breakContents : c.flatContents;
        d && D.push({ mode: s, doc: d });
        break;
      }
      case bu:
        if (s === pu || c.hard) return true;
        c.soft || (o = true);
        break;
      case ie:
        r = true;
...
function ni(u, e) {
  let t = /* @__PURE__ */ Object.create(null), r = e.printWidth, n = Wn(e.endOfLine), i = 0, a = [{ indent: mt, mode: pu, doc: u }], o = "", D = false, l = [], s = [], c = [], C = [], d = 0;
  for (Rn(u); a.length > 0; ) {
...
`, n) : p;
      ...
      case qu:
        ...
        break;
      case Ee:
        if (s.length >= 2) throw new Error("There are too many 'cursor' in doc.");
        s.push(d + o.length);
        break;
      case _u:
        a.push({ indent: ti(f, e), mode: B, doc: p.contents });
        break;
      case Vu:
        a.push({ indent: ei(f, p.n, e), mode: B, doc: p.contents });
        break;
      case re:
        x();
        break;
      case Su:
        switch (B) {
          ...
          case pu: {
            D = false;
            let h = { indent: f, mode: mu, doc: p.contents }, F = r - i, A = l.length > 0;
            if (!p.break && le(h, a, F, A, t)) a.push(h);
      ...
      case Iu: {
        ...
        if (y === 0) break;
        let w = A[F + 0], T = A[F + 1], b = { indent: f, mode: mu, doc: w }, k = { indent: f, mode: pu, doc: w }, L = le(b, [], h, l.length > 0, t, true);
        if (y === 1) {
          L ? a.push(b) : a.push(k);
          break;
        }
        ...
        let S = A[F + 2], U = { indent: f, mode: B, doc: { ...p, [qe]: F + 2 } }, j = le({ indent: f, mode: mu, doc: [w, T, S] }, [], h, l.length > 0, t, true);
      ...
      case ie:
        ...
        break;
      case oe:
        l.length > 0 && a.push({ indent: f, mode: B, doc: Ie });
        break;
      case bu:
        switch (B) {
          case mu:
...
function oi(u, e) {
  ...
  for (let i of t) {
    ...
    r.set(a, true), a > n && (n = a);
  }
  for (let i = 1; i < n; i++) if (!r.get(i)) return i;
  return n + 1;
}
var ai = oi, bt = Object.freeze({ character: "'", codePoint: 39 }), yt = Object.freeze({ character: '"', codePoint: 34 }), Di = Object.freeze({ preferred: bt, alternate: yt }), si = Object.freeze({ preferred: yt, alternate: bt });
function li(u, e) {
  let { preferred: t, alternate: r } = e === true || e === "'" ? Di : si, { length: n } = u, i = 0, a = 0;
  for (let o = 0; o < n; o++) {
...
var ci = li, fi = class extends Error {
  constructor(u, e, t = "type") {
    super(`Unexpected ${e} node ${t}: ${JSON.stringify(u[t])}.`);
    __publicField(this, "name", "UnexpectedNodeError");
    this.node = u;
  }
}, pi = fi, hi = zu(Le()), Fi = Array.prototype.toReversed ?? function() {
  return [...this].reverse();
}, di = Ne("toReversed", function() {
  if (Array.isArray(this)) return Fi;
}), Ci = di;
function Ai() {
  var _a2, _b, _c, _d, _e, _f;
  let u = globalThis, e = (_b = (_a2 = u.Deno) == null ? void 0 : _a2.build) == null ? void 0 : _b.os;
  return typeof e == "string" ? e === "windows" : ((_d = (_c = u.navigator) == null ? void 0 : _c.platform) == null ? void 0 : _d.startsWith("Win")) ?? ((_f = (_e = u.process) == null ? void 0 : _e.platform) == null ? void 0 : _f.startsWith("win")) ?? false;
}
var gi = Ai();
function wt(u) {
...
function Ei(u) {
  return u = wt(u), decodeURIComponent(u.pathname.replace(/%(?![0-9A-Fa-f]{2})/g, "%25"));
}
function mi(u) {
  u = wt(u);
...
var xi = (u) => String(u).split(/[/\\]/u).pop(), Bi = (u) => String(u).startsWith("file:");
function He(u, e) {
  if (!e) return;
...
function wi(u, e) {
  var _a2;
  let t = Ci(0, u.plugins).flatMap((r) => r.languages ?? []);
  return (_a2 = bi(t, e.language) ?? He(t, e.physicalFile) ?? He(t, e.file) ?? Ge(t, e.physicalFile) ?? Ge(t, e.file) ?? (yi == null ? void 0 : yi(t, e.physicalFile))) == null ? void 0 : _a2.parsers[0];
}
var ki = wi, kt = Symbol.for("PRETTIER_IS_FRONT_MATTER");
function qi(u) {
  return !!(u == null ? void 0 : u[kt]);
}
var Si = qi, Qu = 3;
function Li(u) {
  let e = u.slice(0, Qu);
...
`, Qu);
  if (t === -1) return;
  let r = u.slice(Qu, t).trim(), n = u.indexOf(`
${e}`, t), i = r;
  if (i || (i = e === "+++" ? "toml" : "yaml"), n === -1 && e === "---" && i === "yaml" && (n = u.indexOf(`
...`, t)), n === -1) return;
  let a = n + 1 + Qu, o = u.charAt(a + 1);
  if (!/\s?/u.test(o)) return;
  let D = u.slice(0, a), l;
  return { language: i, explicitLanguage: r || null, value: u.slice(t + 1, n), startDelimiter: e, endDelimiter: D.slice(-Qu), raw: D, start: { line: 1, column: 0, index: 0 }, end: { index: D.length, get line() {
    return l ?? (l = D.split(`
`)), l.length;
  }, get column() {
    return l ?? (l = D.split(`
...
var me = Ti, Oi = "format", Ni = /<!--\s*@(?:noformat|noprettier)\s*-->|\{\s*\/\*\s*@(?:noformat|noprettier)\s*\*\/\s*\}|<!--.*\r?\n[\s\S]*(^|\n)[^\S\n]*@(?:noformat|noprettier)[^\S\n]*($|\n)[\s\S]*\n.*-->/mu, Ri = /<!--\s*@(?:format|prettier)\s*-->|\{\s*\/\*\s*@(?:format|prettier)\s*\*\/\s*\}|<!--.*\r?\n[\s\S]*(^|\n)[^\S\n]*@(?:format|prettier)[^\S\n]*($|\n)[\s\S]*\n.*-->/mu, qt = (u) => {
  var _a2;
  return ((_a2 = me(u).content.trimStart().match(Ri)) == null ? void 0 : _a2.index) === 0;
}, Ii = (u) => {
  var _a2;
  return ((_a2 = me(u).content.trimStart().match(Ni)) == null ? void 0 : _a2.index) === 0;
}, Pi = (u) => {
...
`, " ")), u.type === "wikiLink" && (e.value = su(0, u.value.trim(), /[\t\n]+/gu, " ")), (u.type === "definition" || u.type === "linkReference" || u.type === "imageReference") && (e.label = (0, hi.default)(u.label)), (u.type === "link" || u.type === "image") && u.url && u.url.includes("(")) for (let r of "<>") e.url = su(0, u.url, r, encodeURIComponent(r));
  if ((u.type === "definition" || u.type === "link" || u.type === "image") && u.title && (e.title = su(0, u.title, /\\(?=["')])/gu, "")), (t == null ? void 0 : t.type) === "root" && t.children.length > 0 && (t.children[0] === u || Si(t.children[0]) && t.children[1] === u) && u.type === "html" && qt(u.value)) return null;
}
St.ignoredProperties = ji;
var zi = St, $i = /(?:[\u{2c7}\u{2c9}-\u{2cb}\u{2d9}\u{2ea}-\u{2eb}\u{305}\u{323}\u{1100}-\u{11ff}\u{2e80}-\u{2e99}\u{2e9b}-\u{2ef3}\u{2f00}-\u{2fd5}\u{2ff0}-\u{303f}\u{3041}-\u{3096}\u{3099}-\u{30ff}\u{3105}-\u{312f}\u{3131}-\u{318e}\u{3190}-\u{4dbf}\u{4e00}-\u{9fff}\u{a700}-\u{a707}\u{a960}-\u{a97c}\u{ac00}-\u{d7a3}\u{d7b0}-\u{d7c6}\u{d7cb}-\u{d7fb}\u{f900}-\u{fa6d}\u{fa70}-\u{fad9}\u{fe10}-\u{fe1f}\u{fe30}-\u{fe6f}\u{ff00}-\u{ffef}\u{16fe3}\u{16ff2}-\u{16ff6}\u{1aff0}-\u{1aff3}\u{1aff5}-\u{1affb}\u{1affd}-\u{1affe}\u{1b000}-\u{1b122}\u{1b132}\u{1b150}-\u{1b152}\u{1b155}\u{1b164}-\u{1b167}\u{1f200}\u{1f250}-\u{1f251}\u{20000}-\u{2a6df}\u{2a700}-\u{2b81d}\u{2b820}-\u{2cead}\u{2ceb0}-\u{2ebe0}\u{2ebf0}-\u{2ee5d}\u{2f800}-\u{2fa1d}\u{30000}-\u{3134a}\u{31350}-\u{33479}])(?:[\u{fe00}-\u{fe0f}\u{e0100}-\u{e01ef}])?/u, Zu = new RegExp("(?:[\\u{21}-\\u{2f}\\u{3a}-\\u{40}\\u{5b}-\\u{60}\\u{7b}-\\u{7e}]|\\p{General_Category=Connector_Punctuation}|\\p{General_Category=Dash_Punctuation}|\\p{General_Category=Close_Punctuation}|\\p{General_Category=Final_Punctuation}|\\p{General_Category=Initial_Punctuation}|\\p{General_Category=Other_Punctuation}|\\p{General_Category=Open_Punctuation})", "u"), Fe = (u) => u.position.start.offset, de = (u) => u.position.end.offset, Lt = /* @__PURE__ */ new Set(["liquidNode", "inlineCode", "emphasis", "esComment", "strong", "delete", "wikiLink", "link", "linkReference", "image", "imageReference", "footnote", "footnoteReference", "sentence", "whitespace", "word", "break", "inlineMath"]), Tt = /* @__PURE__ */ new Set([...Lt, "tableCell", "paragraph", "heading"]), ee = "non-cjk", xu = "cj-letter", ju = "k-letter", Ce = "cjk-punctuation", Ui = new RegExp("\\p{Script_Extensions=Hangul}", "u");
function Ot(u) {
  let e = [], t = u.split(/([\t\n ]+)/u);
...
` : " " });
    ...
    for (let [o, D] of a.entries()) if (!((o === 0 || o === a.length - 1) && D === "")) {
      if (o % 2 === 0) {
        D !== "" && r({ type: "word", value: D, kind: ee, isCJ: false, hasLeadingPunctuation: Zu.test(D[0]), hasTrailingPunctuation: Zu.test(Au(0, D, -1)) });
        continue;
      }
      if (Zu.test(D)) {
        r({ type: "word", value: D, kind: Ce, isCJ: true, hasLeadingPunctuation: true, hasTrailingPunctuation: true });
        continue;
      }
      if (Ui.test(D)) {
        r({ type: "word", value: D, kind: ju, isCJ: false, hasLeadingPunctuation: false, hasTrailingPunctuation: false });
        continue;
      }
      r({ type: "word", value: D, kind: xu, isCJ: true, hasLeadingPunctuation: false, hasTrailingPunctuation: false });
    }
  }
  return e;
  function r(n) {
    let i = Au(0, e, -1);
    (i == null ? void 0 : i.type) === "word" && !a(ee, Ce) && ![i.value, n.value].some((o) => /\u3000/u.test(o)) && e.push({ type: "whitespace", value: "" }), e.push(n);
    function a(o, D) {
...
function Mi(u, e) {
  return !u.ordered || u.children.length < 2 || Xu(u.children[1], e).number !== 1 ? false : Xu(u.children[0], e).number !== 0 ? true : u.children.length > 2 && Xu(u.children[2], e).number === 1;
}
function Nt(u, e) {
  let { value: t } = u;
...
function Rt(u) {
  if ((u == null ? void 0 : u.type) !== "link" || u.children.length !== 1) return false;
  let [e] = u.children;
...
function _i(u, e) {
  ...
  if (t.type === "code" && t.lang !== null) {
    let r = ki(e, { language: t.lang });
    if (r) return async (n) => {
      let i = e.__inJsTemplate ? "~" : "`", a = i.repeat(Math.max(3, Bt(t.value, i) + 1)), o = { parser: r };
      t.lang === "ts" || t.lang === "typescript" ? o.filepath = "dummy.ts" : t.lang === "tsx" && (o.filepath = "dummy.tsx");
      let D = await n(Nt(t, e.originalText), o);
      return we([a, t.lang, t.meta ? " " + t.meta : "", Du, Pu(D), Du, a]);
    };
  }
  switch (t.type) {
    case "import":
...
var Wi = _i, Ku = null;
function ue(u) {
  if (Ku !== null && typeof Ku.property) {
    let e = Ku;
    return Ku = ue.prototype = null, e;
  }
  return Ku = ue.prototype = u ?? /* @__PURE__ */ Object.create(null), new ue();
}
var Hi = 10;
...
var Yi = Ji, K = [["children"], []], Qi = { root: K[0], paragraph: K[0], sentence: K[0], word: K[1], whitespace: K[1], emphasis: K[0], strong: K[0], delete: K[0], inlineCode: K[1], wikiLink: K[1], link: K[0], image: K[1], blockquote: K[0], heading: K[0], code: K[1], html: K[1], list: K[0], thematicBreak: K[1], linkReference: K[0], imageReference: K[1], definition: K[1], footnote: K[0], footnoteReference: K[1], footnoteDefinition: K[0], table: K[0], tableCell: K[0], break: K[1], liquidNode: K[1], import: K[1], export: K[1], esComment: K[1], jsx: K[1], math: K[1], inlineMath: K[1], tableRow: K[0], listItem: K[0], text: K[1] }, Ki = Yi(Qi), Zi = Ki;
function fu(u, e, t, r = {}) {
  let { processor: n = t } = r, i = [];
  return u.each(() => {
    let a = n(u);
    a !== false && (i.length > 0 && Xi(u) && (i.push(Du), (eo(u, e) || Je(u)) && i.push(Du), Je(u) && i.push(Du)), i.push(a));
  }, "children"), i;
}
function Xi({ node: u, parent: e }) {
  let t = Lt.has(u.type), r = u.type === "html" && Tt.has(e.type);
  return !t && !r;
}
var uo = /* @__PURE__ */ new Set(["listItem", "definition"]);
function eo({ node: u, previous: e, parent: t }, r) {
  if (Ye(e, r) || u.type === "list" && t.type === "listItem" && e.type === "code") return true;
  let n = e.type === u.type && uo.has(u.type), i = t.type === "listItem" && (u.type === "list" || !Ye(t, r)), a = je(e) === "next", o = u.type === "html" && e.type === "html" && e.position.end.line + 1 === u.position.start.line, D = u.type === "html" && t.type === "listItem" && e.type === "paragraph" && e.position.end.line + 1 === u.position.start.line;
  return !(n || i || a || o || D);
}
function Je({ node: u, previous: e }) {
...
function to(u, e, t) {
  let { node: r } = u, n = It(r, u.parent), i = Mi(r, e);
  return fu(u, e, t, { processor() {
    ...
    function D() {
      ...
      return (r.isAligned || r.hasIndentedCodeblock) && r.ordered ? ro(l, e) : l;
    }
  } });
}
function Qe(u, e, t, r) {
...
function io(u, e, t) {
  let { node: r } = u, n = [], i = u.map(() => u.map(({ index: c }) => {
    let C = ni(t(), e).formatted, d = Pe(C);
    return n[c] = Math.max(n[c] ?? 3, d), { text: C, width: d };
  }, "children"), "children"), a = D(false);
  if (e.proseWrap !== "never") return [he, a];
  let o = D(true);
  return [he, ce(Pn(o, a))];
  function D(c) {
    return At(Ie, [s(i[0], c), l(c), ...i.slice(1).map((C) => s(C, c))].map((C) => `| ${C.join(" | ")} |`));
  }
  function l(c) {
    return n.map((C, d) => {
...
function oo(u) {
  let { node: e } = u, t = su(0, su(0, e.value, "*", "\\*"), new RegExp([`(^|${Zu.source})(_+)`, `(_+)(${Zu.source}|$)`].join("|"), "gu"), (i, a, o, D, l) => su(0, o ? `${a}${o}` : `${D}${l}`, "_", "\\_")), r = (i, a, o) => i.type === "sentence" && o === 0, n = (i, a, o) => Rt(i.children[o - 1]);
...
var so = (_a = class {
  constructor(u) {
    ...
    __privateSet(this, _u2, new Set(u));
  }
  getLeadingWhitespaceCount(u) {
    let e = __privateGet(this, _u2), t = 0;
  ...
  hasLeadingWhitespace(u) {
    return __privateGet(this, _u2).has(u.charAt(0));
  }
  hasTrailingWhitespace(u) {
    return __privateGet(this, _u2).has(Au(0, u, -1));
  }
  trimStart(u) {
    let e = this.getLeadingWhitespaceCount(u);
    return u.slice(e);
  ...
  split(u, e = false) {
    let t = `[${ge([...__privateGet(this, _u2)].join(""))}]+`, r = new RegExp(e ? `(${t})` : t, "u");
    return u.split(r);
  }
  hasWhitespaceCharacter(u) {
    let e = __privateGet(this, _u2);
  ...
  dedentString(u) {
    let e = __privateMethod(this, _so_instances, e_fn).call(this, u);
    return e === 0 ? u : u.split(`
`).map((t) => t.slice(e)).join(`
`);
  }
}, _u2 = new WeakMap(), _so_instances = new WeakSet(), e_fn = function(u) {
...
`, "\f", "\r", " "], fo = new lo(co), Ke = fo, po = /^\\?.$/su, ho = /^\n *>[ >]*$/u;
function Fo(u, e) {
...
function Ao(u, e, t) {
  return Hu(u, (r) => {
    ...
    let n = [], i, a;
    for (let o of r.children) i && e(i, o) ? (o = t(i, o), n.splice(-1, 1, o), a || (a = true)) : n.push(o), i = o;
...
function Eo(u) {
  return Hu(u, (e, t, [r]) => {
    ...
    let { value: n } = e;
    return r.type === "paragraph" && (t === 0 && (n = Ke.trimStart(n)), t === r.children.length - 1 && (n = Ke.trimEnd(n))), { type: "sentence", position: e.position, children: Ot(n) };
  });
}
function mo(u, e) {
  return Hu(u, (t, r, n) => {
...
function vo(u, e) {
  return Hu(u, (n, i, a) => {
    if (n.type === "list" && n.children.length > 0) {
      for (let o = 0; o < a.length; o++) {
        let D = a[o];
        if (D.type === "list" && !D.isAligned) return n.isAligned = false, n;
      }
      n.isAligned = r(n);
    }
    return n;
  ...
  function r(n) {
    ...
    let [i, a] = n.children;
    if (Xu(i, e).leadingSpaces.length > 1) return true;
    let o = t(i);
    if (o === -1) return false;
    if (n.children.length === 1) return o % e.tabWidth === 0;
    let D = t(a);
    return o !== D ? false : o % e.tabWidth === 0 ? true : Xu(a, e).leadingSpaces.length > 1;
  }
}
var xo = Fo;
function Bo(u, e) {
...
var bo = /* @__PURE__ */ new Set(["heading", "tableCell", "link", "wikiLink"]), Ze = new Set("!\"#$%&'()*+,-./:;<=>?@[\\]^_`{|}~");
...
function wo(u, e) {
  ...
  return Xe(n) && Xe(i) || n === ju && i === xu || i === ju && n === xu ? true : n === Ce || i === Ce || n === xu && i === xu ? false : Ze.has(r.value[0]) || Ze.has(Au(0, t.value, -1)) ? true : t.hasTrailingPunctuation || r.hasLeadingPunctuation ? false : yo(u);
}
function Xe(u) {
  return u === ee || u === ju;
}
function ko(u, e, t, r) {
  if (t !== "always" || u.hasAncestor((a) => bo.has(a.type))) return false;
  if (r) return e !== "";
  let { previous: n, next: i } = u;
  return !n || !i ? true : e === "" ? false : n.kind === ju && i.kind === xu || i.kind === ju && n.kind === xu ? true : !(n.isCJ || i.isCJ);
}
function ut(u, e, t, r) {
  if (t === "preserve" && e === `
`) return Du;
  let n = e === " " || e === `
` && wo(u, r);
  return ko(u, e, t, r) ? n ? gt : Et : n ? " " : "";
}
function et(u) {
  var _a2, _b;
  let { previous: e, next: t } = u;
  return (e == null ? void 0 : e.type) === "sentence" && ((_a2 = Au(0, e.children, -1)) == null ? void 0 : _a2.type) === "word" && !Au(0, e.children, -1).hasTrailingPunctuation || (t == null ? void 0 : t.type) === "sentence" && ((_b = t.children[0]) == null ? void 0 : _b.type) === "word" && !t.children[0].hasLeadingPunctuation;
}
function qo(u, e, t) {
  let { node: r } = u;
  if (Lo(u)) {
    let n = [""], i = Ot(e.originalText.slice(r.position.start.offset, r.position.end.offset));
    for (let a of i) {
      if (a.type === "word") {
        n.push([n.pop(), a.value]);
        continue;
      }
      let o = ut(u, a.value, e.proseWrap, true);
      if (Lu(o) === Ru) {
        n.push([n.pop(), o]);
        continue;
      }
  ...
  switch (r.type) {
    ...
    case "whitespace": {
      ...
      return ut(u, r.value, i);
    }
    case "emphasis": {
      let n;
      if (Rt(r.children[0])) n = e.originalText[r.position.start.offset];
      else {
        let i = et(u), a = u.callParent(({ node: o }) => o.type === "strong" && et(u));
...
`, " "), i = ai(n, "`"), a = "`".repeat(i), o = n.startsWith("`") || n.endsWith("`") || /^[\n ]/u.test(n) && /[\n ]$/u.test(n) && /[^\n ]/u.test(n) ? " " : "";
      return [a, o, n, o, a];
    }
    case "wikiLink": {
      let n = "";
    ...
    case "code": {
      ...
      return [i, r.lang || "", r.meta ? " " + r.meta : "", Du, Pu(Nt(r, e.originalText), Du), Du, i];
    }
    case "html": {
    ...
    case "definition": {
      let n = e.proseWrap === "always" ? gt : " ";
      return ce([be(r), ":", ye([n, Be(r.url), r.title === null ? "" : [n, fe(r.title, e, false)]])]);
    }
    case "footnote":
      return ["[^", fu(u, e, t), "]"];
    ...
    case "footnoteDefinition": {
      ...
      return [rt(r), ": ", n ? fu(u, e, t) : ce([Nu(" ".repeat(4), fu(u, e, t, { processor: ({ isFirst: i }) => i ? ce([Et, t()]) : t() }))])];
    }
    case "table":
      return io(u, e, t);
    case "tableCell":
...
function So(u, e, t) {
  ...
  return fu(u, e, t, { processor({ index: a }) {
    if (r.length > 0) {
      let o = r[0];
      if (a === o.start.index) return [tt(i[o.start.index]), e.originalText.slice(o.start.offset, o.end.offset), tt(i[o.end.index])];
      if (o.start.index < a && a < o.end.index) return false;
      if (a === o.end.index) return r.shift(), false;
    }
    return t();
  } });
}
...
var To = (u, e) => {
  for (let t of e) u = su(0, u, t, encodeURIComponent(t));
  return u;
};
function Be(u, e = []) {
...
function fe(u, e, t = true) {
  if (!u) return "";
  if (t) return " " + fe(u, e, false);
  if (u = su(0, u, /\\(?=["')])/gu, ""), u.includes('"') && u.includes("'") && !u.includes(")")) return `(${u})`;
  let r = ci(u, e.singleQuote);
...
function be(u) {
  return `[${(0, bn.default)(u.label)}]`;
}
function rt(u) {
  return `[^${u.label}]`;
}
var No = { features: { experimental_frontMatterSupport: { massageAstNode: true, embed: true, print: true } }, preprocess: xo, print: qo, embed: Wi, massageAstNode: zi, hasPrettierIgnore: Oo, insertPragma: Pi, getVisitorKeys: Zi }, Ro = No, Io = [{ name: "Markdown", type: "prose", aceMode: "markdown", extensions: [".md", ".livemd", ".markdown", ".mdown", ".mdwn", ".mkd", ".mkdn", ".mkdown", ".ronn", ".scd", ".workbook"], filenames: ["contents.lr", "README"], tmScope: "text.md", aliases: ["md", "pandoc"], codemirrorMode: "gfm", codemirrorMimeType: "text/x-gfm", wrap: true, parsers: ["markdown"], vscodeLanguageIds: ["markdown"], linguistLanguageId: 222 }, { name: "MDX", type: "prose", aceMode: "markdown", extensions: [".mdx"], filenames: [], tmScope: "text.md", aliases: ["md", "pandoc"], codemirrorMode: "gfm", codemirrorMimeType: "text/x-gfm", wrap: true, parsers: ["mdx"], vscodeLanguageIds: ["mdx"], linguistLanguageId: 222 }], nt = { singleQuote: { category: "Common", type: "boolean", default: false, description: "Use single quotes instead of double quotes." }, proseWrap: { category: "Common", type: "choice", default: "preserve", description: "How to wrap prose.", choices: [{ value: "always", description: "Wrap prose if it exceeds the print width." }, { value: "never", description: "Do not wrap prose." }, { value: "preserve", description: "Wrap prose as-is." }] } }, Po = { proseWrap: nt.proseWrap, singleQuote: nt.singleQuote }, jo = Po, Pt = {};
at(Pt, { markdown: () => ot, mdx: () => na, remark: () => ot });
var zo = zu(Qt()), $o = zu(Xt()), Uo = zu(on()), Mo = zu(gn()), _o = /^import\s/u, Vo = /^export\s/u, Wo = "[a-z][a-z0-9]*(\\.[a-z][a-z0-9]*)*|", Ho = /<!---->|<!---?[^>-](?:-?[^-])*-->/u, Go = /^\{\s*\/\*(.*)\*\/\s*\}/u, Jo = (u) => _o.test(u), jt = (u) => Vo.test(u), zt = (u) => Jo(u) || jt(u), ze = (u, e) => {
  let t = e.indexOf(`

`), r = t === -1 ? e : e.slice(0, t);
  if (zt(r)) return u(r)({ type: jt(r) ? "export" : "import", value: r });
};
ze.notInBlock = true;
ze.locator = (u) => zt(u) ? -1 : 1;
var $t = (u, e) => {
  let t = Go.exec(e);
  if (t) return u(t[0])({ type: "esComment", value: t[1].trim() });
};
$t.locator = (u, e) => u.indexOf("{", e);
var Yo = function() {
  let { Parser: u } = this, { blockTokenizers: e, blockMethods: t, inlineTokenizers: r, inlineMethods: n } = u.prototype;
  e.esSyntax = ze, r.esComment = $t, t.splice(t.indexOf("paragraph"), 0, "esSyntax"), n.splice(n.indexOf("text"), 0, "esComment");
}, Qo = function() {
...
function Zo() {
  return (u) => Hu(u, (e, t, [r]) => e.type !== "html" || Ho.test(e.value) || Tt.has(r.type) ? e : { ...e, type: "jsx" });
}
...
function Ut({ isMDX: u }) {
  return (e) => {
    let t = (0, Mo.default)().use(Uo.default, { commonmark: true, ...u && { blocks: [Wo] } }).use(zo.default).use(Ko).use($o.default).use(u ? Yo : it).use(ea).use(u ? Xo : it).use(ra);
    return t.run(t.parse(e));
  };
}
function it() {
}
var Mt = { astFormat: "mdast", hasPragma: qt, hasIgnorePragma: Ii, locStart: Fe, locEnd: de }, ot = { ...Mt, parse: Ut({ isMDX: false }) }, na = { ...Mt, parse: Ut({ isMDX: true }) }, ia = { mdast: Ro };
export {
  En as default,
  Io as languages,
  jo as options,
