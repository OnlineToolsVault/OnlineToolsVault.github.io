import { c as re, d as xe, r as K, j as o, L as ve } from "./index-OUpguYFg.js";
import { R as be } from "./RelatedTools-dQ1AUZ0r.js";
import { T as Pe } from "./ToolLayout-CuKFTkh4.js";
import { u as Ce } from "./index-CBYUSgtG.js";
import { F as we } from "./FileSaver.min-DzHDzKVl.js";
import { O as Z } from "./tools-B3OPepIK.js";
import { C as ie } from "./camera-CGrTwdGV.js";
import { S as ce } from "./save-DPVfhUHG.js";
...
(function(I, L) {
  (function() {
    ...
    c.version = "1.0.4", c.remove = function(e) {
      ...
      var T = D(d, "0th", 0), P = T[0].length + r * 12 + i * 12 + 4 + T[1].length, C, Y = "", w = 0, V, $ = "", _ = 0, oe, ee = "", te = 0, O, se = "", q;
      ...
      if (p) {
        var ae = P + w + _ + te;
        if (O = D(B, "1st", ae), q = A(a.thumbnail), q.length > 64e3) throw new Error("Given thumbnail is too large. max 64kB");
      }
      var le = "", me = "", de = "", he = "\0\0\0\0";
      if (r) {
        var R = t + P, N = h(">L", [R]), H = 34665, X = h(">H", [H]), U = h(">H", [S.Long]), z = h(">L", [1]);
        le = X + U + z + N;
      }
      if (i) {
        var R = t + P + w, N = h(">L", [R]), H = 34853, X = h(">H", [H]), U = h(">H", [S.Long]), z = h(">L", [1]);
        me = X + U + z + N;
      }
      if (s) {
        var R = t + P + w + _, N = h(">L", [R]), H = 40965, X = h(">H", [H]), U = h(">H", [S.Long]), z = h(">L", [1]);
        de = X + U + z + N;
      }
      if (p) {
        var R = t + P + w + _ + te;
        he = h(">L", [R]);
        var ge = R + O[0].length + 24 + 4 + O[1].length, ye = "\0\0\0\0" + h(">L", [ge]), ue = "\0\0\0\0" + h(">L", [q.length]);
        se = O[0] + ye + ue + "\0\0\0\0" + O[1] + q;
      }
