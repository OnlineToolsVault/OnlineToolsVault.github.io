import { c as F, g as L, r as _, R as U, j as h } from "./index-BtmU1OS0.js";
import { R as N } from "./RelatedTools-GVPazTWJ.js";
import { T as H } from "./ToolLayout-CgcEif7J.js";
import { C as D } from "./copy-BC22e6PQ.js";
import { A as C } from "./alert-circle-OenrUIar.js";
...
*/
const R = F("RotateCcw", [["path", { d: "M3 12a9 9 0 1 0 9-9 9.75 9.75 0 0 0-6.74 2.74L3 8", key: "1357e3" }], ["path", { d: "M3 3v5h5", key: "1xhq8a" }]]);
var I = { exports: {} };
(function(k, A) {
  (function(w, O) {
    k.exports = O();
    ...
    var X = { 949: (v, u, p) => {
      ...
      var o = p(823), g = p(949), m = function() {
        ...
        return t.toString = function(e, r) {
          var n = r === void 0 ? {} : r, i = n.throwExceptionOnParseError, a = i === void 0 ? true : i, s = n.verbose, c = s === void 0 ? false : s, f = n.dayOfWeekStartIndexZero, l = f === void 0 ? true : f, y = n.monthStartIndexZero, d = y === void 0 ? false : y, b = n.use24HourTimeFormat, x = n.locale, M = x === void 0 ? null : x, T = n.logicalAndDayFields, j = T === void 0 ? false : T, S = { throwExceptionOnParseError: a, verbose: c, dayOfWeekStartIndexZero: l, monthStartIndexZero: d, use24HourTimeFormat: b, locale: M, logicalAndDayFields: j };
          ...
          if (!e) c = "";
            ...
            for (var d = e.split(","), b = "", x = 0; x < d.length; x++) if (x > 0 && d.length > 2 && (b += ",", x < d.length - 1 && (b += " ")), x > 0 && d.length > 1 && (x == d.length - 1 || d.length == 2) && (b += "".concat(this.i18n.spaceAnd(), " ")), d[x].indexOf("/") > -1 || d[x].indexOf("-") > -1) {
              var M = d[x].indexOf("-") > -1 && d[x].indexOf("/") == -1, T = this.getSegmentDescription(d[x], r, n, i, M ? this.i18n.commaX0ThroughX1 : a, s);
              M && (T = T.replace(", ", "")), b += T;
            ...
            if (c = o.StringUtilities.format(i(d[1]), d[1]), d[0].indexOf("-") > -1) {
              var j = this.generateRangeSegmentDescription(d[0], a, n);
              j.indexOf(", ") != 0 && (c += ", "), c += j;
    ...
    function O(v) {
      ...
      var p = w[v] = { exports: {} };
      return X[v](p, p.exports, O), p.exports;
    }
    var E = {};
    return (() => {
      var v = E;
