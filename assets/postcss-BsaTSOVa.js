...
var es = Object.create, bt = Object.defineProperty, ts = Object.getOwnPropertyDescriptor, rs = Object.getOwnPropertyNames, ss = Object.getPrototypeOf, ns = Object.prototype.hasOwnProperty, A = (e, s) => () => (s || e((s = { exports: {} }).exports, s), s.exports), Yt = (e, s) => {
  for (var i in s) bt(e, i, { get: s[i], enumerable: true });
}, os = (e, s, i, r) => {
  if (s && typeof s == "object" || typeof s == "function") for (let a of rs(s)) !ns.call(e, a) && a !== i && bt(e, a, { get: () => s[a], enumerable: !(r = ts(s, a)) || r.enumerable });
  return e;
}, xe = (e, s, i) => (i = e != null ? es(ss(e)) : {}, os(bt(i, "default", { value: e, enumerable: true }), e)), is = A((e, s) => {
  ...
  var i = is(), r = Kt(), a = class Xt extends Error {
    ...
    showSourceCode(u) {
      ...
      if (u) {
        let { bold: l, gray: w, red: v } = i.createColors(true);
    ...
    raw(o, u, p) {
      ...
      if (p === "before" || p === "after") return this.beforeAfter(o, p);
      {
        ...
        this[t] ? y = this[t](n, o) : n.walk((h) => {
          if (y = h.raws[u], typeof y < "u") return false;
        });
      }
...
`) && (p = p.replace(/[^\n]+$/, "")), false;
    ...
    rawBeforeOpen(o) {
      let u;
      return o.walk((p) => {
        if (p.type !== "decl" && (u = p.raws.between, typeof u < "u")) return false;
      }), u;
    }
    rawBeforeRule(o) {
      let u;
...
`) && (u = u.replace(/[^\n]+$/, "")), false;
    ...
    rawColon(o) {
      ...
      return o.walkDecls((p) => {
        if (typeof p.raws.between < "u") return u = p.raws.between.replace(/[^\s:]/g, ""), false;
      }), u;
    }
    rawEmptyBody(o) {
      let u;
      return o.walk((p) => {
        if (p.nodes && p.nodes.length === 0 && (u = p.raws.after, typeof u < "u")) return false;
      }), u;
    }
    rawIndent(o) {
...
`);
          return u = m[m.length - 1], u = u.replace(/\S/g, ""), false;
        }
      }), u;
    }
    rawSemicolon(o) {
      let u;
      return o.walk((p) => {
        if (p.nodes && p.nodes.length && p.last.type === "decl" && (u = p.raws.semicolon, typeof u < "u")) return false;
      }), u;
    }
    rawValue(o, u) {
...
` ? (h = 1, c += 1) : h += 1;
  ...
  var m = class {
    ...
    constructor(n = {}) {
      this.raws = {}, this[o] = false, this[u] = true;
    ...
    getProxyProcessor() {
      return { get(n, t) {
        ...
        return n[t] === h || (n[t] = h, (t === "prop" || t === "value" || t === "name" || t === "params" || t === "important" || t === "text") && n.markDirty()), true;
      } };
    }
    markClean() {
      this[o] = true;
...
` ? (t = 1, h += 1) : t += 1;
    ...
    replaceWith(...n) {
      if (this.parent) {
        let t = this, h = false;
        for (let c of n) c === this ? h = true : h ? (this.parent.insertAfter(t, c), t = c) : this.parent.insertBefore(t, c);
        h || this.remove();
      }
      return this;
    }
  ...
  function h(d) {
    if (d[o] = false, d.proxyOf.nodes) for (let l of d.proxyOf.nodes) h(l);
  }
  var c = class er extends a {
    ...
    each(l) {
      ...
      for (; this.indexes[w] < this.proxyOf.nodes.length && (v = this.indexes[w], f = l(this.proxyOf.nodes[v], v), f !== false); ) this.indexes[w] += 1;
    ...
    getProxyProcessor() {
      return { get(l, w) {
        ...
        return l[w] === v || (l[w] = v, (w === "name" || w === "params" || w === "selector") && l.markDirty()), true;
      } };
    }
    index(l) {
    ...
    insertBefore(l, w) {
      let v = this.index(l), f = v === 0 ? "prepend" : false, g = this.normalize(w, this.proxyOf.nodes[v], f).reverse();
      v = this.index(l);
    ...
    walk(l) {
      return this.each((w, v) => {
        ...
        return f !== false && w.walk && (f = w.walk(l)), f;
      });
    }
    walkAtRules(l, w) {
  ...
  c.registerParse = (d) => {
    ...
    d.type === "atrule" ? Object.setPrototypeOf(d, p.prototype) : d.type === "rule" ? Object.setPrototypeOf(d, n.prototype) : d.type === "decl" ? Object.setPrototypeOf(d, r.prototype) : d.type === "comment" ? Object.setPrototypeOf(d, i.prototype) : d.type === "root" && Object.setPrototypeOf(d, m.prototype), d[u] = true, d.nodes && d.nodes.forEach((l) => {
      c.rebuild(l);
    });
  };
}), as = A((e, s) => {
  ...
  var { nanoid: i } = as(), { isAbsolute: r, resolve: a } = {}, { SourceMapConsumer: o, SourceMapGenerator: u } = us(), { fileURLToPath: p, pathToFileURL: y } = {}, m = xt(), n = tr(), t = Kt(), h = Symbol("lineToIndexCache"), c = !!(o && u), d = !!(a && r);
  function l(v) {
    if (v[h]) return v[h];
    let f = v.css.split(`
`), g = new Array(f.length), O = 0;
  ...
  var w = class {
    ...
    constructor(v, f = {}) {
      ...
      if (this.css = v.toString(), this.css[0] === "\uFEFF" || this.css[0] === "\uFFFE" ? (this.hasBOM = true, this.css = this.css.slice(1)) : this.hasBOM = false, this.document = this.css, f.document && (this.document = f.document.toString()), f.from && (!d || /^\w+:\/\//.test(f.from) || r(f.from) ? this.file = f.from : this.file = a(f.from)), d && c) {
  ...
  var i = { comma(r) {
    return i.split(r, [","], true);
  }, space(r) {
    let a = [" ", `
`, "	"];
    return i.split(r, a);
  }, split(r, a, o) {
    let u = [], p = "", y = false, m = 0, n = false, t = "", h = false;
    for (let c of r) h ? h = false : c === "\\" ? h = true : n ? c === t && (n = false) : c === '"' || c === "'" ? (n = true, t = c) : c === "(" ? m += 1 : c === ")" ? m > 0 && (m -= 1) : m === 0 && a.includes(c) && (y = true), y ? (p !== "" && u.push(p.trim()), p = "", y = false) : p += c;
      ...
      switch (n = y.charCodeAt(b), n) {
        ...
        case 40: {
          if (g = x.length ? x.pop()[1] : "", f = y.charCodeAt(b + 1), g === "url" && f !== 39 && f !== 34 && f !== 32 && f !== 10 && f !== 9 && f !== 12 && f !== 13) {
            c = b;
            do {
              if (w = false, c = y.indexOf(")", c + 1), c === -1) if (m || R) {
                c = b;
                break;
              } else S("bracket");
        ...
        case 34: {
          d = n === 39 ? "'" : '"', c = b;
          do {
            if (w = false, c = y.indexOf(d, c + 1), c === -1) if (m || R) {
              c = b + 1;
              break;
            } else S("string");
            for (v = c; y.charCodeAt(v - 1) === 92; ) v -= 1, w = !w;
        ...
        case 92: {
          for (c = b, h = true; y.charCodeAt(c + 1) === 92; ) c += 1, h = !h;
  ...
  var i = Ot(), r = Ne(), a = Xe(), o = We(), u = _t(), p = Ct(), y = { empty: true, space: true };
  function m(t) {
  ...
  var n = class {
    constructor(t) {
      this.input = t, this.root = new o(), this.current = this.root, this.spaces = "", this.semicolon = false, this.createTokenizer(), this.root.source = { input: t, start: { column: 1, line: 1, offset: 0 } };
    }
    atrule(t) {
      let h = new i();
      h.name = t[1].slice(1), h.name === "" && this.unnamedAtrule(h, t), this.init(h, t[2]);
      let c, d, l, w = false, v = false, f = [], g = [];
      for (; !this.tokenizer.endOfFile(); ) {
        if (t = this.tokenizer.nextToken(), c = t[0], c === "(" || c === "[" ? g.push(c === "(" ? ")" : "]") : c === "{" && g.length > 0 ? g.push("}") : c === g[g.length - 1] && g.pop(), g.length === 0) if (c === ";") {
          h.source.end = this.getPosition(t[2]), h.source.end.offset++, this.semicolon = true;
          break;
        } else if (c === "{") {
          v = true;
          break;
    ...
    decl(t, h) {
      ...
      this.init(c, t[0][2]);
      let d = t[t.length - 1];
      for (d[0] === ";" && (this.semicolon = true, t.pop()), c.source.end = this.getPosition(d[3] || d[2] || m(t)), c.source.end.offset++; t[0][0] !== "word"; ) t.length === 1 && this.unknownWord(t), c.raws.before += t.shift()[1];
      ...
      for (let f = t.length - 1; f >= 0; f--) {
        if (l = t[f], l[1].toLowerCase() === "!important") {
          ...
          O.trim().startsWith("!") && (c.important = true, c.raws.important = O, t = g);
        }
    ...
    emptyRule(t) {
      ...
      this.current.nodes && this.current.nodes.length && (this.current.raws.semicolon = this.semicolon), this.semicolon = false, this.current.raws.after = (this.current.raws.after || "") + this.spaces, this.spaces = "", this.current.parent ? (this.current.source.end = this.getPosition(t[2]), this.current.source.end.offset++, this.current = this.current.parent) : this.unexpectedClose(t);
    }
    endFile() {
    ...
    init(t, h) {
      this.current.push(t), t.source = { input: this.input, start: this.getPosition(h) }, t.raws.before = this.spaces, this.spaces = "", t.type !== "comment" && (this.semicolon = false);
    }
    other(t) {
      let h = false, c = null, d = false, l = null, w = [], v = t[1].startsWith("--"), f = [], g = t;
      for (; g; ) {
        if (c = g[0], f.push(g), c === "(" || c === "[") l || (l = g), w.push(c === "(" ? ")" : "]");
          ...
          this.tokenizer.back(f.pop()), h = true;
          break;
        } else c === ":" && (d = true);
        else c === w[w.length - 1] && (w.pop(), w.length === 0 && (l = null));
        g = this.tokenizer.nextToken();
      }
      if (this.tokenizer.endOfFile() && (h = true), w.length > 0 && this.unclosedBracket(l), h && d) {
    ...
    raw(t, h, c, d) {
      let l, w, v = c.length, f = "", g = true, O, b;
      for (let x = 0; x < v; x += 1) l = c[x], w = l[0], w === "space" && x === v - 1 && !d ? g = false : w === "comment" ? (b = c[x - 1] ? c[x - 1][0] : "empty", O = c[x + 1] ? c[x + 1][0] : "empty", !y[b] && !y[O] ? f.slice(-1) === "," ? g = false : f += l[1] : g = false) : f += l[1];
      if (!g) {
...
`));
        ...
        u.push(a[1]), p = a[2], a = this.tokenizer.nextToken({ ignoreUnclosed: true });
      }
      let m = ["comment", u.join(""), o[2], p];
      return this.inlineComment(m), y && (this.input = new r(y), this.tokenizer = i(this.input)), true;
    } else if (a[1] === "/") {
      let o = this.tokenizer.nextToken({ ignoreUnclosed: true });
  ...
  s.exports = { interpolation(i) {
    ...
    if (r[0][1].length > 1 || r[1][0] !== "{") return this.tokenizer.back(r[1]), false;
    ...
    return this.tokenizer.back(i), this.tokenizer.back(y), true;
  } };
}), ps = A((e, s) => {
  var i = /^#[0-9a-fA-F]{6}$|^#[0-9a-fA-F]{3}$/, r = /\.[0-9]/, a = (o) => {
    let [, u] = o, [p] = u;
    return (p === "." || p === "#") && i.test(u) === false && r.test(u) === false;
  };
  ...
  s.exports = (a) => {
    ...
    if (a.name.slice(-1) === ":") {
      if (i.test(o)) {
        let [p] = o.match(i);
        a.name = o.replace(p, ""), a.raws.afterName = p + (a.raws.afterName || ""), a.variable = true, a.value = a.params;
      }
      if (r.test(u)) {
        let [p] = u.match(r);
        a.value = u.replace(p, ""), a.raws.afterName = (a.raws.afterName || "") + p, a.variable = true;
      }
    }
  };
}), ds = A((e, s) => {
  ...
  s.exports = class extends r {
    ...
    decl(...n) {
      super.decl(...n), /extend\(.+\)/i.test(this.lastNode.value) && (this.lastNode.extend = true);
    }
    each(n) {
      n[0][1] = ` ${n[0][1]}`;
    ...
    inlineComment(n) {
      ...
      if (this.init(t, n[2]), t.source.end = this.getPosition(n[3] || n[2]), t.inline = true, t.raws.begin = "//", /^\s*$/.test(h)) t.text = "", t.raws.left = h, t.raws.right = "";
      else {
        let c = h.match(/^(\s*)([^]*[^\s])(\s*)$/);
    ...
    mixin(n) {
      ...
      this.atrule(this.tokenizer.nextToken()), this.lastNode.mixin = true, this.lastNode.raws.identifier = h, l && (this.lastNode.important = true, this.lastNode.raws.important = l);
    }
    other(n) {
    ...
    rule(n) {
      ...
      super.rule(n), /:extend\(.+\)/i.test(this.lastNode.selector) && (this.lastNode.extend = true);
    }
    unknownWord(n) {
      let [t] = n;
      if (n[0][1] === "each" && n[1][0] === "(") {
  ...
  s.exports = function(r) {
    i[r] || (i[r] = true, typeof console < "u" && console.warn && console.warn(r));
  };
}), ir = A((e, s) => {
  var i = pe(), r = At(), a = sr(), o = et(), u = Et(), p = We(), y = Ye(), { isClean: m, my: n } = Tt();
  or();
  var t = { atrule: "AtRule", comment: "Comment", decl: "Declaration", document: "Document", root: "Root", rule: "Rule" }, h = { AtRule: true, AtRuleExit: true, Comment: true, CommentExit: true, Declaration: true, DeclarationExit: true, Document: true, DocumentExit: true, Once: true, OnceExit: true, postcssPlugin: true, prepare: true, Root: true, RootExit: true, Rule: true, RuleExit: true }, c = { Once: true, postcssPlugin: true, prepare: true }, d = 0;
  function l(b) {
    return typeof b == "object" && typeof b.then == "function";
  }
  function w(b) {
    let x = false, k = t[b.type];
  ...
  function f(b) {
    return b[m] = false, b.nodes && b.nodes.forEach((x) => f(x)), b;
  }
  var g = {}, O = class ar {
    get content() {
    ...
    constructor(x, k, T) {
      ...
      else if (k instanceof ar || k instanceof u) S = f(k.root), k.map && (typeof T.map > "u" && (T.map = {}), T.map.inline || (T.map.inline = false), T.map.prev = k.map);
      else {
        let E = o;
    ...
    sync() {
      ...
      if (this.prepareVisitors(), this.hasListener) {
        let x = this.result.root;
        for (; !x[m]; ) x[m] = true, this.walkSync(x);
    ...
    visitSync(x, k) {
      for (let [T, S] of x) {
        ...
        if (k.type !== "root" && k.type !== "document" && !k.parent) return true;
    ...
    visitTick(x) {
      ...
      for (; k.eventIndex < E.length; ) {
        ...
        if (k.eventIndex += 1, P === d) {
          T.nodes && T.nodes.length && (T[m] = true, k.iterator = T.getIterator());
          return;
  ...
  var u = class {
    ...
    constructor(p, y, m) {
      y = y.toString(), this.stringified = false, this._processor = p, this._css = y, this._opts = m, this._map = void 0;
      let n, t = o;
  ...
  var i = At(), r = ir(), a = gs(), o = We(), u = class {
    ...
    normalize(p) {
      let y = [];
      for (let m of p) if (m.postcss === true ? m = m() : m.postcss && (m = m.postcss), typeof m == "object" && Array.isArray(m.plugins)) y = y.concat(m.plugins);
  ...
  O.plugin = function(b, x) {
    let k = false;
    function T(...E) {
      console && console.warn && !k && (k = true, console.warn(b + `: postcss.plugin was deprecated. Migration guide:
https://evilmartians.com/chronicles/postcss-8-plugin-migration`));
  ...
  var { Container: i } = jt(), r = class extends i {
    constructor(a) {
      super(a), this.type = "decl", this.isNested = true, this.nodes || (this.nodes = []);
    }
  };
  s.exports = r;
}), xs = A((e, s) => {
  ...
  s.exports = function(p, y = {}) {
    ...
    function W() {
      let M = 1, I = false, U = false;
      for (; M > 0; ) h += 1, m.length <= h && E("interpolation"), t = m.charCodeAt(h), f = m.charCodeAt(h + 1), I ? !U && t === I ? (I = false, U = false) : t === 92 ? U = !U : U && (U = false) : t === 39 || t === 34 ? I = t : t === 125 ? M -= 1 : t === 35 && f === 123 && (M += 1);
    }
    function $(M) {
      if (k.length) return k.pop();
      if (b >= O) return;
      let I = M ? M.ignoreUnclosed : false;
      switch (t = m.charCodeAt(b), t) {
        ...
        case 40: {
          if (v = x.length ? x.pop()[1] : "", f = m.charCodeAt(b + 1), v === "url" && f !== 39 && f !== 34) {
            for (T = 1, w = false, h = b + 1; h <= m.length - 1; ) {
        ...
        case 39:
        case 34: {
          for (c = t, h = b, w = false; h < O && (h++, h === O && E("string"), t = m.charCodeAt(h), f = m.charCodeAt(h + 1), !(!w && t === c)); ) t === 92 ? w = !w : w ? w = false : t === 35 && f === 123 && W();
        ...
        case 92: {
          for (h = b, l = true; m.charCodeAt(h + 1) === 92; ) h += 1, l = !l;
  ...
  var { Comment: i } = jt(), r = St(), a = bs(), o = xs(), u = class extends r {
    ...
    comment(p) {
      if (p[4] === "inline") {
        let y = new i();
        this.init(y, p[2]), y.raws.inline = true;
...
`)) break;
        t[0] === "(" ? m += 1 : t[0] === ")" ? m -= 1 : m === 0 && t[0] === ":" && (y = true);
      }
      if (!y || n.trim() === "" || /^[#:A-Za-z-]/.test(n)) super.rule(p);
        ...
        for (let d = p.length - 1; d > 0; d--) {
          if (c = p[d], c[1] === "!important") {
            ...
            w.trim().indexOf("!") === 0 && (t.important = true, t.raws.important = w, p = l);
          }
  ...
  a.prototype = Object.create(i.default.prototype), a.constructor = i.default, a.prototype.walk = function(o, u) {
    for (var p = typeof o == "string" || o instanceof RegExp, y = p ? u : o, m = typeof o == "string" ? new RegExp(o) : o, n = 0; n < this.nodes.length; n++) {
      var t = this.nodes[n], h = p ? m.test(t.type) : true;
      if (h && y && y(t, n, this.nodes) === false || t.nodes && t.walk(o, u) === false) return false;
    }
    return true;
    ...
    for (var o = arguments.length <= 0 || arguments[0] === void 0 ? function() {
      ...
      var p = this.nodes[u];
      if (o(p, u, this.nodes) === false) return false;
    }
    return true;
  }, e.default = a;
}), Os = A((e) => {
  Object.defineProperty(e, "__esModule", { value: true }), e.parseMediaFeature = u, e.parseMediaQuery = p, e.parseMediaList = y;
  ...
  function u(m) {
    ...
    for (var g = 0; g < f.length; g++) {
      var O = f[g];
      if ((O === "'" || O === '"') && (t[c].isCalculationEnabled === true ? (t.push({ mode: "string", isCalculationEnabled: false, character: O }), c++) : t[c].mode === "string" && t[c].character === O && f[g - 1] !== "\\" && (t.pop(), c--)), O === "{" ? (t.push({ mode: "interpolation", isCalculationEnabled: true }), c++) : O === "}" && (t.pop(), c--), t[c].mode === "normal" && O === ":") {
  ...
  function p(m) {
    var n = arguments.length <= 1 || arguments[1] === void 0 ? 0 : arguments[1], t = [], h = 0, c = false, d = void 0;
    function l() {
    ...
    for (var w = 0; w < m.length; w++) {
      var v = m[w];
      c ? (d.value += v, (v === "{" || v === "(") && h++, (v === ")" || v === "}") && h--) : v.search(/\s/) !== -1 ? d.before += v : (v === "(" && (d.type = "media-feature-expression", h++), d.value = v, d.sourceIndex = n + w, c = true), c && h === 0 && (v === ")" || w === m.length - 1 || m[w + 1].search(/\s/) !== -1) && (["not", "only", "and"].indexOf(d.value) !== -1 && (d.type = "keyword"), d.type === "media-feature-expression" && (d.nodes = u(d.value, d.sourceIndex)), t.push(Array.isArray(d.nodes) ? new a.default(d) : new i.default(d)), d = l(), c = false);
    }
  ...
  Object.defineProperty(e, "__esModule", { value: true }), e.default = o;
  var s = lr(), i = a(s), r = Os();
  function a(u) {
  ...
  e.__esModule = true, e.TAG = "tag", e.STRING = "string", e.SELECTOR = "selector", e.ROOT = "root", e.PSEUDO = "pseudo", e.NESTING = "nesting", e.ID = "id", e.COMMENT = "comment", e.COMBINATOR = "combinator", e.CLASS = "class", e.ATTRIBUTE = "attribute", e.UNIVERSAL = "universal";
}), It = A((e, s) => {
  e.__esModule = true;
  ...
  function t(c, d) {
    ...
    c.prototype = Object.create(d && d.prototype, { constructor: { value: c, enumerable: false, writable: true, configurable: true } }), d && (Object.setPrototypeOf ? Object.setPrototypeOf(c, d) : c.__proto__ = d);
  }
  var h = function(c) {
    t(d, c);
    function d(l) {
    ...
    return d.prototype.append = function(l) {
      ...
      if (this.indexes[w] = 0, !!this.length) {
        for (var v = void 0, f = void 0; this.indexes[w] < this.length && (v = this.indexes[w], f = l(this.at(v), v), f !== false); ) this.indexes[w] += 1;
        if (delete this.indexes[w], f === false) return false;
      }
    }, d.prototype.walk = function(l) {
      return this.each(function(w, v) {
        var f = l(w, v);
        if (f !== false && w.length && (f = w.walk(l)), f === false) return false;
      });
  ...
  function y(n, t) {
    ...
    n.prototype = Object.create(t && t.prototype, { constructor: { value: n, enumerable: false, writable: true, configurable: true } }), t && (Object.setPrototypeOf ? Object.setPrototypeOf(n, t) : n.__proto__ = t);
  }
  var m = function(n) {
    y(t, n);
    function t(h) {
  ...
  var i = /* @__PURE__ */ function() {
    function n(t, h) {
      for (var c = 0; c < h.length; c++) {
        var d = h[c];
        d.enumerable = d.enumerable || false, d.configurable = true, "value" in d && (d.writable = true), Object.defineProperty(t, d.key, d);
      }
    }
    ...
    for (var $ = [], R = W.css.valueOf(), M = void 0, I = void 0, U = void 0, Oe = void 0, he = void 0, fe = void 0, de = void 0, me = void 0, ye = void 0, B = void 0, _e = void 0, ut = R.length, j = -1, _ = 1, C = 0, L = function(z, q) {
      ...
      switch (M = R.charCodeAt(C), M === u && (j = C, _ += 1), M) {
        ...
        case r:
          U = M === i ? "'" : '"', I = C;
          do
            for (B = false, I = R.indexOf(U, I + 1), I === -1 && L("quote", U), _e = I; R.charCodeAt(_e - 1) === a; ) _e -= 1, B = !B;
          while (B);
        ...
        case T:
          ...
          break;
        case a:
          for (I = C, de = true; R.charCodeAt(I + 1) === a; ) I += 1, de = !de;
...
`), he = Oe.length - 1, he > 0 ? (me = _ + he, ye = I - Oe[he].length) : (me = _, ye = j), $.push(["comment", fe, _, C - j, me, I - ye, C]), j = ye, _ = me, C = I) : (E.lastIndex = C + 1, E.test(R), E.lastIndex === 0 ? I = R.length - 1 : I = E.lastIndex - 2, $.push(["word", R.slice(C, I + 1), _, C - j, _, I - j, C]), C = I);
  ...
  var i = /* @__PURE__ */ function() {
    function j(_, C) {
      for (var L = 0; L < C.length; L++) {
        var z = C[L];
        z.enumerable = z.enumerable || false, z.configurable = true, "value" in z && (z.writable = true), Object.defineProperty(_, z.key, z);
      }
    }
  ...
  var ut = function() {
    function j(_) {
      _e(this, j), this.input = _, this.lossy = _.options.lossless === false, this.position = 0, this.root = new n.default();
      var C = new h.default();
    ...
    return j.prototype.attribute = function() {
      ...
      if (q.length > 1 ? (q[0] === "" && (q[0] = true), X.attribute = this.parseValue(q[2]), X.namespace = this.parseNamespace(q[0])) : X.attribute = this.parseValue(z[0]), C = new E.default(X), z[2]) {
        var re = z[2].split(/(\s+i\s*?)$/), se = re[0].trim();
        C.value = this.lossy ? se : re[0], re[1] && (C.insensitive = true, this.lossy || (C.raws.insensitive = re[1])), C.quoted = se[0] === "'" || se[0] === '"', C.raws.unquoted = C.quoted ? se.slice(1, -1) : se;
      }
      ...
      var _ = this.prevToken && this.prevToken[1] || true;
      ...
      if (this.currToken[0] === "word") {
        var z = void 0;
        this.splitWord(false, function(q, X) {
  ...
  var i = /* @__PURE__ */ function() {
    function y(m, n) {
      for (var t = 0; t < n.length; t++) {
        var h = n[t];
        h.enumerable = h.enumerable || false, h.configurable = true, "value" in h && (h.writable = true), Object.defineProperty(m, h.key, h);
      }
    }
...
` ? (o = 1, u += 1) : o += 1;
  ...
  var i = te(), r = class extends i {
    ...
    each(a) {
      ...
      if (this.indexes[o] = 0, !!this.nodes) {
        for (; this.indexes[o] < this.nodes.length && (u = this.indexes[o], p = a(this.nodes[u], u), p !== false); ) this.indexes[o] += 1;
    ...
    walk(a) {
      return this.each((o, u) => {
        let p = a(o, u);
        return p !== false && o.walk && (p = o.walk(a)), p;
      });
    }
    walkType(a, o) {
  ...
  var i = Z(), r = te(), a = class extends r {
    constructor(o) {
      super(o), this.type = "comment", this.inline = Object(o).inline || false;
    }
    toString() {
    ...
    for (; l < h; ) {
      switch (f = t.charCodeAt(l), f === 10 && (c = l, d += 1), f) {
        ...
        case 34:
          O = f === 39 ? "'" : '"', g = l;
          do
            for (E = false, g = t.indexOf(O, g + 1), g === -1 && $("quote"), P = g; t.charCodeAt(P - 1) === 92; ) P -= 1, E = !E;
          while (E);
...
`), x = b.length - 1, x > 0 ? (T = d + x, S = g - b[x].length) : (T = d, S = c), n.push(["comment", k, d, l - c, T, g - S, l]), c = S, d = T, l = g;
  ...
  s.exports = class {
    ...
    comment() {
      let b = false, x = this.currToken[1].replace(/\/\*|\*\//g, ""), k;
      this.options.loose && x.startsWith("//") && (x = x.substring(2), b = true), k = new p({ value: x, inline: b, source: { start: { line: this.currToken[2], column: this.currToken[3] }, end: { line: this.currToken[4], column: this.currToken[5] } }, sourceIndex: this.currToken[6] }), this.newNode(k), this.position++;
    }
    error(b, x) {
...
var V = { type: Te }, Y = { type: Te, soft: true }, Tn = { type: Te, hard: true }, D = [Tn, $t];
function On(e) {
...
function An(e, s) {
  let { preferred: i, alternate: r } = s === true || s === "'" ? Cn : Sn, { length: a } = e, o = 0, u = 0;
  for (let p = 0; p < a; p++) {
...
var _r = Mn, Rn = class extends Error {
  constructor(e, s, i = "type") {
    super(`Unexpected ${s} node ${i}: ${JSON.stringify(e[i])}.`);
    __publicField(this, "name", "UnexpectedNodeError");
    this.node = e;
  }
}, $n = Rn, Cr = Symbol.for("PRETTIER_IS_FRONT_MATTER");
function Nn(e) {
  return !!(e == null ? void 0 : e[Cr]);
}
var dt = Nn, Se = 3;
function Ln(e) {
  let s = e.slice(0, Se);
...
function Sr(e, s, i) {
  ...
  if (e.type === "css-atrule" && e.name.toLowerCase() === "supports" && delete s.value, e.type === "selector-unknown" && delete s.value, e.type === "value-comma_group") {
    ...
    r !== -1 && (s.groups[r].unit = "", s.groups.splice(r + 1, 0, { type: "value-word", value: "...", isColor: false, isHex: false }));
  }
...
function Nt(e) {
  return (s, i, r) => {
    let a = !!(r == null ? void 0 : r.backwards);
...
function Mr(e, s) {
  var _a, _b, _c;
  if (typeof ((_b = (_a = e.source) == null ? void 0 : _a.start) == null ? void 0 : _b.offset) == "number") return e.source.start.offset;
  if (typeof e.sourceIndex == "number") return e.type === "value-word" ? Pr(e, e.sourceIndex) : e.sourceIndex;
  if ((_c = e.source) == null ? void 0 : _c.start) return Er(e.source.start, s);
  throw Object.assign(new Error("Can not locate node."), { node: e });
}
function Lt(e, s) {
  var _a, _b;
  if (e.type === "css-comment" && e.inline) return Ir(s, e.source.startOffset);
  if (typeof ((_b = (_a = e.source) == null ? void 0 : _a.end) == null ? void 0 : _b.offset) == "number") return e.source.end.offset;
  if (e.source) {
    if (e.source.end) {
...
function Kn(e) {
  ...
  return typeof e.prop == "string" && (s += e.prop.length), e.type === "css-atrule" && typeof e.name == "string" && (s += 1 + e.name.length + e.raws.afterName.match(/^\s*:?\s*/u)[0].length), e.type !== "css-atrule" && typeof ((_a = e.raws) == null ? void 0 : _a.between) == "string" && (s += e.raws.between.length), s;
}
function Xn(e) {
  let s = "initial", i = "initial", r, a = false, o = [];
...
` || p === "\r") return e;
      ...
      case "comment-inline":
        (p === '"' || p === "'" || p === "*") && (a = true), (p === `
` || p === "\r") && (a && o.push([r, u]), s = "initial", a = false);
        continue;
    }
  }
...
var G = (e) => {
  var _a;
  return (_a = e.source) == null ? void 0 : _a.startOffset;
}, J = (e) => {
  var _a;
  return (_a = e.source) == null ? void 0 : _a.endOffset;
}, eo = /\*\/$/, to = /^\/\*\*?/, Nr = /^\s*(\/\*\*?(.|\r?\n)*?\*\/)/, ro = /(^|\s+)\/\/([^\n\r]*)/g, Dt = /^(\r?\n)+/, so = /(?:^|\r?\n) *(@[^\n\r]*?) *\r?\n *(?![^\n\r@]*\/\/[^]*)([^\s@][^\n\r@]+?) *\r?\n/g, Ut = /(?:^|\r?\n) *@(\S+) *([^\n\r]*)/g, no = /(\r?\n|^) *\* ?/g, Lr = [];
function oo(e) {
  let s = e.match(Nr);
...
function io(e) {
  var _a;
  let s = (_a = e.match(Nr)) == null ? void 0 : _a[0];
...
function ko(e) {
  var _a, _b;
  return (_b = (_a = e.findAncestor((s) => s.type === "css-decl")) == null ? void 0 : _a.prop) == null ? void 0 : _b.toLowerCase();
}
...
function _o(e, s) {
  var _a, _b;
  return ((_b = (_a = e.findAncestor((i) => i.type === "css-atrule")) == null ? void 0 : _a.name) == null ? void 0 : _b.toLowerCase().endsWith("keyframes")) && ["from", "to"].includes(s.toLowerCase());
}
function Ee(e) {
...
function Ze(e, s) {
  var _a, _b;
  return ((_b = (_a = e.findAncestor((i) => i.type === "value-func")) == null ? void 0 : _a.value) == null ? void 0 : _b.toLowerCase()) === s;
}
function Co(e) {
  return e.hasAncestor((s) => {
    var _a;
    if (s.type !== "css-rule") return false;
    let i = (_a = s.raws) == null ? void 0 : _a.selector;
...
function So(e) {
  var _a, _b;
  let { node: s } = e;
  return ((_a = s.groups[0]) == null ? void 0 : _a.value) === "url" && s.groups.length === 2 && ((_b = e.findAncestor((i) => i.type === "css-atrule")) == null ? void 0 : _b.name) === "import";
}
function Ao(e) {
...
function jo(e) {
  let { selector: s } = e;
  return s ? typeof s == "string" && /^@.+:.*$/u.test(s) || s.value && /^@.+:.*$/u.test(s.value) : false;
}
function Io(e) {
...
function Gt(e) {
  var _a;
  return ((_a = e.raws) == null ? void 0 : _a.params) && /^\(\s*\)$/u.test(e.raws.params);
}
function ct(e) {
...
function zo(e) {
  var _a, _b;
  return ((_a = e.value) == null ? void 0 : _a.type) === "value-root" && ((_b = e.value.group) == null ? void 0 : _b.type) === "value-value" && e.prop.toLowerCase() === "composes";
}
function Bo(e) {
  var _a, _b, _c;
  return ((_c = (_b = (_a = e.value) == null ? void 0 : _a.group) == null ? void 0 : _b.group) == null ? void 0 : _c.type) === "value-paren_group" && e.value.group.group.open !== null && e.value.group.group.close !== null;
}
function oe(e) {
  var _a;
  return ((_a = e == null ? void 0 : e.raws) == null ? void 0 : _a.before) === "";
}
function zt(e) {
  var _a, _b;
  return e.type === "value-comma_group" && ((_b = (_a = e.groups) == null ? void 0 : _a[1]) == null ? void 0 : _b.type) === "value-colon";
}
function pt(e) {
  var _a;
  return e.type === "value-paren_group" && ((_a = e.groups) == null ? void 0 : _a[0]) && zt(e.groups[0]);
}
function Wr(e, s) {
  var _a, _b;
  if (s.parser !== "scss") return false;
  let { node: i } = e;
  if (i.groups.length === 0) return false;
  let r = e.grandparent;
  return !pt(i) && !(r && pt(r)) ? false : !!(((_b = (_a = e.findAncestor((a) => a.type === "css-decl")) == null ? void 0 : _a.prop) == null ? void 0 : _b.startsWith("$")) || pt(r) || r.type === "value-func");
}
function Ve(e) {
...
function qo(e, s) {
  if (!zt(s)) return false;
  let { groups: i } = s, r = i.indexOf(e);
  return r === -1 ? false : vt(i[r + 1]);
}
function Fo(e) {
  return e.value && ["not", "and", "or"].includes(e.value.toLowerCase());
}
function Do(e) {
  return e.type !== "value-func" ? false : xo.has(e.value.toLowerCase());
}
function je(e) {
...
function Uo(e, s) {
  var _a, _b;
  if (((_a = e.open) == null ? void 0 : _a.value) !== "(" || ((_b = e.close) == null ? void 0 : _b.value) !== ")" || e.groups.some((i) => i.type !== "value-comma_group")) return false;
...
function He(e) {
  var _a, _b;
  return e.type === "value-paren_group" && ((_a = e.open) == null ? void 0 : _a.value) === "(" && ((_b = e.close) == null ? void 0 : _b.value) === ")";
}
function Vo(e, s, i) {
  var _a;
  let { node: r } = e, a = e.parent, o = e.grandparent, u = ko(e), p = u && a.type === "value-value" && (u === "grid" || u.startsWith("grid-template")), y = e.findAncestor((w) => w.type === "css-atrule"), m = y && yt(y, s), n = r.groups.some((w) => Ve(w)), t = e.map(i, "groups"), h = [""], c = Ze(e, "url"), d = false, l = false;
  for (let w = 0; w < r.groups.length; ++w) {
    ...
    if (f.type === "value-string" && f.quoted) {
      ...
      E !== -1 && P !== -1 ? d = E > P : E !== -1 ? d = true : P !== -1 && (d = false);
    }
    if (d || vt(f) || vt(g) || f.type === "value-atword" && (f.value === "" || f.value.endsWith("[")) || g.type === "value-word" && g.value.startsWith("]") || f.value === "~" || s.parser === "less" && ((g == null ? void 0 : g.type) === "value-word" && g.value === "[" || f.type === "value-word" && f.value === "[" && ((g == null ? void 0 : g.type) === "value-atword" || (g == null ? void 0 : g.type) === "value-word") || f.type === "value-word" && f.value === "][" && (g == null ? void 0 : g.type) === "value-word") || f.type !== "value-string" && f.value && f.value.includes("\\") && g && g.type !== "value-comment" || (v == null ? void 0 : v.value) && v.value.indexOf("\\") === v.value.length - 1 && f.type === "value-operator" && f.value === "/" || f.value === "\\" || Wo(f, g) || ht(f) || Jt(f) || ft(g) || Jt(g) && oe(g) || ft(f) && oe(g) || f.value === "--" && ht(g)) continue;
    let b = lt(f), x = lt(g);
    ...
    let T = (O == null ? void 0 : O.type) === "value-func" || O && Ge(O) || f.type === "value-func" || Ge(f), S = g.type === "value-func" || Ge(g) || (v == null ? void 0 : v.type) === "value-func" || v && Ge(v);
    if (!(!(mt(g) || mt(f)) && !Ze(e, "calc") && !k && (we(g) && !T || we(f) && !S || ie(g) && !T || ie(f) && !S || be(g) || be(f)) && (oe(g) || b && (!v || v && lt(v)))) && !((s.parser === "scss" || s.parser === "less") && b && f.value === "-" && He(g) && J(f) === G(g.open) && g.open.value === "(")) {
      ...
      if (p) {
        f.source && g.source && f.source.start.line !== g.source.start.line ? (h.push(D, ""), l = true) : h.push([h.pop(), " "]);
        continue;
      }
      if (!(u && (u === "font" || u.startsWith("--")) && (we(g) && oe(g) && Ht(f) || we(f) && oe(f) && Ht(v)))) {
        ...
        if ((g == null ? void 0 : g.value) !== "..." && !(Je(f) && Je(g) && J(f) === G(g))) {
          ...
          if (!(((_a = f.value) == null ? void 0 : _a.endsWith("#")) && g.value === "{" && He(g.group)) && !(Ve(g) && !O)) {
...
function Ht(e) {
  if ((e == null ? void 0 : e.type) === "value-number") return true;
  if ((e == null ? void 0 : e.type) !== "value-func") return false;
...
var ni = si;
function oi(e, s) {
  return s === false ? false : e.charAt(s) === "/" && e.charAt(s + 1) === "/" ? Ir(e, s) : s;
}
var ii = oi;
function ai(e, s) {
  let i = null, r = s;
  for (; r !== i; ) i = r, r = Yn(e, r), r = ni(e, r), r = jr(e, r);
  return r = ii(e, r), r = Fr(e, r), r !== false && Dr(e, r);
}
var Ur = ai;
...
function ci(e, s, i) {
  ...
  let u = e.map(({ node: c, isLast: d, index: l }) => {
    var _a;
    let w = o[l];
    zt(c) && c.type === "value-comma_group" && c.groups && c.groups[0].type !== "value-paren_group" && ((_a = c.groups[2]) == null ? void 0 : _a.type) === "value-paren_group" && Pe(w) === rt && Pe(w.contents) === tt && Pe(w.contents.contents) === st && (w = K($e(w)));
    let v = [w, d ? li(e, s) : ","];
...
function fi(e, s, i) {
  ...
  return e.each(() => {
    ...
    if ((o == null ? void 0 : o.type) === "css-comment" && o.text.trim() === "prettier-ignore" ? r.push(s.originalText.slice(G(a), J(a))) : r.push(i()), e.isLast) return;
    let { next: u } = e;
    u.type === "css-comment" && !Dr(s.originalText, G(u), { backwards: true }) && !dt(a) || u.type === "css-atrule" && u.name === "else" && a.type !== "css-comment" ? r.push(" ") : (r.push(s.__isHTMLStyleAttribute ? V : D), Ur(s.originalText, J(a)) && !dt(a) && r.push(D));
  }, "nodes"), r;
}
var Ie = fi;
function di(e, s, i) {
  ...
  switch (r.type) {
    ...
    case "css-rule":
      return [i("selector"), r.important ? " !important" : "", r.nodes ? [((_a = r.selector) == null ? void 0 : _a.type) === "selector-unknown" && je(r.selector.value) ? V : r.selector ? " " : "", "{", r.nodes.length > 0 ? Q([D, Ie(e, s, i)]) : "", D, "}", jo(r) ? ";" : ""] : ";"];
    case "css-decl": {
    ...
    case "css-atrule": {
      ...
      let u = r.name === "import" && ((_b = r.params) == null ? void 0 : _b.type) === "value-unknown" && r.params.value.endsWith(";");
    ...
    case "selector-string":
      return ee(r.value, s);
    case "selector-tag":
      return [r.namespace ? [r.namespace === true ? "" : r.namespace.trim(), "|"] : "", ((_c = e.previous) == null ? void 0 : _c.type) === "selector-nesting" ? r.value : ge(_o(e, r.value) ? r.value.toLowerCase() : r.value)];
    case "selector-id":
      return ["#", r.value];
    case "selector-class":
      return [".", ge(ee(r.value, s))];
    case "selector-attribute":
      return ["[", r.namespace ? [r.namespace === true ? "" : r.namespace.trim(), "|"] : "", r.attribute.trim(), r.operator ?? "", r.value ? Xo(ee(r.value.trim(), s), s) : "", r.insensitive ? " i" : "", "]"];
    ...
    case "selector-unknown": {
      if ((_d = e.findAncestor((u) => u.type === "css-rule")) == null ? void 0 : _d.isSCSSNesterProperty) return ge(ee(Ee(r.value), s));
      let a = e.parent;
      if ((_e = a.raws) == null ? void 0 : _e.selector) {
        let u = G(a), p = u + a.raws.selector.length;
        return s.originalText.slice(u, p).trim();
      }
      let o = e.grandparent;
      if (a.type === "value-paren_group" && (o == null ? void 0 : o.type) === "value-func" && o.value === "selector") {
    ...
    case "value-colon": {
      let { previous: a } = e;
      return K([r.value, typeof (a == null ? void 0 : a.value) == "string" && a.value.endsWith("\\") || Ze(e, "url") ? "" : V]);
    }
    case "value-string":
...
var mi = { features: { experimental_frontMatterSupport: { massageAstNode: true, embed: true, print: true } }, print: di, embed: Fn, insertPragma: bo, massageAstNode: qn, getVisitorKeys: Qn }, yi = mi, vi = [{ name: "CSS", type: "markup", aceMode: "css", extensions: [".css", ".wxss"], tmScope: "source.css", codemirrorMode: "css", codemirrorMimeType: "text/css", parsers: ["css"], vscodeLanguageIds: ["css"], linguistLanguageId: 50 }, { name: "PostCSS", type: "markup", aceMode: "text", extensions: [".pcss", ".postcss"], tmScope: "source.postcss", group: "CSS", parsers: ["css"], vscodeLanguageIds: ["postcss"], linguistLanguageId: 262764437 }, { name: "Less", type: "markup", aceMode: "less", extensions: [".less"], tmScope: "source.css.less", aliases: ["less-css"], codemirrorMode: "css", codemirrorMimeType: "text/x-less", parsers: ["less"], vscodeLanguageIds: ["less"], linguistLanguageId: 198 }, { name: "SCSS", type: "markup", aceMode: "scss", extensions: [".scss"], tmScope: "source.css.scss", codemirrorMode: "css", codemirrorMimeType: "text/x-scss", parsers: ["scss"], vscodeLanguageIds: ["scss"], linguistLanguageId: 329 }], gi = { singleQuote: { category: "Common", type: "boolean", default: false, description: "Use single quotes instead of double quotes." } }, wi = { singleQuote: gi.singleQuote }, bi = wi, Gr = {};
...
function Li(e) {
  if (ot(e)) {
    for (let s = e.length - 1; s > 0; s--) if (e[s].type === "word" && e[s].value === "{" && e[s - 1].type === "word" && e[s - 1].value.endsWith("#")) return true;
  }
  return false;
}
var Wi = Li;
...
function Di(e, s) {
  ...
  for (let y = 0; y < i.length; ++y) {
    ...
    if (s.parser === "scss" && m.type === "number" && m.unit === ".." && m.value.endsWith(".") && (m.value = m.value.slice(0, -1), m.unit = "..."), m.type === "func" && m.value === "selector" && (m.group.groups = [le(Hr(e).text.slice(m.group.open.sourceIndex + 1, m.group.close.sourceIndex))]), m.type === "func" && m.value === "url") {
      let n = ((_a = m.group) == null ? void 0 : _a.groups) ?? [], t = [];
...
function Ui(e, s) {
  ...
  let i = null;
  try {
    i = new Mi.default(e, { loose: true }).parse();
  } catch {
...
var Ji = Gi;
function Hi(e, s) {
  return s.parser !== "scss" || !e.selector ? false : e.selector.replace(/\/\*.*?\*\//u, "").replace(/\/\/.*\n/u, "").trim().endsWith(":");
}
  ...
  if (at(e)) {
    ...
    if (e.raws ?? (e.raws = {}), e.type === "css-decl" && typeof e.prop == "string" && e.prop.startsWith("--") && typeof e.value == "string" && e.value.startsWith("{")) {
      ...
      if (e.value.trimEnd().endsWith("}")) {
        ...
        ((_a = n == null ? void 0 : n.nodes) == null ? void 0 : _a.length) === 1 && n.nodes[0].type === "css-rule" && (o = n.nodes[0].nodes);
      }
    ...
    let a = "";
    if (typeof e.params == "string" && (a = e.raws.params ? e.raws.params.scss ?? e.raws.params.raw : e.params, e.raws.afterName && e.raws.afterName.trim().length > 0 && (a = e.raws.afterName + a), e.raws.between && e.raws.between.trim().length > 0 && (a = a + e.raws.between), a = a.trim(), e.raws.params = a), i.trim().length > 0) return i.startsWith("@") && i.endsWith(":") ? e : e.mixin ? (e.selector = ue(i, s), e) : (Qi(e, s) && (e.isSCSSNesterProperty = true), e.selector = le(i), e);
    if (r.trim().length > 0) {
      let o = r.match(Zi);
      o && (r = r.slice(0, o.index), e.scssDefault = true, o[0].trim() !== "!default" && (e.raws.scssDefault = o[0]));
      let u = r.match(Yi);
      if (u && (r = r.slice(0, u.index), e.scssGlobal = true, u[0].trim() !== "!global" && (e.raws.scssGlobal = u[0])), r.startsWith("progid:")) return { type: "value-unknown", value: r };
      e.value = ue(r, s);
    }
    if (s.parser === "less" && e.type === "css-decl" && r.startsWith("extend(") && (e.extend || (e.extend = e.raws.between === ":"), e.extend && !e.selector && (delete e.value, e.selector = le(r.slice(7, -1)))), e.type === "css-atrule") {
      ...
      if (s.parser === "less") {
        ...
        if (!["page", "nest", "keyframes"].includes(e.name) && ((_b = e.params) == null ? void 0 : _b[0]) === ":") {
          e.variable = true;
