import { c as Ll, e as Ml, b as ae, r as Rt, j as Q, d as ql } from "./index-BtmU1OS0.js";
import { R as Pl } from "./RelatedTools-GVPazTWJ.js";
import { T as jl } from "./ToolLayout-CgcEif7J.js";
import { F as Xl } from "./FileUploader-xSS6jOvf.js";
import { j as Vl } from "./jszip.min-C_BKxssD.js";
import { E as Hl } from "./jspdf.es.min-PShLCHje.js";
import { F as Fc } from "./tools-DOXC7sEs.js";
import { D as $l } from "./download-Cb6qc09_.js";
import { S as zl, G as Gl } from "./shield-C_IpXjfc.js";
import "./index-BhP_zCBa.js";
...
function la(e) {
  return e === true || e === false || ht.call(e) === "[object Boolean]";
}
function Cu(e) {
...
var ku = Zl && (!/\[native code\]/.test(String(DataView)) || Ru(new DataView(new ArrayBuffer(8)))), pa = typeof Map < "u" && Ru(/* @__PURE__ */ new Map()), af = We("DataView");
function cf(e) {
  return e != null && Ce(e.getInt8) && ga(e.buffer);
}
const gt = ku ? cf : af, En = Jl || We("Array");
function Fn(e, n) {
...
function sf(e) {
  return Sc ? Sc(e) && !gt(e) : of(e) && uf.test(ht.call(e));
}
const ya = Eu ? sf : ba(false), ke = Lu("length");
function df(e) {
...
function qu(e) {
  ...
  var n = ke(e);
  return typeof n == "number" && (En(e) || ri(e) || ai(e)) ? n === 0 : ke(xe(e)) === 0;
}
function Da(e, n) {
...
function Pu(e, n, t, i) {
  ...
  var r = ht.call(e);
  if (r !== ht.call(n)) return false;
  if (ku && r == "[object Object]" && gt(e)) {
...
const wa = _a(tt), Yn = _a(xe), Ea = _a(tt, true);
function hf() {
  return function() {
  };
}
...
function Ju(e) {
  return wn(e) ? En(e) ? e.slice() : wa({}, e) : e;
}
function es(e, n) {
  return n(e), e;
}
...
function ts(e, n, t) {
  return e == null ? ci : Ce(e) ? At(e, n, t) : wn(e) && !En(e) ? Sn(e) : oi(e);
}
function ui(e, n) {
  return ts(e, n, 1 / 0);
}
...
var yf = /^\s*(\w|\$)+\s*$/;
function ls(e, n, t) {
  !n && t && (n = t), n = Ea({}, n, ce.templateSettings);
...
function Ln(e, n, t, i) {
  ...
  for (var r = i.length, a = 0, c = ke(e); a < c; a++) {
    var u = e[a];
    if (je(u) && (En(u) || ai(u))) if (n > 1) Ln(u, n - 1, t, i), r = i.length;
...
function ws(e) {
  return function(n, t, i) {
    t = Ie(t, i);
    for (var r = ke(n), a = e > 0 ? 0 : r - 1; a >= 0 && a < r; a += e) if (t(n[a], a, n)) return a;
    return -1;
  };
}
const di = ws(1), ka = ws(-1);
function Oa(e, n, t, i) {
  t = Ie(t, i, 1);
  for (var r = t(n), a = 0, c = ke(e); a < c; ) {
...
function Es(e, n, t) {
  return function(i, r, a) {
    ...
    if (r !== r) return a = n(Et.call(i, c, u), ma), a >= 0 ? a + c : -1;
    for (a = e > 0 ? c : u - 1; a >= 0 && a < u; a += e) if (i[a] === r) return a;
    return -1;
  };
}
const Ia = Es(1, di, Oa), Fs = Es(-1, ka);
function mt(e, n, t) {
...
function Ye(e, n, t, i) {
  return je(e) || (e = On(e)), (typeof t != "number" || i) && (t = 0), Ia(e, n, t) >= 0;
}
const Bs = Se(function(e, n, t) {
  var i, r;
  return Ce(n) ? r = n : (n = Ft(n), i = n.slice(0, -1), n = n[n.length - 1]), hn(e, function(a) {
    var c = r;
    if (!c) {
...
var xf = /[^\ud800-\udfff]|[\ud800-\udbff][\udc00-\udfff]|[\ud800-\udfff]/g;
function Ma(e) {
  return e ? En(e) ? Et.call(e) : ri(e) ? e.match(xf) : je(e) ? hn(e, ci) : On(e) : [];
}
function qa(e, n, t) {
  if (n == null || t) return je(e) || (e = On(e)), e[$t(e.length - 1)];
  var i = Ma(e), r = ke(i);
...
const Pa = Se(function(e, n) {
  var t = {}, i = n[0];
  if (e == null) return t;
  Ce(i) ? (n.length > 1 && (i = At(i, n[1])), n = tt(e)) : (i = vf, n = Ln(n, false, false), e = Object(e));
...
function ja(e, n, t) {
  return Et.call(e, 0, Math.max(0, e.length - (n == null || t ? 1 : n)));
}
function Gn(e, n, t) {
  return e == null || e.length < 1 ? n == null || t ? void 0 : [] : n == null || t ? e[0] : ja(e, e.length - n);
}
function Bn(e, n, t) {
  return Et.call(e, n == null || t ? 1 : n);
}
function js(e, n, t) {
...
const $s = Se(function(e) {
  return bt(Ln(e, true, true));
});
function zs(e) {
  for (var n = [], t = arguments.length, i = 0, r = ke(e); i < r; i++) {
    var a = e[i];
    if (!Ye(n, a)) {
      var c;
...
function yt(e) {
  for (var n = e && La(e, ke).length || 0, t = Array(n), i = 0; i < n; i++) t[i] = li(e, i);
  return t;
}
const Gs = Se(yt);
function Ys(e, n) {
  for (var t = {}, i = 0, r = ke(e); i < r; i++) n ? t[e[i]] = n[i] : t[e[i][0]] = e[i][1];
  return t;
}
function Qs(e, n, t) {
...
function Ks(e, n) {
  ...
  for (var t = [], i = 0, r = e.length; i < r; ) t.push(Et.call(e, i, i += n));
  return t;
}
function Va(e, n) {
...
const Uf = Object.freeze(Object.defineProperty({ __proto__: null, VERSION: ua, after: Ts, all: Gt, allKeys: tt, any: Yt, assign: Yn, before: Na, bind: Ba, bindAll: ms, chain: gs, chunk: Ks, clone: Ju, collect: hn, compact: Xs, compose: Us, constant: ba, contains: Ye, countBy: Ls, create: Zu, debounce: xs, default: ce, defaults: Ea, defer: ys, delay: Sa, detect: mt, difference: Xa, drop: Bn, each: Ke, escape: us, every: Gt, extend: wa, extendOwn: Yn, filter: Tn, find: mt, findIndex: di, findKey: Ra, findLastIndex: ka, findWhere: As, first: Gn, flatten: Vs, foldl: zn, foldr: zt, forEach: Ke, functions: pt, get: Ca, groupBy: Os, has: ns, head: Gn, identity: ci, include: Ye, includes: Ye, indexBy: Is, indexOf: Ia, initial: ja, inject: zn, intersection: zs, invert: Ta, invoke: Bs, isArguments: ai, isArray: En, isArrayBuffer: ga, isBoolean: la, isDataView: gt, isDate: Wu, isElement: Cu, isEmpty: qu, isEqual: ju, isError: Su, isFinite: Ou, isFunction: Ce, isMap: $u, isMatch: Da, isNaN: ma, isNull: Au, isNumber: fa, isObject: wn, isRegExp: Bu, isSet: Gu, isString: ri, isSymbol: ha, isTypedArray: ya, isUndefined: da, isWeakMap: zu, isWeakSet: Yu, iteratee: ui, keys: xe, last: js, lastIndexOf: Fs, map: hn, mapObject: is, matcher: Sn, matches: Sn, max: La, memoize: bs, methods: pt, min: Ns, mixin: Ha, negate: si, noop: Wa, now: Qn, object: Ys, omit: Ps, once: _s, pairs: Qu, partial: In, partition: Ms, pick: Pa, pluck: li, property: oi, propertyOf: rs, random: $t, range: Qs, reduce: zn, reduceRight: zt, reject: Ws, rest: Bn, restArguments: Se, result: fs, sample: qa, select: Tn, shuffle: Rs, size: qs, some: Yt, sortBy: ks, sortedIndex: Oa, tail: Bn, take: Gn, tap: es, template: ls, templateSettings: ds, throttle: Ds, times: as, toArray: Ma, toPath: Fa, transpose: yt, unescape: ss, union: $s, uniq: bt, unique: bt, uniqueId: hs, unzip: yt, values: On, where: Ss, without: Hs, wrap: vs, zip: Gs }, Symbol.toStringTag, { value: "Module" }));
var ia = Ha(Uf);
ia._ = ia;
const Tf = Object.freeze(Object.defineProperty({ __proto__: null, VERSION: ua, after: Ts, all: Gt, allKeys: tt, any: Yt, assign: Yn, before: Na, bind: Ba, bindAll: ms, chain: gs, chunk: Ks, clone: Ju, collect: hn, compact: Xs, compose: Us, constant: ba, contains: Ye, countBy: Ls, create: Zu, debounce: xs, default: ia, defaults: Ea, defer: ys, delay: Sa, detect: mt, difference: Xa, drop: Bn, each: Ke, escape: us, every: Gt, extend: wa, extendOwn: Yn, filter: Tn, find: mt, findIndex: di, findKey: Ra, findLastIndex: ka, findWhere: As, first: Gn, flatten: Vs, foldl: zn, foldr: zt, forEach: Ke, functions: pt, get: Ca, groupBy: Os, has: ns, head: Gn, identity: ci, include: Ye, includes: Ye, indexBy: Is, indexOf: Ia, initial: ja, inject: zn, intersection: zs, invert: Ta, invoke: Bs, isArguments: ai, isArray: En, isArrayBuffer: ga, isBoolean: la, isDataView: gt, isDate: Wu, isElement: Cu, isEmpty: qu, isEqual: ju, isError: Su, isFinite: Ou, isFunction: Ce, isMap: $u, isMatch: Da, isNaN: ma, isNull: Au, isNumber: fa, isObject: wn, isRegExp: Bu, isSet: Gu, isString: ri, isSymbol: ha, isTypedArray: ya, isUndefined: da, isWeakMap: zu, isWeakSet: Yu, iteratee: ui, keys: xe, last: js, lastIndexOf: Fs, map: hn, mapObject: is, matcher: Sn, matches: Sn, max: La, memoize: bs, methods: pt, min: Ns, mixin: Ha, negate: si, noop: Wa, now: Qn, object: Ys, omit: Ps, once: _s, pairs: Qu, partial: In, partition: Ms, pick: Pa, pluck: li, property: oi, propertyOf: rs, random: $t, range: Qs, reduce: zn, reduceRight: zt, reject: Ws, rest: Bn, restArguments: Se, result: fs, sample: qa, select: Tn, shuffle: Rs, size: qs, some: Yt, sortBy: ks, sortedIndex: Oa, tail: Bn, take: Gn, tap: es, template: ls, templateSettings: ds, throttle: Ds, times: as, toArray: Ma, toPath: Fa, transpose: yt, unescape: ss, union: $s, uniq: bt, unique: bt, uniqueId: hs, unzip: yt, values: On, where: Ss, without: Hs, wrap: vs, zip: Gs }, Symbol.toStringTag, { value: "Module" })), be = Ml(Tf);
var $a = {}, Ue = {}, Zs = { exports: {} }, kt = { exports: {} }, Oc;
function it() {
  if (Oc) return kt.exports;
  Oc = 1;
  var e = /* @__PURE__ */ function() {
    return this === void 0;
  }();
  if (e) kt.exports = { freeze: Object.freeze, defineProperty: Object.defineProperty, getDescriptor: Object.getOwnPropertyDescriptor, keys: Object.keys, names: Object.getOwnPropertyNames, getPrototypeOf: Object.getPrototypeOf, isArray: Array.isArray, isES5: e, propertyIsWritable: function(d, l) {
    ...
    kt.exports = { isArray: s, keys: r, names: r, defineProperty: c, getDescriptor: a, freeze: u, getPrototypeOf: o, isES5: e, propertyIsWritable: function() {
      return true;
    } };
  }
  return kt.exports;
...
function le() {
  if (Ic) return $i;
  Ic = 1;
  var e = {}, n = it(), t = typeof navigator > "u", i = { e: {} }, r, a = typeof self < "u" ? self : typeof window < "u" ? window : typeof ae < "u" ? ae : ae !== void 0 ? ae : null;
  function c() {
    try {
      var E = r;
  ...
  var o = function(E, H) {
    ...
    function Y() {
      this.constructor = E, this.constructor$ = H;
      for (var K in H.prototype) ee.call(H.prototype, K) && K.charAt(K.length - 1) !== "$" && (this[K + "$"] = H.prototype[K]);
    }
    return Y.prototype = H.prototype, E.prototype = new Y(), E.prototype;
  };
  function s(E) {
    return E == null || E === true || E === false || typeof E == "string" || typeof E == "number";
  }
  function d(E) {
    return typeof E == "function" || typeof E == "object" && E !== null;
  }
  function l(E) {
    return s(E) ? new Error(w(E)) : E;
  }
  function g(E, H) {
    var ee = E.length, Y = new Array(ee + 1), K;
    for (K = 0; K < ee; ++K) Y[K] = E[K];
    return Y[K] = H, Y;
  }
  function D(E, H, ee) {
    if (n.isES5) {
      var Y = Object.getOwnPropertyDescriptor(E, H);
      if (Y != null) return Y.get == null && Y.set == null ? Y.value : ee;
    } else return {}.hasOwnProperty.call(E, H) ? E[H] : void 0;
  }
  function y(E, H, ee) {
    if (s(E)) return E;
    var Y = { value: ee, configurable: true, enumerable: false, writable: true };
    return n.defineProperty(E, H, Y), E;
  }
  function p(E) {
    throw E;
  }
  var h = function() {
    var E = [Array.prototype, Object.prototype, Function.prototype], H = function(K) {
      for (var se = 0; se < E.length; ++se) if (E[se] === K) return true;
      return false;
    };
    if (n.isES5) {
      var ee = Object.getOwnPropertyNames;
      return function(K) {
        for (var se = [], Te = /* @__PURE__ */ Object.create(null); K != null && !H(K); ) {
          var Ne;
          try {
            Ne = ee(K);
          } catch {
      ...
      return function(K) {
        if (H(K)) return [];
        var se = [];
        e: for (var Te in K) if (Y.call(K, Te)) se.push(Te);
        else {
          for (var Ne = 0; Ne < E.length; ++Ne) if (Y.call(E[Ne], Te)) continue e;
          se.push(Te);
        }
        return se;
      };
  ...
  function f(E) {
    try {
      if (typeof E == "function") {
        var H = n.names(E.prototype), ee = n.isES5 && H.length > 1, Y = H.length > 0 && !(H.length === 1 && H[0] === "constructor"), K = b.test(E + "") && n.names(E).length > 0;
        if (ee || Y || K) return true;
      }
      return false;
    } catch {
      return false;
  ...
  function x(E, H, ee) {
    for (var Y = new Array(E), K = 0; K < E; ++K) Y[K] = H + K + ee;
    return Y;
  }
  function w(E) {
    try {
  ...
  function $(E) {
    return E == null ? false : E instanceof Error.__BluebirdErrorTypes__.OperationalError || E.isOperational === true;
  }
  function V(E) {
    return N(E) && n.propertyIsWritable(E, "stack");
  }
  var F = function() {
    return "stack" in new Error() ? function(E) {
      return V(E) ? E : new Error(w(E));
    } : function(E) {
      if (V(E)) return E;
      try {
        throw new Error(w(E));
  ...
  function j(E, H, ee) {
    for (var Y = n.names(E), K = 0; K < Y.length; ++K) {
      var se = Y[K];
      if (ee(se)) try {
        n.defineProperty(H, se, n.getDescriptor(E, se));
      } catch {
      }
    }
  }
  ...
  if (typeof Symbol < "u" && Symbol.iterator) {
    var v = typeof Array.from == "function" ? function(E) {
      return Array.from(E);
    } : function(E) {
      for (var H = [], ee = E[Symbol.iterator](), Y; !(Y = ee.next()).done; ) H.push(Y.value);
      return H;
    };
    z = function(E) {
      return n.isArray(E) ? E : E != null && typeof E[Symbol.iterator] == "function" ? v(E) : null;
    };
  }
...
`);
  ...
  if (e.isNode && typeof MutationObserver > "u") {
    var r = ae.setImmediate, a = process.nextTick;
...
`);
  ...
  }, Ot.exports = r, Ot.exports.firstLineError = e, Ot.exports;
}
var Yi, Pc;
function _n() {
  if (Pc) return Yi;
...
`);
        ...
        }, e.prototype._captureStackTrace = R, e.prototype._attachExtraTrace = k, n.activateLongStackTraces(), i.disableTrampolineIfNecessary();
      }
    }, e.hasLongStackTraces = function() {
      return ye.longStackTraces && Z();
    };
    var T = function() {
      try {
        if (typeof CustomEvent == "function") {
          ...
          return a.global.dispatchEvent(A), function(q, P) {
            var J = new Event(q.toLowerCase(), { cancelable: true });
            return J.detail = P, !a.global.dispatchEvent(J);
          };
        } else {
          ...
          return A.initCustomEvent("testingtheevent", false, true, {}), a.global.dispatchEvent(A), function(q, P) {
            ...
            return J.initCustomEvent(q.toLowerCase(), false, true, P), !a.global.dispatchEvent(J);
          };
        }
      } catch {
      }
    ...
    var N = { promiseCreated: w, promiseFulfilled: w, promiseRejected: w, promiseResolved: w, promiseCancelled: w, promiseChained: function(A, S, q) {
      return { promise: S, child: q };
    }, warning: function(A, S) {
      return { warning: S };
    }, unhandledRejection: function(A, S, q) {
      return { reason: S, promise: q };
    }, rejectionHandled: w }, O = function(A) {
      var S = false;
      try {
    ...
    e.config = function(A) {
      ...
      return "monitoring" in A && (A.monitoring && !ye.monitoring ? (ye.monitoring = true, e.prototype._fireEvent = O) : !A.monitoring && ye.monitoring && (ye.monitoring = false, e.prototype._fireEvent = $)), e;
    };
    function $() {
      return false;
    }
    ...
    function V(A, S, q) {
      ...
      try {
        A(S, q, function(J) {
          if (typeof J != "function") throw new TypeError("onCancel must be a function, got: " + a.toString(J));
          P._attachCancellationCallback(J);
        });
      } catch (J) {
        return J;
      }
...
`)), a.notEnumerableProp(A, "__stackCleaned__", true);
    ...
    function X(A, S, q, P, J) {
      if (A === void 0 && S !== null && m) {
        if (J !== void 0 && J._returnedNonUndefined() || !(P._bitField & 65535)) return;
        q && (q = q + " ");
        var pe = "", de = "";
        if (S._trace) {
          for (var ne = S._trace.stack.split(`
`), he = se(ne), De = he.length - 1; De >= 0; --De) {
            var on = he[De];
            if (!d.test(on)) {
              var un = on.match(l);
          ...
          if (he.length > 0) {
            for (var Ol = he[0], De = 0; De < ne.length; ++De) if (ne[De] === Ol) {
              De > 0 && (de = `
` + ne[De - 1]);
              break;
            }
    ...
    function H(A, S, q) {
      if (ye.warnings) {
        ...
        else if (ye.longStackTraces && (J = e._peekContext())) J.attachExtraTrace(P);
        else {
          var pe = Ne(P);
          P.stack = pe.message + `
` + pe.stack.join(`
...
`);
    ...
    function K(A) {
      for (var S = A[0], q = 1; q < A.length; ++q) {
        for (var P = A[q], J = S.length - 1, pe = S[J], de = -1, ne = P.length - 1; ne >= 0; --ne) if (P[ne] === pe) {
          de = ne;
          break;
        }
        for (var ne = de; ne >= 0; --ne) {
          var he = P[ne];
          if (S[J] === he) S.pop(), J--;
          else break;
        }
    ...
    function se(A) {
      for (var S = [], q = 0; q < A.length; ++q) {
        var P = A[q], J = P === "    (No stack trace)" || g.test(P), pe = J && te(P);
        J && !pe && (y && P.charAt(0) !== " " && (P = "    " + P), S.push(P));
      }
      return S;
    }
    function Te(A) {
...
`), q = 0; q < S.length; ++q) {
    ...
    function C(A, S, q, P) {
      var J = false;
      try {
        typeof S == "function" && (J = true, A === "rejectionHandled" ? S(P) : S(q, P));
      } catch (pe) {
        i.throwLater(pe);
      }
      A === "unhandledRejection" ? !O(A, q, P) && !J && yn(q, "Unhandled rejection ") : O(A, P);
    }
    function M(A) {
      var S;
...
`), P = S.stack.split(`
`), J = -1, pe = -1, de, ne, he = 0; he < q.length; ++he) {
          var De = ge(q[he]);
          if (De) {
            de = De.fileName, J = De.line;
            break;
          }
        }
        for (var he = 0; he < P.length; ++he) {
          var De = ge(P[he]);
          if (De) {
            ne = De.fileName, pe = De.line;
            break;
          }
        }
        J < 0 || pe < 0 || !de || !ne || de !== ne || J >= pe || (te = function(on) {
          if (s.test(on)) return true;
          var un = ge(on);
          return !!(un && un.fileName === de && J <= un.line && un.line <= pe);
        });
      }
    }
    function He(A) {
    ...
    a.inherits(He, Error), n.CapturedTrace = He, He.prototype.uncycle = function() {
      var A = this._length;
      if (!(A < 2)) {
        for (var S = [], q = {}, P = 0, J = this; J !== void 0; ++P) S.push(J), J = J._parent;
        A = this._length = P;
        for (var P = A - 1; P >= 0; --P) {
          var pe = S[P].stack;
          q[pe] === void 0 && (q[pe] = P);
        ...
        for (var P = 0; P < A; ++P) {
          var de = S[P].stack, ne = q[de];
          if (ne !== void 0 && ne !== P) {
            ne > 0 && (S[ne - 1]._parent = void 0, S[ne - 1]._length = 1), S[P]._parent = void 0, S[P]._length = 1;
            var he = P > 0 ? S[P - 1] : this;
            ne < A - 1 ? (he._parent = S[ne + 1], he._parent.uncycle(), he._length = he._parent._length + 1) : (he._parent = void 0, he._length = 1);
      ...
      if (!A.__stackCleaned__) {
        this.uncycle();
        for (var S = Ne(A), q = S.message, P = [S.stack], J = this; J !== void 0; ) P.push(se(J.stack.split(`
`))), J = J._parent;
        K(P), Y(P), a.notEnumerableProp(A, "stack", ee(q, P)), a.notEnumerableProp(A, "__stackCleaned__", true);
      }
    };
    var ot = function() {
      var S = /^\s*at\s*/, q = function(de, ne) {
        return typeof de == "string" ? de : ne.name !== void 0 && ne.message !== void 0 ? ne.toString() : M(ne);
      };
      if (typeof Error.stackTraceLimit == "number" && typeof Error.captureStackTrace == "function") {
        ...
        return te = function(de) {
          ...
          Error.stackTraceLimit += 6, P(de, ne), Error.stackTraceLimit -= 6;
        };
      }
      var J = new Error();
      if (typeof J.stack == "string" && J.stack.split(`
`)[0].indexOf("stackDetection@") >= 0) return g = /@/, D = q, y = true, function(ne) {
        ne.stack = new Error().stack;
      };
      var pe;
      try {
        throw new Error();
      ...
      return !("stack" in J) && pe && typeof Error.stackTraceLimit == "number" ? (g = S, D = q, function(ne) {
        ...
        return typeof de == "string" ? de : (typeof ne == "object" || typeof ne == "function") && ne.name !== void 0 && ne.message !== void 0 ? ne.toString() : M(ne);
      }, null);
    }();
...
`);
    ...
    return f && e.longStackTraces(), { longStackTraces: function() {
      ...
      return W;
    }, checkForgottenReturns: X, setBounds: Ve, warn: H, deprecated: E, CapturedTrace: He, fireDomEvent: T, fireGlobalEvent: x };
  }), Ji;
}
var er, $c;
function Bf() {
...
`), w = m.join(", "), N = "Holder$" + f, O = `return function(tryCatch, errorObj, Promise, async) {    
	            'use strict';                                                    
	            function [TheName](fn) {                                         
	                [TheProperties]                                              
	                this.fn = fn;                                                
	        ...
	        `;
        return O = O.replace(/\[TheName\]/g, N).replace(/\[TheTotal\]/g, f).replace(/\[ThePassedArguments\]/g, w).replace(/\[TheProperties\]/g, T).replace(/\[CancellationCode\]/g, x), new Function("tryCatch", "errorObj", "Promise", "async", O)(o, s, e, r);
    ...
    e.join = function() {
      ...
      if (f > 0 && typeof arguments[f] == "function" && (m = arguments[f], f <= 8 && u)) {
        ...
        for (var U = y[f - 1], T = new U(m), x = p, w = 0; w < f; ++w) {
          var N = t(arguments[w], j);
          if (N instanceof e) {
            N = N._target();
            var O = N._bitField;
            O & 50397184 ? O & 33554432 ? x[w].call(j, N._value(), T) : O & 16777216 ? j._reject(N._reason()) : j._cancel() : (N._then(x[w], d, void 0, j, T), h[w](N, T), T.asyncNeeded = false);
          } else x[w].call(j, N, T);
        }
        if (!j._isFateSealed()) {
          if (T.asyncNeeded) {
  ...
  return no || (no = 1, sr = function(e, n, t, i, r, a) {
    ...
    u.inherits(l, n), l.prototype._asyncInit = function() {
      ...
      if (y < 0) {
        ...
        m._pushContext();
        var x = o(U).call(T, D, y, h), w = m._popContext();
        if (a.checkForgottenReturns(x, w, b !== null ? "Promise.filter" : "Promise.map", m), x === s) return this._reject(x.e), true;
        var N = i(x, this._promise);
        if (N instanceof e) {
          N = N._target();
          var O = N._bitField;
          if (O & 50397184) if (O & 33554432) x = N._value();
          else return O & 16777216 ? (this._reject(N._reason()), true) : (this._cancel(), true);
...
function Pf() {
  return io || (io = 1, lr = function(e, n, t, i, r, a) {
    ...
    function y(m, U) {
      var T = 0, x = m.length, w = new e(r);
      function N() {
        if (T >= x) return w._fulfill();
        var O = D(m[T++]);
        if (O instanceof e && O._isDisposable()) {
          try {
            O = t(O._getDisposer().tryDispose(U), m.promise);
          } catch ($) {
            return g($);
          }
          if (O instanceof e) return O._then(N, g, null, null, null);
        }
        N();
      }
      return N(), w;
    ...
    f.prototype._resultCancelled = function() {
      ...
      for (var w = new f(m), N = 0; N < m; ++N) {
        var O = T[N];
        if (p.isDisposer(O)) {
          var $ = O;
          O = O.promise(), O._setDisposable($);
        } else {
          var V = t(O);
          V instanceof e && (O = V._then(b, null, null, { resources: w, index: N }, void 0));
        }
        w[N] = O;
      }
      for (var F = new Array(w.length), N = 0; N < F.length; ++N) F[N] = e.resolve(w[N]).reflect();
      ...
      return w.promise = j, j._setOnCancel(w), j;
...
`.replace("%s", j));
    ...
    function f(I, j, z, v) {
      for (var B = i.inheritedDataKeys(I), _ = [], W = 0; W < B.length; ++W) {
        var R = B[W], k = I[R], X = v === D ? true : D(R);
        typeof k == "function" && !p(k) && !h(I, R, j) && v(R, k, I, X) && _.push(R, k);
      }
      return b(_, j, z), _;
    }
    var m = function(I) {
    ...
    }, U;
    {
      ...
      U = function(I, j, z, v, B, _) {
        var W = Math.max(0, N(v) - 1), R = T(W), k = typeof I == "string" || j === t;
        function X(Y) {
          var K = x(Y).join(", "), se = Y > 0 ? ", " : "", Te;
          return k ? Te = `ret = callback.call(this, {{args}}, nodeback); break;
` : Te = j === void 0 ? `ret = callback({{args}}, nodeback); break;
` : `ret = callback.call(receiver, {{args}}, nodeback); break;
`, Te.replace("{{args}}", K).replace(", ", se);
        }
        function E() {
          for (var Y = "", K = 0; K < R.length; ++K) Y += "case " + R[K] + ":" + X(R[K]);
          return Y += `                                                             
	        default:                                                             
...
`), Y;
        ...
        var H = typeof I == "string" ? "this != null ? this['" + I + "'] : fn" : "fn", ee = `'use strict';                                                
	        ...
	        return ret;                                                          
	    `.replace("[CodeForSwitchCase]", E()).replace("[GetFunctionCode]", H);
        return ee = ee.replace("Parameters", w(W)), new Function("Promise", "fn", "receiver", "withAppended", "maybeWrapAsError", "nodebackForPromise", "tryCatch", "errorObj", "notEnumerableProp", "INTERNAL", ee)(e, v, j, a, c, r, i.tryCatch, i.errorObj, i.notEnumerableProp, n);
      };
    }
    function O(I, j, z, v, B, _) {
      ...
      function k() {
        ...
        var H = typeof R == "string" && this !== W ? this[R] : I, ee = r(E, _);
        try {
          H.apply(X, a(arguments, ee));
        } catch (Y) {
          E._rejectCallback(c(Y), true, true);
        }
        return E._isFateSealed() || E._setAsyncGuaranteed(), E;
      }
      return i.notEnumerableProp(k, "__isPromisified__", true), k;
    }
    var $ = u ? U : O;
    function V(I, j, z, v, B) {
      for (var _ = new RegExp(m(j) + "$"), W = f(I, j, _, z), R = 0, k = W.length; R < k; R += 2) {
        var X = W[R], E = W[R + 1], H = X + j;
        if (v === $) I[H] = $(X, t, X, E, j, B);
        else {
          var ee = v(E, function() {
            return $(X, t, X, E, j, B);
          });
          i.notEnumerableProp(ee, "__isPromisified__", true), I[H] = ee;
        }
      }
...
`);
      for (var W = i.inheritedDataKeys(I), R = 0; R < W.length; ++R) {
        var k = I[W[R]];
        W[R] !== "constructor" && i.isClass(k) && (V(k.prototype, v, B, _, z), V(k, v, B, _, z));
      }
      return V(I, v, B, _, z);
    };
  }), pr;
...
`);
    ...
    T.CapturedTrace;
    var x = Bf()(F, b), w = Sf()(h), N = Js(), O = c.errorObj, $ = c.tryCatch;
    function V(v, B) {
...
`);
    ...
    F.prototype.toString = function() {
      ...
      if (B > 1) {
        ...
        for (R = 0; R < B - 1; ++R) {
          var k = arguments[R];
          if (c.isObject(k)) _[W++] = k;
          else return i("expecting an object but got A catch statement predicate " + c.classString(k));
        }
        return _.length = W, v = arguments[R], this.then(void 0, w(_, v, this));
      }
      ...
      return W === O && B._rejectCallback(W.e, true), B._isFateSealed() || B._setAsyncGuaranteed(), B;
    }, F.all = function(v) {
      ...
      var k = R !== void 0, X = k ? R : new F(y), E = this._target(), H = E._bitField;
      k || (X._propagateFrom(this, 3), X._captureStackTrace(), W === void 0 && this._bitField & 2097152 && (H & 50397184 ? W = this._boundValue() : W = E === this ? void 0 : this._boundTo), this._fireEvent("promiseChained", this, X));
      var ee = u();
      if (H & 50397184) {
        var Y, K, se = E._settlePromiseCtx;
        H & 33554432 ? (K = E._rejectionHandler0, Y = v) : H & 16777216 ? (K = E._fulfillmentHandler0, Y = B, E._unsetRejectionIsUnhandled()) : (se = E._settlePromiseLateCancellationObserver, K = new D("late cancellation observer"), E._attachExtraTrace(K), Y = B), d.invoke(se, E, { handler: ee === null ? Y : typeof Y == "function" && c.domainBind(ee, Y), promise: X, receiver: W, value: K });
      } else E._addCallbacks(v, B, X, W, ee);
      return X;
      ...
      var _ = v._fulfillmentHandlerAt(B), W = v._rejectionHandlerAt(B), R = v._promiseAt(B), k = v._receiverAt(B);
      k === void 0 && (k = a), this._addCallbacks(_, W, R, k, null);
    }, F.prototype._addCallbacks = function(v, B, _, W, R) {
      var k = this._length();
      if (k >= 65531 && (k = 0, this._setLength(0)), k === 0) this._promise0 = _, this._receiver0 = W, typeof v == "function" && (this._fulfillmentHandler0 = R === null ? v : c.domainBind(R, v)), typeof B == "function" && (this._rejectionHandler0 = R === null ? B : c.domainBind(R, B));
      else {
        var X = k * 4 - 4;
      ...
      if (!(this._bitField & 117506048)) {
        ...
        if (R & 50397184) if (R & 33554432) this._fulfill(W._value());
          ...
          var E = new D("late cancellation observer");
          W._attachExtraTrace(E), this._reject(E);
        }
        else {
          var k = this._length();
          k > 0 && W._migrateCallback0(this);
          for (var X = 1; X < k; ++X) W._migrateCallbackAt(this, X);
      ...
      if (!R && !_ && T.warnings()) {
        var k = "a promise was rejected with a non-error: " + c.classString(v);
        this._warn(k, true);
      }
      ...
      if (!(R & 65536)) {
        W._pushContext();
        var k;
        B === p ? !_ || typeof _.length != "number" ? (k = O, k.e = new g("cannot .spread() a non-array: " + c.classString(_))) : k = $(v).apply(this._boundValue(), _) : k = $(v).call(B, _);
        var X = W._popContext();
        R = W._bitField, !(R & 65536) && (k === h ? W._reject(_) : k === O ? W._rejectCallback(k.e, false) : (T.checkForgottenReturns(k, X, "", W, this), W._resolveCallback(k)));
      }
      ...
      var R = v instanceof F, k = this._bitField, X = (k & 134217728) !== 0;
      k & 65536 ? (R && v._invokeInternalOnCancel(), _ instanceof x && _.isFinallyHandler() ? (_.cancelPromise = v, $(B).call(_, W) === O && v._reject(O.e)) : B === t ? v._fulfill(t.call(_)) : _ instanceof r ? _._promiseCancelled(v) : R || v instanceof f ? v._cancel() : _.cancel()) : typeof B == "function" ? R ? (X && v._setAsyncGuaranteed(), this._settlePromiseFromHandler(B, _, W, v)) : B.call(_, W, v) : _ instanceof r ? _._isResolved() || (k & 33554432 ? _._promiseFulfilled(W, v) : _._promiseRejected(W, v)) : R && (X && v._setAsyncGuaranteed(), k & 33554432 ? v._fulfill(W) : v._reject(W));
      ...
      for (var _ = 1; _ < v; _++) {
        var W = this._fulfillmentHandlerAt(_), R = this._promiseAt(_), k = this._receiverAt(_);
        this._clearCallbackDataAtIndex(_), this._settlePromise(R, W, k, B);
      }
    }, F.prototype._rejectPromises = function(v, B) {
      for (var _ = 1; _ < v; _++) {
        var W = this._rejectionHandlerAt(_), R = this._promiseAt(_), k = this._receiverAt(_);
        this._clearCallbackDataAtIndex(_), this._settlePromise(R, W, k, B);
      }
    ...
    }, c.notEnumerableProp(F, "_makeSelfResolutionError", n), Nf()(F, y, b, i, T), Rf()(F, y, b, T), kf()(F, f, i, T), Of()(F), If()(F), Lf()(F, f, b, y, d, u), F.Promise = F, F.version = "3.4.7", Mf()(F, f, i, b, y, T), qf()(F), Pf()(F, i, b, U, y, T), jf()(F, y, T), Xf()(F, i, y, b, r, T), Vf()(F), Hf()(F, y), $f()(F, f, b, i), zf()(F, y, b, i), Gf()(F, f, i, b, y, T), Yf()(F, f, T), Qf()(F, f, i), Kf()(F, y), Zf()(F, y), Jf()(F), c.toFastProperties(F), c.toFastProperties(F.prototype);
    function z(v) {
      var B = new F(y);
...
var eh = Zs.exports, nh = be, Oe = eh();
Ue.defer = th;
Ue.when = Oe.resolve;
Ue.resolve = Oe.resolve;
Ue.all = Oe.all;
Ue.props = Oe.props;
Ue.reject = Oe.reject;
Ue.promisify = Oe.promisify;
Ue.mapSeries = Oe.mapSeries;
Ue.attempt = Oe.attempt;
Ue.nfcall = function(e) {
  var n = Array.prototype.slice.call(arguments, 1), t = Oe.promisify(e);
  return t.apply(null, n);
};
Oe.prototype.fail = Oe.prototype.caught;
Oe.prototype.also = function(e) {
...
function th() {
  var e, n, t = new Oe.Promise(function(i, r) {
    e = i, n = r;
  });
  return { resolve: e, reject: n, promise: t };
}
var ie = {}, ih = be, we = ie.types = { document: "document", paragraph: "paragraph", run: "run", text: "text", tab: "tab", checkbox: "checkbox", hyperlink: "hyperlink", noteReference: "noteReference", image: "image", note: "note", commentReference: "commentReference", comment: "comment", table: "table", tableRow: "tableRow", tableCell: "tableCell", break: "break", bookmarkStart: "bookmarkStart" };
function rh(e, n) {
  return n = n || {}, { type: we.document, children: e, notes: n.notes || new hi({}), comments: n.comments || [] };
}
function ah(e, n) {
  n = n || {};
  var t = n.indent || {};
  return { type: we.paragraph, children: e, styleId: n.styleId || null, styleName: n.styleName || null, numbering: n.numbering || null, alignment: n.alignment || null, indent: { start: t.start || null, end: t.end || null, firstLine: t.firstLine || null, hanging: t.hanging || null } };
}
function ch(e, n) {
  return n = n || {}, { type: we.run, children: e, styleId: n.styleId || null, styleName: n.styleName || null, isBold: !!n.isBold, isUnderline: !!n.isUnderline, isItalic: !!n.isItalic, isStrikethrough: !!n.isStrikethrough, isAllCaps: !!n.isAllCaps, isSmallCaps: !!n.isSmallCaps, verticalAlignment: n.verticalAlignment || ed.baseline, font: n.font || null, fontSize: n.fontSize || null, highlight: n.highlight || null };
}
var ed = { baseline: "baseline", superscript: "superscript", subscript: "subscript" };
function oh(e) {
  return { type: we.text, value: e };
}
function uh() {
  return { type: we.tab };
}
function sh(e) {
  return { type: we.checkbox, checked: e.checked };
}
function dh(e, n) {
  return { type: we.hyperlink, children: e, href: n.href, anchor: n.anchor, targetFrame: n.targetFrame };
}
function lh(e) {
  return { type: we.noteReference, noteType: e.noteType, noteId: e.noteId };
}
function hi(e) {
...
function fh(e) {
  return { type: we.note, noteType: e.noteType, noteId: e.noteId, body: e.body };
}
function hh(e) {
  return { type: we.commentReference, commentId: e.commentId };
}
function gh(e) {
  return { type: we.comment, commentId: e.commentId, body: e.body, authorName: e.authorName, authorInitials: e.authorInitials };
}
function nd(e, n) {
  return e + "-" + n;
}
function ph(e) {
  return { type: we.image, read: function(n) {
...
function mh(e, n) {
  return n = n || {}, { type: we.table, children: e, styleId: n.styleId || null, styleName: n.styleName || null };
}
function bh(e, n) {
  return n = n || {}, { type: we.tableRow, children: e, isHeader: n.isHeader || false };
}
function yh(e, n) {
  return n = n || {}, { type: we.tableCell, children: e, colSpan: n.colSpan == null ? 1 : n.colSpan, rowSpan: n.rowSpan == null ? 1 : n.rowSpan };
}
function za(e) {
  return { type: we.break, breakType: e };
}
function Dh(e) {
  return { type: we.bookmarkStart, name: e.name };
}
ie.document = ie.Document = rh;
ie.paragraph = ie.Paragraph = ah;
ie.run = ie.Run = ch;
ie.text = ie.Text = oh;
ie.tab = ie.Tab = uh;
ie.checkbox = ie.Checkbox = sh;
ie.Hyperlink = dh;
ie.noteReference = ie.NoteReference = lh;
ie.Notes = hi;
ie.Note = fh;
ie.commentReference = hh;
ie.comment = gh;
ie.Image = ph;
ie.Table = mh;
ie.TableRow = bh;
ie.TableCell = yh;
ie.lineBreak = za("line");
ie.pageBreak = za("page");
ie.columnBreak = za("column");
ie.BookmarkStart = Dh;
ie.verticalAlignment = ed;
var Xe = {}, Dt = be;
Xe.Result = an;
Xe.success = xh;
Xe.warning = vh;
...
an.combine = function(e) {
  var n = Dt.flatten(Dt.pluck(e, "value")), t = Ga(e);
  return new an(n, t);
};
function xh(e) {
  return new an(e, []);
...
function Ga(e) {
  var n = [];
  return Dt.flatten(Dt.pluck(e, "messages"), true).forEach(function(t) {
    Th(n, t) || n.push(t);
  }), n;
}
function Th(e, n) {
  return Dt.find(e, _h.bind(null, n)) !== void 0;
}
function _h(e, n) {
...
gi.toByteArray = Ch;
gi.fromByteArray = Sh;
var nn = [], ze = [], wh = typeof Uint8Array < "u" ? Uint8Array : Array, _r = "ABCDEFGHIJKLMNOPQRSTUVWXYZabcdefghijklmnopqrstuvwxyz0123456789+/";
for (var Mn = 0, Eh = _r.length; Mn < Eh; ++Mn) nn[Mn] = _r[Mn], ze[_r.charCodeAt(Mn)] = Mn;
ze[45] = 62;
ze[95] = 63;
function td(e) {
  var n = e.length;
...
function Ch(e) {
  var n, t = td(e), i = t[0], r = t[1], a = new wh(Ah(e, i, r)), c = 0, u = r > 0 ? i - 4 : i, o;
...
bn.MIME_TYPE = cd;
bn.NAMESPACE = od;
var ud = bn, tn = ud.find, xt = ud.NAMESPACE;
function Ph(e) {
  return e !== "";
}
function jh(e) {
...
Bt.prototype = { nodeName: "#document", nodeType: hd, doctype: null, documentElement: null, _inc: 1, insertBefore: function(e, n) {
  if (e.nodeType == gn) {
  ...
  return Zt(this, e, n), Ut(e, this), this.documentElement === null && e.nodeType === Qe && (this.documentElement = e), e;
}, removeChild: function(e) {
  return this.documentElement == e && (this.documentElement = null), xd(this, e);
}, replaceChild: function(e, n) {
  Zt(this, e, n, vd), Ut(e, this), n && this.removeChild(n), rn(e) && (this.documentElement = e);
}, importNode: function(e, n) {
  return Ed(this, e, n);
}, getElementById: function(e) {
  var n = null;
  return vt(this.documentElement, function(t) {
  ...
  return new Zn(this, function(t) {
    var i = [];
    return n.length > 0 && vt(t.documentElement, function(r) {
...
Bt.prototype.getElementsByTagName = Nn.prototype.getElementsByTagName;
Bt.prototype.getElementsByTagNameNS = Nn.prototype.getElementsByTagNameNS;
Le(Nn, ue);
function Jt() {
}
...
St.prototype = { data: "", substringData: function(e, n) {
...
_d.prototype.serializeToString = function(e, n, t) {
  return wd.call(e, n, t);
};
ue.prototype.toString = wd;
function wd(e, n) {
...
function To(e, n, t) {
  ...
  if (!r || i === "xml" && r === xt.XML || r === xt.XMLNS) return false;
    ...
    case Qe:
      ...
      for (var D = 0; D < c; D++) {
        ...
        if (To(y, t, r)) {
          ...
          wr(n, p ? "xmlns:" + p : "xmlns", h), r.push({ prefix: p, namespace: h });
        }
        Hn(y, n, t, i, r);
      }
      if (u === o && To(e, t, r)) {
...
function Ed(e, n, t) {
  ...
  if (i || (i = n.cloneNode(false)), i.ownerDocument = e, i.parentNode = null, t) for (var r = n.firstChild; r; ) i.appendChild(Ed(e, r, t)), r = r.nextSibling;
  return i;
}
function ra(e, n, t) {
...
var cc = {}, Tt = bn.NAMESPACE, aa = /[A-Z_a-z\xC0-\xD6\xD8-\xF6\u00F8-\u02FF\u0370-\u037D\u037F-\u1FFF\u200C-\u200D\u2070-\u218F\u2C00-\u2FEF\u3001-\uD7FF\uF900-\uFDCF\uFDF0-\uFFFD]/, _o = new RegExp("[\\-\\.0-9" + aa.source.slice(1, -1) + "\\u00B7\\u0300-\\u036F\\u203F-\\u2040]"), wo = new RegExp("^" + aa.source + _o.source + "*(?::" + aa.source + _o.source + "*)?$"), ut = 0, Dn = 1, qn = 2, st = 3, Pn = 4, jn = 5, dt = 6, It = 7;
function Jn(e, n) {
    ...
    try {
      ...
      switch (h > p && u(h), e.charAt(h + 1)) {
        case "/":
          ...
          var T = U.localNSMap, x = U.tagName == m, w = x || U.tagName && U.tagName.toLowerCase() == m.toLowerCase();
          if (w) {
        ...
        default:
          g && o(h);
          var O = new Bd(), $ = D[D.length - 1].currentNSMap, V = eg(e, h, O, $, c, r), F = O.length;
          if (!O.closed && tg(e, V, O.tagName, y) && (O.closed = true, t.nbsp || r.warning("unclosed xml attribute")), g && F) {
            for (var I = Eo(g, {}), j = 0; j < F; j++) {
              var z = O[j];
              o(z.offset), z.locator = Eo(g, {});
            }
            i.locator = I, Fo(O, i, $) && D.push(O), i.locator = g;
          } else Fo(O, i, $) && D.push(O);
          Tt.isHTML(O.uri) && !O.closed ? V = ng(e, V, O.tagName, c, i) : V++;
      }
    } catch (v) {
...
function eg(e, n, t, i, r, a) {
  ...
  for (var u, o, s = ++n, d = ut; ; ) {
    var l = e.charAt(s);
    switch (l) {
      case "=":
        if (d === Dn) u = e.slice(n, s), d = st;
        else if (d === qn) d = st;
        else throw new Error("attribute equal must after attrName");
        break;
      case "'":
      case '"':
        if (d === st || d === Dn) if (d === Dn && (a.warning('attribute value must after "="'), u = e.slice(n, s)), n = s + 1, s = e.indexOf(l, n), s > 0) o = e.slice(n, s), c(u, o, n - 1), d = jn;
      ...
      case "/":
        ...
        break;
      case "":
        return a.error("unexpected end of input"), d == ut && t.setTagName(e.slice(n, s)), s;
      case ">":
        switch (d) {
          case ut:
            t.setTagName(e.slice(n, s));
          ...
          case qn:
            d === qn && (o = u), d == Pn ? (a.warning('attribute "' + o + '" missed quot(")!'), c(u, o, n)) : ((!Tt.isHTML(i[""]) || !o.match(/^(?:disabled|checked|selected)$/i)) && a.warning('attribute "' + o + '" missed value!! "' + o + '" instead!!'), c(o, o, n));
            break;
          case st:
      ...
      default:
        if (l <= " ") switch (d) {
          ...
          case qn:
            t.tagName, (!Tt.isHTML(i[""]) || !u.match(/^(?:disabled|checked|selected)$/i)) && a.warning('attribute "' + u + '" missed value!! "' + u + '" instead2!!'), c(u, u, n), n = s, d = Dn;
            break;
          case jn:
...
function Fo(e, n, t) {
  for (var i = e.tagName, r = null, l = e.length; l--; ) {
    ...
    a.localName = s, d !== false && (r == null && (r = {}, Wd(t, t = {})), t[d] = r[d] = u, a.uri = Tt.XMLNS, n.startPrefixMapping(d, u));
  }
...
Bd.prototype = { setTagName: function(e) {
  if (!wo.test(e)) throw new Error("invalid tagName:" + e);
  this.tagName = e;
}, addValue: function(e, n, t) {
  if (!wo.test(e)) throw new Error("invalid attribute:" + e);
...
Rd.prototype.parseFromString = function(e, n) {
  var t = this.options, i = new dg(), r = t.domBuilder || new Nt(), a = t.errorHandler, c = t.locator, u = t.xmlns || {}, o = /\/x?html?$/.test(n), s = o ? Ao.HTML_ENTITIES : Ao.XML_ENTITIES;
...
Nt.prototype = { startDocument: function() {
...
Di.DOMParser = Rd;
var kd = cn;
mi.DOMImplementation = kd.DOMImplementation;
mi.XMLSerializer = kd.XMLSerializer;
...
Qa.Node = hg.Node;
var Er = Ue, Bo = be, Od = Qa, Id = rt, pg = Id.Element;
ad.readString = mg;
var So = Od.Node;
function mg(e, n) {
  n = n || {};
  try {
    var t = Od.parseFromString(e, "text/xml");
  } catch (c) {
    return Er.reject(c);
  }
  if (t.documentElement.tagName === "parsererror") return Er.resolve(new Error(t.documentElement.textContent));
  function i(c) {
    switch (c.nodeType) {
...
function wi() {
  return qo || (qo = 1, (function() {
    ...
    n = An().isObject, e = qe(), Or.exports = function(r) {
      t(a, r);
      function a(c, u, o, s) {
...
function Ai() {
  return Xo || (Xo = 1, (function() {
    ...
    a = An().isObject, r = qe(), e = _i(), t = wi(), n = Ei(), i = Fi(), Rr.exports = function(o) {
      c(s, o);
      function s(d, l, g) {
        var D, y;
  ...
  return Go || (Go = 1, (function() {
    ...
    D = An(), g = D.isObject, l = D.isFunction, d = D.isEmpty, s = D.getValue, a = null, e = null, n = null, t = null, i = null, u = null, o = null, c = null, r = null, Ar.exports = function() {
      ...
      return p.prototype.element = function(h, b, f) {
        var m, U, T, x, w, N, O, $, V, F, I;
        if (N = null, b === null && f == null && (V = [{}, null], b = V[0], f = V[1]), b == null && (b = {}), b = s(b), g(b) || (F = [b, f], f = F[0], b = F[1]), h != null && (h = s(h)), Array.isArray(h)) for (T = 0, O = h.length; T < O; T++) U = h[T], N = this.element(U);
        else if (l(h)) N = this.element(h.apply());
        else if (g(h)) {
          for (w in h) if (y.call(h, w)) if (I = h[w], l(I) && (I = I.apply()), g(I) && d(I) && (I = null), !this.options.ignoreDecorators && this.stringify.convertAttKey && w.indexOf(this.stringify.convertAttKey) === 0) N = this.attribute(w.substr(this.stringify.convertAttKey.length), I);
          else if (!this.options.separateArrayItems && Array.isArray(I)) for (x = 0, $ = I.length; x < $; x++) U = I[x], m = {}, m[w] = U, N = this.element(m);
          else g(I) ? (N = this.element(w), N.element(I)) : N = this.element(w, I);
        ...
        var f, m, U, T, x, w, N, O, $, V;
        for (m = this.document(), U = new i(m, h, b), $ = m.children, T = x = 0, N = $.length; x < N; T = ++x) if (f = $[T], f instanceof i) return m.children[T] = U, U;
        for (V = m.children, T = w = 0, O = V.length; w < O; T = ++w) if (f = V[T], f.isRoot) return m.children.splice(T, 0, U), U;
...
function uc() {
  return Ko || (Ko = 1, (function() {
    ...
    c = Ti(), u = Ai(), e = vi(), n = Ui(), s = xi(), l = Ci(), g = Wi(), d = Bi(), o = oc(), t = _i(), i = Ei(), r = wi(), a = Fi(), D = Pd(), Vr.exports = function(h) {
      y(b, h);
      function b(f) {
      ...
      return b.prototype.document = function(f) {
        var m, U, T, x, w;
        for (this.textispresent = false, x = "", w = f.children, U = 0, T = w.length; U < T; U++) m = w[U], !(m instanceof o) && (x += (function() {
          switch (false) {
            case !(m instanceof c):
        ...
        var U, T, x, w, N;
        if (m || (m = 0), w = this.space(m), w += "<!DOCTYPE " + f.root().name, f.pubID && f.sysID ? w += ' PUBLIC "' + f.pubID + '" "' + f.sysID + '"' : f.sysID && (w += ' SYSTEM "' + f.sysID + '"'), f.children.length > 0) {
          for (w += " [", w += this.newline, N = f.children, T = 0, x = N.length; T < x; T++) U = N[T], w += (function() {
            switch (false) {
              case !(U instanceof t):
        ...
        if (f.children.length === 0 || f.children.every(function(B) {
          ...
          for (this.textispresent && (this.newline = "", this.pretty = false, z = this.space(m)), V += ">" + this.newline, j = f.children, w = 0, O = j.length; w < O; w++) T = j[w], V += (function() {
            switch (false) {
              case !(T instanceof e):
        ...
        if (m || (m = 0), f instanceof s) {
          x = this.space(m) + "<" + f.name, w = f.attributes;
          for (T in w) p.call(w, T) && (U = w[T], x += this.attribute(U));
...
function yg() {
  return Jo || (Jo = 1, (function() {
    ...
    m = An(), b = m.isObject, h = m.isFunction, f = m.isPlainObject, p = m.getValue, s = xi(), n = vi(), t = Ui(), l = Ci(), y = Wi(), d = Bi(), u = Ti(), o = Ai(), i = _i(), a = wi(), r = Ei(), c = Fi(), e = Md(), D = qd(), g = uc(), $r.exports = function() {
      function T(x, w, N) {
        var O;
        this.name = "?xml", x || (x = {}), x.writer ? f(x.writer) && (O = x.writer, x.writer = new g(O)) : x.writer = new g(x), this.options = x, this.writer = x.writer, this.stringify = new D(x), this.onDataCallback = w || function() {
      ...
      return T.prototype.node = function(x, w, N) {
        var O, $;
        ...
        return this.openCurrent(), x = p(x), w === null && N == null && (O = [{}, null], w = O[0], N = O[1]), w == null && (w = {}), w = p(w), b(w) || ($ = [w, N], N = $[0], w = $[1]), this.currentNode = new s(this, x, w), this.currentNode.children = false, this.currentLevel++, this.openTags[this.currentLevel] = this.currentNode, N != null && this.text(N), this;
      }, T.prototype.element = function(x, w, N) {
        return this.currentNode && this.currentNode instanceof o ? this.dtdElement.apply(this, arguments) : this.node(x, w, N);
      }, T.prototype.attribute = function(x, w) {
        var N, O;
        ...
        if (x != null && (x = p(x)), b(x)) for (N in x) U.call(x, N) && (O = x[N], this.attribute(N, O));
        else h(w) && (w = w.apply()), (!this.options.skipNullAttributes || w != null) && (this.currentNode.attributes[x] = new e(this, x, w));
        return this;
      }, T.prototype.text = function(x) {
        var w;
        return this.openCurrent(), w = new y(this, x), this.onData(this.writer.text(w, this.currentLevel + 1), this.currentLevel + 1), this;
      }, T.prototype.cdata = function(x) {
        var w;
        return this.openCurrent(), w = new n(this, x), this.onData(this.writer.cdata(w, this.currentLevel + 1), this.currentLevel + 1), this;
      }, T.prototype.comment = function(x) {
        var w;
        return this.openCurrent(), w = new t(this, x), this.onData(this.writer.comment(w, this.currentLevel + 1), this.currentLevel + 1), this;
      }, T.prototype.raw = function(x) {
        var w;
        return this.openCurrent(), w = new l(this, x), this.onData(this.writer.raw(w, this.currentLevel + 1), this.currentLevel + 1), this;
      }, T.prototype.instruction = function(x, w) {
        var N, O, $, V, F;
        if (this.openCurrent(), x != null && (x = p(x)), w != null && (w = p(w)), Array.isArray(x)) for (N = 0, V = x.length; N < V; N++) O = x[N], this.instruction(O);
        else if (b(x)) for (O in x) U.call(x, O) && ($ = x[O], this.instruction(O, $));
        else h(w) && (w = w.apply()), F = new d(this, x, w), this.onData(this.writer.processingInstruction(F, this.currentLevel + 1), this.currentLevel + 1);
        return this;
      }, T.prototype.declaration = function(x, w, N) {
        var O;
        if (this.openCurrent(), this.documentStarted) throw new Error("declaration() must be the first node.");
        return O = new u(this, x, w, N), this.onData(this.writer.declaration(O, this.currentLevel + 1), this.currentLevel + 1), this;
      }, T.prototype.doctype = function(x, w, N) {
        if (this.openCurrent(), x == null) throw new Error("Missing root node name.");
        if (this.root) throw new Error("dtd() must come before the root node.");
        return this.currentNode = new o(this, w, N), this.currentNode.rootNodeName = x, this.currentNode.children = false, this.currentLevel++, this.openTags[this.currentLevel] = this.currentNode, this;
      }, T.prototype.dtdElement = function(x, w) {
        var N;
        return this.openCurrent(), N = new r(this, x, w), this.onData(this.writer.dtdElement(N, this.currentLevel + 1), this.currentLevel + 1), this;
      }, T.prototype.attList = function(x, w, N, O, $) {
        var V;
        return this.openCurrent(), V = new i(this, x, w, N, O, $), this.onData(this.writer.dtdAttList(V, this.currentLevel + 1), this.currentLevel + 1), this;
      }, T.prototype.entity = function(x, w) {
        var N;
        return this.openCurrent(), N = new a(this, false, x, w), this.onData(this.writer.dtdEntity(N, this.currentLevel + 1), this.currentLevel + 1), this;
      }, T.prototype.pEntity = function(x, w) {
        var N;
        return this.openCurrent(), N = new a(this, true, x, w), this.onData(this.writer.dtdEntity(N, this.currentLevel + 1), this.currentLevel + 1), this;
      }, T.prototype.notation = function(x, w) {
        var N;
        return this.openCurrent(), N = new c(this, x, w), this.onData(this.writer.dtdNotation(N, this.currentLevel + 1), this.currentLevel + 1), this;
      ...
      }, T.prototype.onData = function(x, w) {
        return this.documentStarted = true, this.onDataCallback(x, w + 1);
      ...
      }, T.prototype.nod = function(x, w, N) {
        return this.node(x, w, N);
      ...
      }, T.prototype.ins = function(x, w) {
        return this.instruction(x, w);
      }, T.prototype.dec = function(x, w, N) {
        return this.declaration(x, w, N);
      }, T.prototype.dtd = function(x, w, N) {
        return this.doctype(x, w, N);
      }, T.prototype.e = function(x, w, N) {
        return this.element(x, w, N);
      }, T.prototype.n = function(x, w, N) {
        return this.node(x, w, N);
        ...
        return this.currentNode && this.currentNode instanceof o ? this.attList.apply(this, arguments) : this.attribute.apply(this, arguments);
      }, T.prototype.ent = function(x, w) {
        return this.entity(x, w);
      }, T.prototype.pent = function(x, w) {
        return this.pEntity(x, w);
      }, T.prototype.not = function(x, w) {
        return this.notation(x, w);
      }, T;
    }();
  }).call(ae)), $r.exports;
}
...
function Dg() {
  return eu || (eu = 1, (function() {
    ...
    c = Ti(), u = Ai(), e = vi(), n = Ui(), s = xi(), l = Ci(), g = Wi(), d = Bi(), o = oc(), t = _i(), i = Ei(), r = wi(), a = Fi(), D = Pd(), zr.exports = function(h) {
      y(b, h);
      function b(f, m) {
      ...
      return b.prototype.document = function(f) {
        ...
        for (f.children[f.children.length - 1].isLastRootNode = true, O = f.children, $ = [], T = 0, w = O.length; T < w; T++) if (m = O[T], !(m instanceof o)) switch (false) {
          case !(m instanceof c):
        ...
        if (m || (m = 0), this.stream.write(this.space(m)), this.stream.write("<!DOCTYPE " + f.root().name), f.pubID && f.sysID ? this.stream.write(' PUBLIC "' + f.pubID + '" "' + f.sysID + '"') : f.sysID && this.stream.write(' SYSTEM "' + f.sysID + '"'), f.children.length > 0) {
          for (this.stream.write(" ["), this.stream.write(this.endline(f)), w = f.children, T = 0, x = w.length; T < x; T++) switch (U = w[T], false) {
            case !(U instanceof t):
        ...
        var U, T, x, w, N, O, $, V;
        m || (m = 0), V = this.space(m), this.stream.write(V + "<" + f.name), O = f.attributes;
        for (N in O) p.call(O, N) && (U = O[N], this.attribute(U));
        if (f.children.length === 0 || f.children.every(function(F) {
          ...
          for (this.stream.write(">" + this.newline), $ = f.children, x = 0, w = $.length; x < w; x++) switch (T = $[x], false) {
            case !(T instanceof e):
              this.cdata(T, m + 1);
              break;
            case !(T instanceof n):
...
(function() {
  var e, n, t, i, r, a, c;
  c = An(), r = c.assign, a = c.isFunction, e = bg(), n = yg(), i = uc(), t = Dg(), ft.create = function(u, o, s, d) {
    var l, g;
  ...
  }, ft.begin = function(u, o, s) {
    var d;
    return a(u) && (d = [u, o], o = d[0], s = d[1], u = {}), o ? new n(u, o, s) : new e(u);
  }, ft.stringWriter = function(u) {
    return new i(u);
  }, ft.streamWriter = function(u, o) {
    return new t(u, o);
  };
}).call(ae);
var nu = be, xg = ft;
...
dc.default = Cg;
var Wg = ae && ae.__importDefault || function(e) {
  return e && e.__esModule ? e : { default: e };
};
Object.defineProperty(Un, "__esModule", { value: true });
Un.hex = Un.dec = Un.codePoint = void 0;
var Bg = Wg(dc), Vd = {}, Sg = String.fromCodePoint ? String.fromCodePoint : Og;
...
var au = Un, Ge = be, fe = ie, Gd = Xe.Result, dn = Xe.warning, jg = mn, cu = Cn, ou = hc;
function Xg(e) {
...
function uu(e) {
  ...
  function x(C, M, G, Z) {
    var te = [], oe = C.first(M), ge = null, Ve = null;
    if (oe && (ge = oe.attributes["w:val"], ge)) {
      var He = Z(ge);
      He ? Ve = He.name : te.push(yn(G, ge));
    }
    return Mt({ styleId: ge, name: Ve }, te);
  }
  function w(C) {
    ...
    if (M === "begin") n.push({ type: "begin", fldChar: C }), t = [];
      ...
      var G = n.pop();
      if (G.type === "begin" && (G = O(G)), G.type === "checkbox") return Pe(fe.checkbox({ checked: G.checked }));
    } else if (M === "separate") {
      var Z = n.pop(), te = O(Z);
      n.push(te);
    }
  ...
  function $(C, M) {
    ...
    var Z = /\s*HYPERLINK\s+\\l\s+"(.*)"/.exec(C);
    if (Z) return { type: "hyperlink", options: { anchor: Z[1] } };
    var te = /\s*FORMCHECKBOX\s*/.exec(C);
    if (te) {
  ...
  function F(C) {
    var M = C.attributes["w:font"], G = C.attributes["w:char"], Z = au.hex(M, G);
    return Z == null && /^F0..$/.test(G) && (Z = au.hex(M, G.substring(2))), Z == null ? lt([dn("A w:sym element with an unsupported character was ignored: char " + G + " in font " + M)]) : Pe(new fe.Text(Z.string));
  }
  function I(C) {
    return function(M) {
  ...
  var v = { "w:p": function(C) {
    ...
    if (G) return C.children.forEach(function(te) {
      i.push(te);
    }), Vn();
    var Z = C.children;
    return i.length > 0 && (Z = i.concat(Z), i = []), _e.map(g(M), d(Z), function(te, oe) {
      return new fe.Paragraph(oe, te);
    }).insertExtra();
  }, "w:r": function(C) {
    return _e.map(y(C.firstOrEmpty("w:rPr")), d(C.children), function(M, G) {
      var Z = N();
      return Z !== null && (G = [new fe.Hyperlink(G, Z)]), new fe.Run(G, M);
    });
  }, "w:fldChar": w, "w:instrText": V, "w:t": function(C) {
    ...
    return d(C.children).map(function(Z) {
      function te(ge) {
        ...
        return new fe.Hyperlink(Z, Ge.extend({ targetFrame: Ve }, ge));
      }
      if (M) {
        var oe = r.findTargetByRelationshipId(M);
        return G && (oe = ou.replaceFragment(oe, G)), te({ href: oe });
      } else return G ? te({ anchor: G }) : Z;
    });
    ...
    return M == null || M === "textWrapping" ? Pe(fe.lineBreak) : M === "page" ? Pe(fe.pageBreak) : M === "column" ? Pe(fe.columnBreak) : lt([dn("Unsupported break type: " + M)]);
    ...
    return M.map(function(G) {
      ...
      if (Z) {
        var te = Z.first("wordml:checked"), oe = !!te && b(te.attributes["wordml:val"]), ge = fe.checkbox({ checked: oe }), Ve = false, He = G.map(cu._elementsOfType(fe.types.text, function(ot) {
  ...
  function W(C) {
    ...
    return d(C.children).map(function(te) {
      return fe.TableRow(te, { isHeader: Z });
    });
  }
  function R(C) {
    return d(C.children).map(function(M) {
      var G = C.firstOrEmpty("w:tcPr"), Z = G.firstOrEmpty("w:gridSpan").attributes["w:val"], te = Z ? parseInt(Z, 10) : 1, oe = fe.TableCell(M, { colSpan: te });
      return oe._vMerge = k(G), oe;
    });
  }
  function k(C) {
  ...
  function X(C) {
    var M = Ge.any(C, function(te) {
      return te.type !== fe.types.tableRow;
    });
    if (M) return E(C), Mt(C, [dn("unexpected non-row element in table, cell merging may be incorrect")]);
    var G = Ge.any(C, function(te) {
      return Ge.any(te.children, function(oe) {
        return oe.type !== fe.types.tableCell;
      });
    });
    if (G) return E(C), Mt(C, [dn("unexpected non-cell element in table row, cell merging may be incorrect")]);
    var Z = {};
    return C.forEach(function(te) {
      var oe = 0;
      te.children.forEach(function(ge) {
        ge._vMerge && Z[oe] ? Z[oe].rowSpan++ : (Z[oe] = ge, ge._vMerge = false), oe += ge.colSpan;
      });
    }), C.forEach(function(te) {
      te.children = te.children.filter(function(oe) {
        return !oe._vMerge;
      }), te.children.forEach(function(oe) {
        delete oe._vMerge;
      });
    }), Pe(C);
  }
  ...
  function H(C) {
    ...
    return su(M.map(ee.bind(null, C)));
  }
  function ee(C, M) {
    var G = C.first("wp:docPr").attributes, Z = Y(G.descr) ? G.title : G.descr, te = K(M);
    return te === null ? lt([dn("Could not find image file for a:blip element")]) : Ne(te, Z);
  }
  function Y(C) {
  ...
  function K(C) {
    ...
    if (M) return Te(M);
    if (G) {
      var Z = r.findTargetByRelationshipId(G);
      return { path: Z, read: u.read.bind(u, Z) };
    } else return null;
  }
  function se(C) {
    var M = C.attributes["r:id"];
    return M ? Ne(Te(M), C.attributes["o:title"]) : lt([dn("A v:imagedata element without a relationship ID was ignored")]);
  }
  function Te(C) {
  ...
  function Ne(C, M) {
    var G = a.findContentType(C.path), Z = fe.Image({ readImage: C.read, altText: M, contentType: G }), te = Vg[G] ? [] : dn("Image of type " + G + " is unlikely to display in web browsers");
    return Mt(Z, te);
  }
  function yn(C, M) {
...
var ki = {}, qt = be;
ki.readNumberingXml = Jg;
ki.Numbering = mc;
ki.defaultNumbering = new mc({}, {});
function mc(e, n, t) {
...
var bc = {}, op = ie, up = Xe.Result;
bc.createFootnotesReader = Jd.bind(ae, "footnote");
bc.createEndnotesReader = Jd.bind(ae, "endnote");
function Jd(e, n) {
  function t(a) {
...
$a.read = xp;
$a._findPartPaths = il;
var gp = Ue, pp = ie, Qr = Xe.Result, ei = Ct, tl = Ya.readXmlFromZipFile, mp = sc.createBodyReader, bp = Qd.DocumentXmlReader, et = Ri, du = pc, lu = ki, fu = Oi, hu = bc, yp = el, Dp = nl.Files;
function xp(e, n, t) {
  n = n || {}, t = t || {};
...
var wp = ct({ filename: "_rels/.rels", readElement: et.readRelationships, defaultValue: et.defaultValue }), yc = {}, Ep = be, Fp = Ue, wt = mn;
yc.writeStyleMap = Cp;
yc.readStyleMap = Sp;
...
sl.writer = Rp;
function Rp(e) {
  return e = e || {}, e.prettyPrint ? kp() : ll();
}
...
var vn = be, vu = Ue, Xt = ie, $e = Li(), oa = Xe, zp = xc, re = Ii(), Gp = ul;
...
function Qp(e, n) {
  ...
  function s(_) {
    var W = [], R = l(_, W, {}), k = [];
    pl(R, function(E) {
      E.type === "deferred" && k.push(E);
    });
    var X = {};
    return vu.mapSeries(k, function(E) {
      return E.value().then(function(H) {
        X[E.id] = H;
      });
    }).then(function() {
      function E(ee) {
        return Zr(ee, function(Y) {
          return Y.type === "deferred" ? X[Y.id] : Y.children ? [vn.extend({}, Y, { children: E(Y.children) })] : [Y];
        });
      }
      var H = Gp.writer({ prettyPrint: e.prettyPrint, outputFormat: e.outputFormat });
      return re.write(H, re.simplify(E(R))), new oa.Result(H.asString(), W);
    });
  }
  function d(_, W, R) {
  ...
  function g(_, W, R) {
    return D(_, W).wrap(function() {
      var k = d(_.children, W, R);
      return c ? k : [re.forceWrite].concat(k);
    });
  }
  function D(_, W) {
    var R = b(_);
  ...
  function y(_, W, R) {
    ...
    if (_.highlight !== null) {
      var E = h({ type: "highlight", color: _.highlight });
      E && X.push(E);
    }
    ...
    var H = $e.empty, ee = b(_);
    return ee ? H = ee.to : _.styleId && W.push(Uu("run", _)), X.push(H), X.forEach(function(Y) {
      k = Y.wrap.bind(Y, k);
    }), k();
  }
  function p(_, W) {
  ...
  function $(_, W, R) {
    var k = vn.findIndex(_.children, function(ee) {
      return !ee.type === Xt.types.tableRow || !ee.isHeader;
    });
    k === -1 && (k = _.children.length);
    var X;
    if (k === 0) X = d(_.children, W, vn.extend({}, R, { isTableHeader: false }));
    else {
      var E = d(_.children.slice(0, k), W, vn.extend({}, R, { isTableHeader: true })), H = d(_.children.slice(k), W, vn.extend({}, R, { isTableHeader: false }));
      X = [re.freshElement("thead", {}, E), re.freshElement("tbody", {}, H)];
    }
    return [re.forceWrite].concat(X);
  }
  function V(_, W, R) {
    var k = d(_.children, W, R);
    return [re.freshElement("tr", {}, [re.forceWrite].concat(k))];
  }
  function F(_, W, R) {
    var k = R.isTableHeader ? "th" : "td", X = d(_.children, W, R), E = {};
    return _.colSpan !== 1 && (E.colspan = _.colSpan.toString()), _.rowSpan !== 1 && (E.rowspan = _.rowSpan.toString()), [re.freshElement(k, E, [re.forceWrite].concat(X))];
  }
  function I(_, W, R) {
    return h(_, $e.ignore).wrap(function() {
      var k = n[_.commentId], X = r.length + 1, E = "[" + Jp(k) + X + "]";
      return r.push({ label: E, comment: k }), [re.freshElement("a", { href: "#" + T("comment", _.commentId), id: x("comment", _.commentId) }, [re.text(E)])];
    });
  }
  function j(_, W, R) {
    var k = _.label, X = _.comment, E = d(X.body, W, R).concat([re.nonFreshElement("p", {}, [re.text(" "), re.freshElement("a", { href: "#" + x("comment", X.commentId) }, [re.text("\u2191")])])]);
    return [re.freshElement("dt", { id: T("comment", X.commentId) }, [re.text("Comment " + k)]), re.freshElement("dd", {}, E)];
  }
  function z(_, W, R) {
  ...
  var B = { document: function(_, W, R) {
    var k = d(_.children, W, R), X = i.map(function(H) {
      return _.notes.resolve(H);
    }), E = d(X, W, R);
    return k.concat([re.freshElement("ol", {}, E), re.freshElement("dl", {}, Zr(r, function(H) {
      return j(H, W, R);
    }))]);
  }, paragraph: g, run: y, text: function(_, W, R) {
    return [re.text(_.value)];
  }, tab: function(_, W, R) {
    return [re.text("	")];
  }, hyperlink: function(_, W, R) {
    var k = _.anchor ? "#" + w(_.anchor) : _.href, X = { href: k };
    _.targetFrame != null && (X.target = _.targetFrame);
    var E = d(_.children, W, R);
    return [re.nonFreshElement("a", X, E)];
  }, checkbox: function(_) {
    var W = { type: "checkbox" };
    return _.checked && (W.checked = "checked"), [re.freshElement("input", W)];
  }, bookmarkStart: function(_, W, R) {
    var k = re.freshElement("a", { id: w(_.name) }, [re.forceWrite]);
    return [k];
  }, noteReference: function(_, W, R) {
    i.push(_);
    var k = re.freshElement("a", { href: "#" + m(_), id: U(_) }, [re.text("[" + t++ + "]")]);
    return [re.freshElement("sup", {}, [k])];
  }, note: function(_, W, R) {
    var k = d(_.body, W, R), X = re.elementWithTag($e.element("p", {}, { fresh: false }), [re.text(" "), re.freshElement("a", { href: "#" + U(_) }, [re.text("\u2191")])]), E = k.concat([X]);
    return re.freshElement("li", { id: m(_) }, E);
  }, commentReference: I, comment: j, image: Zp(f(e.convertImage || zp.dataUri)), table: O, tableRow: V, tableCell: F, break: z };
  ...
  e.token = function(g, D) {
    ...
    var g = Array.prototype.slice.call(arguments, 0), D = function(p) {
      var h = n.foldl(g, function(f, m) {
        ...
        if (x.isSuccess()) {
          var w;
          m.isCaptured ? w = U.value().withValue(m, x.value()) : w = U.value();
          var N = x.remaining(), O = p.to(N);
          return { result: i.success(w, N, O), hasCut: T };
  ...
  e.leftAssociative = function(g, D, y) {
    ...
    return function(b) {
      ...
      for (var U = h(m.remaining()); U.isSuccess(); ) {
        var T = U.remaining(), x = f.to(U.remaining()), w = U.value();
        m = i.success(w(m.value(), x), T, x), U = h(m.remaining());
      }
...
Je.Token = _l;
Je.bottomUp = wl;
Je.RegexTokeniser = El.RegexTokeniser;
Je.rule = function(e) {
  var n;
  return function(t) {
    return n || (n = e()), n(t);
...
Ee.table = o2;
Ee.bold = new en("bold");
Ee.italic = new en("italic");
Ee.underline = new en("underline");
Ee.strikethrough = new en("strikethrough");
Ee.allCaps = new en("allCaps");
Ee.smallCaps = new en("smallCaps");
Ee.highlight = u2;
Ee.commentReference = new en("commentReference");
Ee.lineBreak = new Pi({ breakType: "line" });
Ee.pageBreak = new Pi({ breakType: "page" });
Ee.columnBreak = new Pi({ breakType: "column" });
Ee.equalTo = d2;
Ee.startsWith = l2;
function a2(e) {
...
var b2 = be, L = Je, Fe = Ee, Vt = Li(), y2 = Al.tokenise, ea = Xe;
Mi.readHtmlPath = U2;
...
function Cl() {
  var e = L.rules.sequence, n = function(x, w) {
  ...
  var l = e(e.capture(r), e.capture(d([a, u, s]))).map(function(x, w) {
    return x(w);
...
var w2 = L.rules.sequence(L.rules.tokenOfType("open-square-bracket"), L.rules.sequence.cut(), L.rules.sequence.capture(ji), L.rules.tokenOfType("equals"), L.rules.sequence.capture($n), L.rules.tokenOfType("close-square-bracket")).map(function(e, n) {
  return { name: e, value: n, append: false };
}), E2 = L.rules.sequence(L.rules.tokenOfType("dot"), L.rules.sequence.cut(), L.rules.sequence.capture(ji)).map(function(e) {
  return { name: "class", value: e, append: true };
}), F2 = L.rules.firstOf("attribute or class", w2, E2);
function _c(e, n) {
...
Nl.openZip = O2;
function O2(e) {
  return e.arrayBuffer ? wu.resolve(k2.openArrayBuffer(e.arrayBuffer)) : wu.reject(new Error("Could not find file in options"));
}
var Rl = {}, I2 = Li(), L2 = Ii();
Rl.element = M2;
function M2(e) {
...
var q2 = be, kl = $a, wc = yc, P2 = Dc.DocumentConverter, j2 = ml.convertElementToRawText, X2 = Mi.readStyle, V2 = Xi.readOptions, Vi = Nl, H2 = Xe.Result;
Ze.convertToHtml = $2;
...
function Ec(e, n) {
  return n = V2(n), Vi.openZip(e).tap(function(t) {
    return wc.readStyleMap(t).then(function(i) {
      n.embeddedStyleMap = i;
    });
  }).then(function(t) {
    return kl.read(t, e, n).then(function(i) {
...
function G2(e) {
  return Vi.openZip(e).then(wc.readStyleMap);
}
function Y2(e, n) {
...
function K2(e) {
  return Vi.openZip(e).then(kl.read).then(function(n) {
    return n.map(j2);
  });
}
function Z2(e, n) {
  return Vi.openZip(e).tap(function(t) {
    return wc.writeStyleMap(t, n);
  }).then(function(t) {
...
const fm = () => {
  const [e, n] = Rt.useState(null), [t, i] = Rt.useState(false), [r, a] = Rt.useState(null), [c, u] = Rt.useState(null), o = async (l) => {
    n(l), a(null), u(null), i(true);
    try {
      const g = await l.arrayBuffer(), D = await Ze.convertToHtml({ arrayBuffer: g });
      await s(D.value);
    } catch (g) {
      console.error(g), u("We could not read this document. Make sure it is a valid .docx file (older .doc files are not supported)."), i(false);
    }
  }, s = async (l) => {
    try {
      const g = new Hl({ unit: "pt", format: "a4" }), D = document.createElement("div");
      D.style.position = "absolute", D.style.left = "-9999px", D.style.top = "0";
      const y = document.createElement("div");
      y.innerHTML = l, y.style.width = "595px", y.style.padding = "40px", y.style.fontSize = "12pt", y.style.lineHeight = "1.5", y.style.fontFamily = "Arial, sans-serif", D.appendChild(y), document.body.appendChild(D);
      try {
        await g.html(y, { callback: (p) => {
          const h = p.output("blob");
          a(h), i(false);
      ...
      console.error("PDF Generation failed", g), u("We could not build a PDF from this document. Very complex layouts or embedded objects can fail \u2014 try simplifying the document and converting again."), i(false);
    }
  }, d = () => {
    if (r) {
      const l = URL.createObjectURL(r), g = document.createElement("a");
      g.href = l, g.download = e.name.replace(/\.docx?$/i, ".pdf"), document.body.appendChild(g), g.click(), document.body.removeChild(g), setTimeout(() => URL.revokeObjectURL(l), 0);
    }
  };
  return Q.jsx(jl, { title: "Word to PDF Converter", description: "Convert Microsoft Word documents (DOCX) to PDF format.", seoTitle: "Word to PDF Converter - Free Online Tool", seoDescription: "Convert DOCX files to PDF online for free. Secure, client-side conversion ensures your documents remain private.", faqs: J2, children: Q.jsxs("div", { className: "tool-workspace", style: { maxWidth: "1000px", margin: "0 auto" }, children: [e ? Q.jsxs("div", { style: { textAlign: "center", padding: "3rem", background: "white", borderRadius: "1rem", border: "1px solid var(--border)" }, children: [Q.jsxs("div", { style: { marginBottom: "2rem" }, children: [Q.jsx(Fc, { size: 48, color: "var(--primary)" }), Q.jsx("p", { style: { marginTop: "1rem", fontWeight: "bold" }, children: e.name })] }), t ? Q.jsxs(Q.Fragment, { children: [Q.jsx(ql, { className: "spin", size: 32, style: { display: "inline-block" } }), Q.jsx("p", { children: "Converting..." })] }) : Q.jsxs(Q.Fragment, { children: [c ? Q.jsx("div", { role: "alert", style: { padding: "0.75rem 1rem", borderRadius: "0.5rem", background: "#fef2f2", border: "1px solid #fecaca", color: "#b91c1c", textAlign: "left" }, children: c }) : Q.jsxs("button", { className: "tool-btn-primary", onClick: d, style: { padding: "0.75rem 1.5rem", borderRadius: "0.5rem", background: "var(--primary)", color: "white", border: "none", cursor: "pointer", fontWeight: "bold" }, children: [Q.jsx($l, { size: 20, style: { marginRight: "0.5rem", verticalAlign: "middle" } }), " Download PDF"] }), Q.jsx("br", {}), Q.jsx("br", {}), Q.jsx("button", { className: "tool-btn-secondary", onClick: () => {
    n(null), a(null), u(null);
  }, style: { background: "none", border: "none", color: "#64748b", textDecoration: "underline", cursor: "pointer" }, children: "Convert Another" })] })] }) : Q.jsx("div", { className: "tool-upload-area", children: Q.jsx(Xl, { onFileSelect: o, accept: { "application/vnd.openxmlformats-officedocument.wordprocessingml.document": [".docx"] }, icon: Fc, label: "Drag & Drop Word File", subLabel: "Supports .docx files" }) }), Q.jsxs("div", { className: "tool-content", style: { marginTop: "4rem" }, children: [Q.jsx(Pl, {}), Q.jsxs("div", { className: "about-section", style: { background: "var(--bg-card)", padding: "2rem", borderRadius: "1rem", border: "1px solid var(--border)", marginBottom: "2rem" }, children: [Q.jsx("h2", { style: { fontSize: "1.8rem", marginBottom: "1.5rem" }, children: "About Word to PDF Converter" }), Q.jsx("p", { style: { lineHeight: "1.6", color: "var(--text-secondary)", marginBottom: "1rem" }, children: "Drop in a .docx and this reads its contents, lays them out on A4 pages, and produces a PDF with selectable text. Conversion runs and finishes before anything is written to disk \u2014 press Download when it is ready and the file is saved under your original name with a .pdf extension. Nothing is uploaded at any stage." }), Q.jsx("h3", { style: { fontSize: "1.15rem", marginTop: "1.75rem", marginBottom: "0.75rem" }, children: "What happens in the two steps" }), Q.jsx("p", { style: { lineHeight: "1.6", color: "var(--text-secondary)", marginBottom: "1rem" }, children: "A .docx file is a ZIP archive containing XML that describes the document semantically: this run is bold, this paragraph is Heading 2, this is a list item, here is a table with three columns. The first step unzips that and converts the semantics into clean HTML \u2014 headings become heading elements, list paragraphs become real lists, runs with direct formatting become emphasis. Word-specific machinery that has no semantic equivalent is discarded here rather than approximated badly." }), Q.jsx("p", { style: { lineHeight: "1.6", color: "var(--text-secondary)", marginBottom: "1rem" }, children: "The second step lays that HTML out at a fixed content width and walks the result, emitting PDF drawing operations as it goes. Text becomes text-showing operators rather than pixels, which is why the output stays selectable and searchable, and pagination is computed so lines are not sliced across a page boundary." }), Q.jsx("h3", { style: { fontSize: "1.15rem", marginTop: "1.75rem", marginBottom: "0.75rem" }, children: "What survives and what does not" }), Q.jsxs("ul", { style: { lineHeight: "1.7", color: "var(--text-secondary)", marginBottom: "1rem", paddingLeft: "1.25rem" }, children: [Q.jsxs("li", { children: [Q.jsx("strong", { children: "Survives:" }), " headings, paragraphs, ordered and unordered lists, bold and italic, tables, hyperlinks and inline images."] }), Q.jsxs("li", { children: [Q.jsx("strong", { children: "Replaced:" }), " your page size and margins, by a fixed A4 layout. Manual page breaks are not carried over, so the page count will differ."] }), Q.jsxs("li", { children: [Q.jsx("strong", { children: "Dropped:" }), " headers, footers, page numbers, columns, text boxes, comments, tracked changes, fields and section-level layout."] }), Q.jsxs("li", { children: [Q.jsx("strong", { children: "Substituted:" }), " fonts. The standard PDF font set is used, so your typeface becomes its nearest built-in equivalent and line breaks shift accordingly."] })] }), Q.jsx("h3", { style: { fontSize: "1.15rem", marginTop: "1.75rem", marginBottom: "0.75rem" }, children: "When this is and is not the right tool" }), Q.jsx("p", { style: { lineHeight: "1.6", color: "var(--text-secondary)", marginBottom: "1rem" }, children: "It is a good fit when the content is what matters and the document is mostly text: notes, an article, a CV, a letter, a set of terms \u2014 anything you want to hand over in a format the recipient cannot accidentally edit. It is the wrong fit when the page design is the point. A brochure with precise positioning, a form with a fixed layout, or a document that must land on exactly the pages it does in Word should be exported from Word or LibreOffice, both of which embed your real fonts and honour your page setup. The same applies to documents in Cyrillic, Greek or any CJK script, since the standard PDF fonts have no glyphs for them." }), Q.jsx("h3", { style: { fontSize: "1.15rem", marginTop: "1.75rem", marginBottom: "0.75rem" }, children: "Afterwards" }), Q.jsxs("p", { style: { lineHeight: "1.6", color: "var(--text-secondary)" }, children: ["Once you have the PDF, the rest of the toolkit applies: add pagination with ", Q.jsx("strong", { children: "Add Page Numbers to PDF" }), ", stamp a draft marking with ", Q.jsx("strong", { children: "Add Watermark to PDF" }), ", combine it with other documents using ", Q.jsx("strong", { children: "Merge PDF" }), ", set its properties with ", Q.jsx("strong", { children: "PDF Metadata Editor" }), ", or lock it with ", Q.jsx("strong", { children: "Protect PDF" }), ". Going the other way, ", Q.jsx("strong", { children: "PDF to Word" }), " extracts text from a PDF back into an editable .docx \u2014 though as with any round trip, what comes back is the words rather than the original formatting."] })] })] }), Q.jsx("div", { className: "features-section", style: { display: "grid", gridTemplateColumns: "repeat(auto-fit, minmax(250px, 1fr))", gap: "2rem" }, children: em.map((l, g) => Q.jsxs("div", { className: "tool-feature-block", style: { padding: "1.5rem", borderRadius: "1rem", border: "1px solid var(--border)", background: "var(--bg-card)" }, children: [Q.jsx("div", { style: { width: "48px", height: "48px", background: "var(--primary-light)", borderRadius: "0.75rem", display: "flex", alignItems: "center", justifyContent: "center", marginBottom: "1rem" }, children: l.icon }), Q.jsx("h3", { style: { fontSize: "1.25rem", marginBottom: "0.5rem" }, children: l.title }), Q.jsx("p", { style: { color: "var(--text-secondary)" }, children: l.desc })] }, g)) })] }) });
}, J2 = [{ question: "How faithful is the layout?", answer: "The structure survives, the page design does not. Headings, paragraphs, ordered and unordered lists, bold and italic, tables, links and embedded images all come across. What does not is anything belonging to the Word page itself: your page size and margins are replaced by A4 with a fixed margin, manual page breaks are not honoured, and headers, footers, page numbers, columns, text boxes and section layouts are dropped. Treat it as a clean readable rendering of the content, not a replica of the printed document." }, { question: "Is the text in the PDF selectable?", answer: "Yes. The document is not screenshotted \u2014 text is written into the PDF as real text operators, so it can be selected, searched, copied and read by a screen reader. Pagination is chosen so that lines of text are not cut in half across a page boundary." }, { question: "Why do the fonts look different?", answer: "The PDF is built with the standard font set every reader provides, so your typeface is mapped to its nearest equivalent \u2014 in practice a Helvetica-like sans serif, with bold and italic variants. No font files from the .docx are embedded. Spacing and line breaks therefore differ slightly from Word, and a document laid out to a precise page count will not land on the same pages." }, { question: "Can I convert an older .doc file?", answer: "No. Only the modern .docx format is accepted, and the file picker enforces it. The two formats have almost nothing in common internally: .doc is a legacy binary container while .docx is a ZIP of XML parts. Open the file in Word or LibreOffice and use Save As to produce a .docx, then convert that." }, { question: "What happens to images in my document?", answer: "Pictures embedded in the .docx are carried into the PDF and placed inline where they appeared in the text flow. Positioning is simplified: an image that was anchored with text wrapping around it will end up on its own line instead. Charts, SmartArt and drawing-canvas objects are Word-specific constructs and generally do not survive." }, { question: "Non-Latin text came out missing or wrong.", answer: "That is the standard-font limitation. The built-in PDF fonts cover the Latin-1 range, so Cyrillic, Greek, Chinese, Japanese, Korean, Arabic, Hebrew and Devanagari have no glyphs available and cannot be drawn. There is no workaround here. For documents in those scripts, export to PDF from Word or LibreOffice, which can embed the real font." }, { question: "The conversion failed or produced something odd.", answer: "Very complex documents are the usual cause \u2014 heavy use of text boxes, nested tables, floating objects, embedded spreadsheets or fields. Simplify the layout and convert again. A file that is not a valid .docx, or one saved by an unusual generator, will be rejected with a message. Note that conversion happens first and the file is only written when you press Download, so a failure never leaves you with a broken PDF on disk." }, { question: "Is the document uploaded anywhere?", answer: "No. The .docx is unzipped and interpreted in this browser tab and the PDF is generated in the same tab, then handed to the browser as a download named after your original. Nothing is transmitted, which is the reason to convert an employment contract or a draft agreement here rather than through a service that wants the file on its server." }], em = [{ title: "Structure over pixels", desc: "The .docx is read as a document rather than a picture: headings, paragraphs, lists, tables, links and inline images are interpreted and then laid out fresh onto A4 pages.", icon: Q.jsx(Yl, { color: "var(--primary)", size: 24 }) }, { title: "Real text in the output", desc: "Words are written as PDF text operators, not rasterised, so the result stays selectable, searchable and accessible. Page breaks are placed so that lines of text are not sliced in half.", icon: Q.jsx(zl, { color: "var(--primary)", size: 24 }) }, { title: "Unzipped and rendered locally", desc: "A .docx is a ZIP of XML parts, and both the unzipping and the PDF generation happen in this tab. Contracts and drafts are converted without ever being transmitted.", icon: Q.jsx(Gl, { color: "var(--primary)", size: 24 }) }];
export {
  fm as default
};
