function I(e, t, r, i, n) {
  ...
  if ((i.valign === "middle" || i.valign === "bottom" || i.halign === "center" || i.halign === "right") && (g = typeof e == "string" ? e.split(l) : e, u = g.length || 1), r += h * (2 - a), i.valign === "middle" ? r -= u / 2 * o : i.valign === "bottom" && (r -= u * o), i.halign === "center" || i.halign === "right") {
    ...
    if (i.halign === "center" && (v *= 0.5), g && u >= 1) {
      for (var p = 0; p < g.length; p++) n.text(g[p], t - n.getStringUnitWidth(g[p]) * v, r), r += o;
      return n;
    }
...
var B = {}, P = function() {
  ...
  return e.setDefaults = function(t, r) {
    r === void 0 && (r = null), r ? r.__autoTableDocumentDefaults = t : B = t;
    ...
    var i, n, a;
    r === void 0 && (r = false), t.fontStyle && this.jsPDFDocument.setFontStyle && this.jsPDFDocument.setFontStyle(t.fontStyle);
...
function nt(e) {
  return { font: "helvetica", fontStyle: "normal", overflow: "linebreak", fillColor: false, textColor: 20, halign: "left", valign: "top", fontSize: 10, cellPadding: 5 / e, lineColor: 200, lineWidth: 0, cellWidth: "auto", minCellHeight: 0, minCellWidth: 0 };
}
function at(e) {
  var t = { striped: { table: { fillColor: 255, textColor: 80, fontStyle: "normal" }, head: { textColor: 255, fillColor: [41, 128, 185], fontStyle: "bold" }, body: {}, foot: { textColor: 255, fillColor: [41, 128, 185], fontStyle: "bold" }, alternateRow: { fillColor: 245 } }, grid: { table: { fillColor: 255, textColor: 80, fontStyle: "normal", lineWidth: 0.1 }, head: { textColor: 255, fillColor: [26, 188, 156], fontStyle: "bold", lineWidth: 0 }, body: {}, foot: { textColor: 255, fillColor: [26, 188, 156], fontStyle: "bold", lineWidth: 0 }, alternateRow: {} }, plain: { head: { fontStyle: "bold" }, foot: { fontStyle: "bold" } } };
  return t[e];
}
function D(e, t, r) {
  r.applyStyles(t, true);
...
function F(e, t) {
  ...
  return typeof e == "object" ? (typeof e.vertical == "number" && (e.top = e.vertical, e.bottom = e.vertical), typeof e.horizontal == "number" && (e.right = e.horizontal, e.left = e.horizontal), { left: (r = e.left) !== null && r !== void 0 ? r : t, top: (i = e.top) !== null && i !== void 0 ? i : t, right: (n = e.right) !== null && n !== void 0 ? n : t, bottom: (a = e.bottom) !== null && a !== void 0 ? a : t }) : (typeof e != "number" && (e = t), { top: e, right: e, bottom: e, left: e });
}
function U(e, t) {
...
function ot(e, t, r, i, n) {
  ...
  if (i.borderBottomWidth === u && i.borderRightWidth === u && i.borderLeftWidth === u) {
    ...
    v && (a.lineWidth = v);
  } else a.lineWidth = { top: (parseFloat(i.borderTopWidth) || 0) / g, right: (parseFloat(i.borderRightWidth) || 0) / g, bottom: (parseFloat(i.borderBottomWidth) || 0) / g, left: (parseFloat(i.borderLeftWidth) || 0) / g }, a.lineWidth.top || (a.lineWidth.right ? l = "borderRightColor" : a.lineWidth.bottom ? l = "borderBottomColor" : a.lineWidth.left && (l = "borderLeftColor"));
  var p = b(t, function(c) {
    return n.getComputedStyle(c)[l];
  });
  p != null && (a.lineColor = p);
...
function b(e, t) {
  ...
  var n = [parseInt(i[1]), parseInt(i[2]), parseInt(i[3])], a = parseInt(i[4]);
  return a === 0 || isNaN(n[0]) || isNaN(n[1]) || isNaN(n[2]) ? null : n;
}
function _(e, t) {
  var r = t(e);
  return r === "rgba(0, 0, 0, 0)" || r === "transparent" || r === "initial" || r === "inherit" ? e.parentElement == null ? null : _(e.parentElement, t) : r;
}
function ht(e, t) {
  var r = [e.paddingTop, e.paddingRight, e.paddingBottom, e.paddingLeft], i = 96 / (72 / t), n = (parseInt(e.lineHeight) - parseInt(e.fontSize)) / t / 2, a = r.map(function(h) {
...
function $(e, t, r, i, n) {
  var a, s;
  i === void 0 && (i = false), n === void 0 && (n = false);
  var h;
  ...
  for (var v = 0; v < h.rows.length; v++) {
    var p = h.rows[v], m = (s = (a = p == null ? void 0 : p.parentElement) === null || a === void 0 ? void 0 : a.tagName) === null || s === void 0 ? void 0 : s.toLowerCase(), d = ft(f, o, r, p, i, n);
    d && (m === "thead" ? l.push(d) : m === "tfoot" ? u.push(d) : g.push(d));
  }
  return { head: l, body: g, foot: u };
}
function ft(e, t, r, i, n, a) {
  for (var s = new q(i), h = 0; h < i.cells.length; h++) {
    var f = i.cells[h], o = r.getComputedStyle(f);
    if (n || o.display !== "none") {
      var l = void 0;
      a && (l = ot(e, f, t, o, r)), s.push({ rowSpan: f.rowSpan, colSpan: f.colSpan, styles: l, _element: f, content: lt(f) });
    }
  }
...
function Q(e, t) {
  ...
  var h = ut(n, i, t), f = vt(n, i, t), o = pt(r, a), l = yt(r, a, s);
  return { id: t.tableId, content: l, hooks: f, styles: h, settings: o };
}
function ut(e, t, r) {
  for (var i = { styles: {}, headStyles: {}, bodyStyles: {}, footStyles: {}, alternateRowStyles: {}, columnStyles: {} }, n = function(f) {
    if (f === "columnStyles") {
      var o = e[f], l = t[f], g = r[f];
      i.columnStyles = w({}, o, l, g);
    } else {
      var u = [e, t, r], v = u.map(function(p) {
        return p[f] || {};
      });
      i[f] = w({}, v[0], v[1], v[2]);
    }
...
function vt(e, t, r) {
  for (var i = [e, t, r], n = { didParseCell: [], willDrawCell: [], didDrawCell: [], willDrawPage: [], didDrawPage: [] }, a = 0, s = i; a < s.length; a++) {
    var h = s[a];
...
function pt(e, t) {
  var r, i, n, a, s, h, f, o, l, g, u, v, p = F(t.margin, 40 / e.scaleFactor()), m = (r = dt(e, t.startY)) !== null && r !== void 0 ? r : p.top, d;
  t.showFoot === true ? d = "everyPage" : t.showFoot === false ? d = "never" : d = (i = t.showFoot) !== null && i !== void 0 ? i : "everyPage";
  var y;
  t.showHead === true ? y = "everyPage" : t.showHead === false ? y = "never" : y = (n = t.showHead) !== null && n !== void 0 ? n : "everyPage";
  var C = (a = t.useCss) !== null && a !== void 0 ? a : false, c = t.theme || (C ? "plain" : "striped"), x = !!t.horizontalPageBreak, rt = (s = t.horizontalPageBreakRepeat) !== null && s !== void 0 ? s : null;
  return { includeHiddenHtml: (h = t.includeHiddenHtml) !== null && h !== void 0 ? h : false, useCss: C, theme: c, startY: m, margin: p, pageBreak: (f = t.pageBreak) !== null && f !== void 0 ? f : "auto", rowPageBreak: (o = t.rowPageBreak) !== null && o !== void 0 ? o : "auto", tableWidth: (l = t.tableWidth) !== null && l !== void 0 ? l : "auto", showHead: y, showFoot: d, tableLineWidth: (g = t.tableLineWidth) !== null && g !== void 0 ? g : 0, tableLineColor: (u = t.tableLineColor) !== null && u !== void 0 ? u : 200, horizontalPageBreak: x, horizontalPageBreakRepeat: rt, horizontalPageBreakBehaviour: (v = t.horizontalPageBreakBehaviour) !== null && v !== void 0 ? v : "afterAllRows" };
}
function dt(e, t) {
  var r = e.getLastAutoTable(), i = e.scaleFactor(), n = e.pageNumber(), a = false;
  if (r && r.startPageNumber) {
    var s = r.startPageNumber + r.pageNumber - 1;
    a = s === n;
  }
  return typeof t == "number" ? t : (t == null || t === false) && a && (r == null ? void 0 : r.finalY) != null ? r.finalY + 20 / i : null;
}
function yt(e, t, r) {
...
function mt(e, t, r) {
  ...
  return Object.keys(i).filter(function(a) {
    ...
    var s = 1, h;
    Array.isArray(i) ? h = i[parseInt(a)] : h = i[a], typeof h == "object" && !Array.isArray(h) && (s = (h == null ? void 0 : h.colSpan) || 1);
    for (var f = 0; f < s; f++) {
      var o = void 0;
...
var A = /* @__PURE__ */ function() {
  ...
  return e.prototype.getHeadHeight = function(t) {
    ...
    for (var h = 0, f = r; h < f.length; h++) {
      var o = f[h], l = new ct(t, this, i, n, a, s), g = o(l) === false;
      if (i.text = Array.isArray(i.text) ? i.text : [i.text], g) return false;
    }
    return true;
  ...
  function e(t, r, i, n, a) {
    a === void 0 && (a = false), this.height = 0, this.raw = t, t instanceof q && (this.raw = t._element, this.element = t._element), this.index = r, this.section = i, this.cells = n, this.spansMultiplePages = a;
  }
  ...
  t.allRows().forEach(function(a) {
    for (var s = 0, h = t.columns; s < h.length; s++) {
      ...
      if (o) {
        ...
        if (o.minReadableWidth = u + o.padding("horizontal"), typeof o.styles.cellWidth == "number") o.minWidth = o.styles.cellWidth, o.wrappedWidth = o.styles.cellWidth;
        else if (o.styles.cellWidth === "wrap" || i === true) o.contentWidth > n ? (o.minWidth = n, o.wrappedWidth = n) : (o.minWidth = o.contentWidth, o.wrappedWidth = o.contentWidth);
        else {
          var v = 10 / r;
    ...
    for (var s = 0, h = t.columns; s < h.length; s++) {
      var f = h[s], o = a.cells[f.index];
      if (o && o.colSpan === 1) f.wrappedWidth = Math.max(f.wrappedWidth, o.wrappedWidth), f.minWidth = Math.max(f.minWidth, o.minWidth), f.minReadableWidth = Math.max(f.minReadableWidth, o.minReadableWidth);
      else {
...
function j(e, t, r) {
  for (var i = t, n = e.reduce(function(v, p) {
    return v + p.wrappedWidth;
  }, 0), a = 0; a < e.length; a++) {
...
function Pt(e) {
  for (var t = {}, r = 1, i = e.allRows(), n = 0; n < i.length; n++) for (var a = i[n], s = 0, h = e.columns; s < h.length; s++) {
    var f = h[s], o = t[f.index];
    if (r > 1) r--, delete a.cells[f.index];
    else if (o) o.cell.height += a.height, r = o.cell.colSpan, delete a.cells[f.index], o.left--, o.left <= 1 && delete t[f.index];
    else {
...
function Ht(e) {
  for (var t = e.allRows(), r = 0; r < t.length; r++) for (var i = t[r], n = null, a = 0, s = 0, h = 0; h < e.columns.length; h++) {
    var f = e.columns[h];
...
function Dt(e, t) {
  for (var r = { count: 0, height: 0 }, i = 0, n = e.allRows(); i < n.length; i++) {
    for (var a = n[i], s = 0, h = e.columns; s < h.length; s++) {
      var f = h[s], o = a.cells[f.index];
      if (o) {
        t.applyStyles(o.styles, true);
        var l = o.width - o.padding("horizontal");
        if (o.styles.overflow === "linebreak") o.text = t.splitTextToSize(o.text, l + 1 / t.scaleFactor(), { fontSize: o.styles.fontSize });
        else if (o.styles.overflow === "ellipsize") o.text = L(o.text, l, o.styles, t, "...");
        else if (o.styles.overflow === "hidden") o.text = L(o.text, l, o.styles, t, "");
...
function Ft(e, t) {
  ...
  return { columns: i, head: k("head", r.head, i, s, a, t), body: k("body", r.body, i, s, a, t), foot: k("foot", r.foot, i, s, a, t) };
}
function k(e, t, r, i, n, a) {
  var s = {}, h = t.map(function(f, o) {
    for (var l = 0, g = {}, u = 0, v = 0, p = 0, m = r; p < m.length; p++) {
      var d = m[p];
      if (s[d.index] == null || s[d.index].left === 0) if (v === 0) {
        var y = void 0;
        Array.isArray(f) ? y = f[d.index - u - l] : y = f[d.dataKey];
        var C = {};
        typeof y == "object" && !Array.isArray(y) && (C = (y == null ? void 0 : y.styles) || {});
        var c = Rt(e, d, o, n, i, a, C), x = new Z(y, c, e);
        g[d.dataKey] = x, g[d.index] = x, v = x.colSpan - 1, s[d.index] = { left: x.rowSpan - 1, times: v };
      } else v--, u++;
      else s[d.index].left--, v = s[d.index].times, l++;
    }
    return new X(f, o, e, g);
  });
  return h;
}
function E(e, t) {
...
function Rt(e, t, r, i, n, a, s) {
  var h = at(i), f;
  e === "head" ? f = n.headStyles : e === "body" ? f = n.bodyStyles : e === "foot" && (f = n.footStyles);
  var o = w({}, h.table, h[e], n.styles, f), l = n.columnStyles[t.dataKey] || n.columnStyles[t.index] || {}, g = e === "body" ? l : {}, u = e === "body" && r % 2 === 0 ? w({}, h.alternateRow, n.alternateRowStyles) : {}, v = nt(a), p = w({}, v, o, u, g);
  return w(p, s);
}
function Tt(e, t, r) {
  var i;
  r === void 0 && (r = {});
  var n = U(e, t), a = /* @__PURE__ */ new Map(), s = [], h = [], f = [];
  Array.isArray(t.settings.horizontalPageBreakRepeat) ? f = t.settings.horizontalPageBreakRepeat : (typeof t.settings.horizontalPageBreakRepeat == "string" || typeof t.settings.horizontalPageBreakRepeat == "number") && (f = [t.settings.horizontalPageBreakRepeat]), f.forEach(function(u) {
    var v = t.columns.find(function(p) {
      return p.dataKey === u || p.index === u;
    });
    v && !a.has(v.index) && (a.set(v.index, true), s.push(v.index), h.push(t.columns[v.index]), n -= v.wrappedWidth);
  });
  for (var o = true, l = (i = r == null ? void 0 : r.start) !== null && i !== void 0 ? i : 0; l < t.columns.length; ) {
    if (a.has(l)) {
      l++;
      continue;
    }
    var g = t.columns[l].wrappedWidth;
    if (o || n >= g) o = false, s.push(l), h.push(t.columns[l]), n -= g;
    else break;
    l++;
  }
...
function tt(e, t) {
  ...
  t.startPageNumber = l.pageNumber(), r.horizontalPageBreak ? At(l, t, g, a) : (l.applyStyles(l.userStyles), (r.showHead === "firstPage" || r.showHead === "everyPage") && t.head.forEach(function(u) {
    ...
    var p = v === t.body.length - 1;
    W(l, t, u, p, g, a, t.columns);
  }), l.applyStyles(l.userStyles), (r.showFoot === "lastPage" || r.showFoot === "everyPage") && t.foot.forEach(function(u) {
    return S(l, t, u, a, t.columns);
  })), G(l, t, g, a), t.callEndPageHooks(l, a), t.finalY = a.y, e.lastAutoTable = t, l.applyStyles(l.userStyles);
}
function At(e, t, r, i) {
  var n = zt(e, t), a = t.settings;
  if (a.horizontalPageBreakBehaviour === "afterAllRows") n.forEach(function(o, l) {
    e.applyStyles(e.userStyles), l > 0 ? H(e, t, r, i, o.columns, true) : M(e, t, i, o.columns), jt(e, t, r, i, o.columns), R(e, t, i, o.columns);
  });
  else for (var s = -1, h = n[0], f = function() {
    var o = s;
    if (h) {
      e.applyStyles(e.userStyles);
      var l = h.columns;
      s >= 0 ? H(e, t, r, i, l, true) : M(e, t, i, l), o = N(e, t, s + 1, i, l), R(e, t, i, l);
    }
    var g = o - s;
    n.slice(1).forEach(function(u) {
      e.applyStyles(e.userStyles), H(e, t, r, i, u.columns, true), N(e, t, s + 1, i, u.columns, g), R(e, t, i, u.columns);
    }), s = o;
  }; s < t.body.length - 1; ) f();
}
function M(e, t, r, i) {
...
function N(e, t, r, i, n, a) {
  ...
  for (var s = Math.min(r + a, t.body.length), h = -1, f = t.body.slice(r, s), o = 0; o < f.length; o++) {
    ...
    if (l.canEntireRowFit(u, n)) S(e, t, l, i, n), h = r + o;
    else break;
  }
  return h;
}
...
function Lt(e, t, r, i) {
  ...
  var p = new X(e.raw, -1, e.section, n, true);
  p.height = a;
  for (var m = 0, d = r.columns; m < d.length; m++) {
    var f = d[m], l = p.cells[f.index];
    l && (l.height = p.height);
...
function Et(e, t, r, i) {
  ...
  if (f > h) return console.log("Will not be able to print row ".concat(t.index, " correctly since it's minimum height is larger than page height")), true;
  if (!o) return false;
  var l = t.hasRowSpan(i.columns), g = t.getMaxCellHeight(i.columns) > h;
  return g ? (l && console.log("The content of row ".concat(t.index, " will not be drawn correctly since drawing rows with a height larger than the page height and has cells with rowspans is not supported.")), true) : !(l || i.settings.rowPageBreak === "avoid");
}
...
function S(e, t, r, i, n) {
  ...
  for (var a = 0, s = n; a < s.length; a++) {
    ...
    Mt(e, f, i);
    var l = f.getTextPos();
    I(f.text, l.x, l.y, { halign: f.styles.halign, valign: f.styles.valign, maxWidth: Math.ceil(f.width - f.padding("left") - f.padding("right")) }, e.getDocument()), t.callCellHooks(e, t.hooks.didDrawCell, f, r, h, i), i.x += h.width;
  }
  i.y += r.height;
}
function Mt(e, t, r) {
  ...
  if (e.getDocument().setFillColor(e.getDocument().getFillColor()), typeof i.lineWidth == "number") {
    var n = J(i.lineWidth, i.fillColor);
...
function H(e, t, r, i, n, a) {
  n === void 0 && (n = []), a === void 0 && (a = false), e.applyStyles(e.userStyles), t.settings.showFoot === "everyPage" && !a && t.foot.forEach(function(h) {
    return S(e, t, h, i, n);
  }), t.callEndPageHooks(e, i);
  var s = t.settings.margin;
  G(e, t, r, i), it(e), t.pageNumber++, i.x = s.left, i.y = s.top, r.y = s.top, t.callWillDrawPageHooks(e, i), t.settings.showHead === "everyPage" && (t.head.forEach(function(h) {
    return S(e, t, h, i, n);
  }), e.applyStyles(e.userStyles));
}
function it(e) {
  ...
  e.setPage(t + 1);
  var r = e.pageNumber();
  return r === t ? (e.addPage(), true) : false;
}
function Ot(e) {
  e.API.autoTable = function() {
    for (var t = [], r = 0; r < arguments.length; r++) t[r] = arguments[r];
    var i = t[0], n = Q(this, i), a = V(this, n);
    return tt(this, a), this;
  }, e.API.lastAutoTable = false, e.API.autoTableText = function(t, r, i, n) {
    I(t, r, i, n, this);
    ...
    var i;
    if (r === void 0 && (r = false), typeof window > "u") return console.error("Cannot run autoTableHtmlToJson in non browser environment"), null;
    var n = new P(this), a = $(n, t, window, r, false), s = a.head, h = a.body, f = ((i = s[0]) === null || i === void 0 ? void 0 : i.map(function(o) {
      return o.content;
    })) || [];
...
try {
  if (typeof window < "u" && window) {
    var O = window, Y = O.jsPDF || ((T = O.jspdf) === null || T === void 0 ? void 0 : T.jsPDF);
    Y && Ot(Y);
  }
} catch (e) {
