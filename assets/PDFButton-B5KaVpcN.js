import { F as Gr, p as $n, E as Ye, a as eo, U as Cn } from "./UPNG-YrU8YmuG.js";
/*! *****************************************************************************
...
%` + t + t + t + t;
  ...
  return t.prototype.size = function() {
    ...
    var e = this.lookup(0, T).asNumber(), n = this.lookup(1, T).asNumber(), i = this.lookup(2, T).asNumber(), o = this.lookup(3, T).asNumber(), a = e, s = n, u = i - e, c = o - n;
...
`;
  ...
  return r.prototype.assign = function(t, e) {
    ...
    if (typeof t == "number") return T.of(t);
    ...
    var t = this.obj({}), e = V.of(K.PushGraphicsState), n = Re.of(t, [e]);
    ...
    var t = this.obj({}), e = V.of(K.PopGraphicsState), n = Re.of(t, [e]);
  ...
  return t.prototype.clone = function(e) {
    ...
    return this.context.lookupMaybe(e, T);
...
` + this.dict.toString();
  ...
  function t(e, n, i) {
    ...
    return o.objects = n, o.offsets = o.computeObjectOffsets(), o.offsetsString = o.computeOffsetsString(), o.dict.set(h.of("Type"), h.of("ObjStm")), o.dict.set(h.of("N"), T.of(o.objects.length)), o.dict.set(h.of("First"), T.of(o.offsetsString.length)), o;
  }
  ...
  return t.prototype.computeBufferSize = function() {
    return W(this, void 0, void 0, function() {
      ...
      return M(this, function(U) {
        switch (U.label) {
          case 0:
            e = this.context.largestObjectNumber + 1, n = Pr.forVersion(1, 7), i = n.sizeInBytes() + 2, o = aa.create(this.createTrailerDict(), this.encodeStreams), a = [], s = [], u = [], c = this.context.enumerateIndirectObjects(), y = 0, m = c.length, U.label = 1;
          case 1:
          ...
          case 3:
            return [3, 5];
          case 4:
            S = hr(s), g = hr(u), (!S || S.length % this.objectsPerStream === 0) && (S = [], s.push(S), g = J.of(e++), u.push(g)), o.addCompressedEntry(b, g, S.length), S.push(f), U.label = 5;
          case 5:
            return y++, [3, 1];
          case 6:
            y = 0, m = s.length, U.label = 7;
          case 7:
          ...
          case 9:
            return y++, [3, 7];
          case 10:
            return P = J.of(e++), o.dict.set(h.of("Size"), T.of(e)), o.addUncompressedEntry(P, i), I = i, i += this.computeIndirectObjectSize([P, o]), a.push([P, o]), D = un.forLastCrossRefSectionOffset(I), i += D.sizeInBytes(), [2, { size: i, header: n, indirectObjects: a, trailer: D }];
        }
      });
    });
...
var ma = function() {
  ...
  return t.prototype.readBlock = function() {
    ...
    if (o === 1) v = Ca, g = Aa;
      ...
      n = 0, F = 0;
      for (var I = y + m, D = new Uint8Array(I), U = void 0, L = void 0, et = void 0; F < I; ) {
        var rt = this.getCode(P);
        if (rt === 16) U = 2, L = 3, et = n;
        else if (rt === 17) U = 3, L = 3, et = n = 0;
        else if (rt === 18) U = 7, L = 11, et = n = 0;
        else {
          D[F++] = n = rt;
          continue;
        }
        for (var it = this.getBits(U) + L; it-- > 0; ) D[F++] = et;
      }
    ...
    e = this.buffer;
    for (var ht = e ? e.length : 0, _ = this.bufferLength; ; ) {
      var $ = this.getCode(v);
      if ($ < 256) {
        _ + 1 >= ht && (e = this.ensureBuffer(_ + 1), ht = e.length), e[_++] = $;
        continue;
      }
      if ($ === 256) {
        this.bufferLength = _;
      ...
      var bt = ($ & 65535) + ot;
      _ + n >= ht && (e = this.ensureBuffer(_ + n), ht = e.length);
      for (var Et = 0; Et < n; ++Et, ++_) e[_] = e[_ - bt];
    }
  ...
  return t.prototype.readBlock = function() {
    ...
    if (u) {
      ...
      for (o = 0; o < e; o++) {
        ...
        if (U && (g[f] = m, v[f] = v[m] + 1, d[f] = S[0], f++, y = f + c & f + c - 1 ? y : Math.min(Math.log(f + c) / 0.6931471805599453 + 1, 12) | 0), m = D, F += b, n < F) {
          do
            n += i;
          while (n < F);
  ...
  var t = r.MediaBox(), e = t.lookup(2, T).asNumber() - t.lookup(0, T).asNumber(), n = t.lookup(3, T).asNumber() - t.lookup(1, T).asNumber();
...
var Kn = function() {
  ...
  return r.prototype.lookupBool = function(t) {
    ...
    for (var e = [], n = 0; n < t.size(); n += 2) {
      var i = t.lookup(n, T).asNumber(), o = t.lookup(n + 1, T).asNumber();
  ...
  return r.prototype.T = function() {
    ...
    return this.dict.context.lookupMaybe(t, T);
  ...
  return r.prototype.R = function() {
    ...
    if (t) {
      for (var e = [], n = 0, i = t == null ? void 0 : t.size(); n < i; n++) {
        var o = t.get(n);
        o instanceof T && e.push(o.asNumber());
      }
      return e;
    }
...
var Di = function(r) {
  ...
  return t.prototype.MaxLen = function() {
    ...
    this.dict.set(h.of("MaxLen"), T.of(e));
  ...
  var e, n = dn(r, h.of("Ff")), i = r.context.lookupMaybe(n, T), o = (e = i == null ? void 0 : i.asNumber()) !== null && e !== void 0 ? e : 0;
  ...
  return t.prototype.Parent = function() {
    ...
    return this.lookup(h.of("Count"), T);
...
var Gn = l.Newline, Hn = l.CarriageReturn, Ma = function() {
  ...
  return t.prototype.parseObject = function() {
    ...
    return this.bytes.moveTo(n), T.of(e);
    ...
    a instanceof T ? (o = i + a.asNumber(), this.bytes.moveTo(o), this.skipWhitespaceAndComments(), this.matchKeyword(tt.endstream) || (this.bytes.moveTo(i), o = this.findEndOfStreamFallback(e))) : o = this.findEndOfStreamFallback(e);
  ...
  function t(e, n) {
    ...
    return i.alreadyParsed = false, i.shouldWaitForTick = n || function() {
      return false;
    }, i.firstOffset = o.lookup(h.of("First"), T).asNumber(), i.objectCount = o.lookup(h.of("N"), T).asNumber(), i;
  }
  ...
  function r(t) {
    ...
    var e = this.dict.lookup(h.of("Size"), T), n = this.dict.lookup(h.of("Index"));
    if (n instanceof q) {
      this.subsections = [];
      for (var i = 0, o = n.size(); i < o; i += 2) {
        var a = n.lookup(i + 0, T).asNumber(), s = n.lookup(i + 1, T).asNumber();
    ...
    for (var i = 0, o = u.size(); i < o; i++) this.byteWidths[i] = u.lookup(i, T).asNumber();
  }
...
var Nr = function(r) {
  ...
  return r instanceof T ? r : T.of(r);
}, z = function(r) {
  return r instanceof T ? r.asNumber() : r;
}, Le;
(function(r) {
...
var B = function(r) {
  ...
  return V.of(K.ClipNonZero);
}, mr = Math.cos, br = Math.sin, xr = Math.tan, Wr = function(r, t, e, n, i, o) {
  return V.of(K.ConcatTransformationMatrix, [O(r), O(t), O(e), O(n), O(i), O(o)]);
}, kt = function(r, t) {
  ...
  return V.of(K.SetLineDashPattern, ["[" + r.map(O).join(" ") + "]", O(t)]);
}, de;
(function(r) {
  r[r.Butt = 0] = "Butt", r[r.Round = 1] = "Round", r[r.Projecting = 2] = "Projecting";
})(de || (de = {}));
var zr = function(r) {
  return V.of(K.SetLineCapStyle, [O(r)]);
}, Vn;
(function(r) {
  r[r.Miter = 0] = "Miter", r[r.Round = 1] = "Round", r[r.Bevel = 2] = "Bevel";
})(Vn || (Vn = {}));
var ie = function(r) {
  return V.of(K.SetGraphicsStateParams, [Nr(r)]);
}, ct = function() {
  return V.of(K.PushGraphicsState);
}, ft = function() {
  return V.of(K.PopGraphicsState);
}, Ve = function(r) {
  return V.of(K.SetLineWidth, [O(r)]);
}, wt = function(r, t, e, n, i, o) {
  return V.of(K.AppendBezierCurve, [O(r), O(t), O(e), O(n), O(i), O(o)]);
}, rr = function(r, t, e, n) {
  return V.of(K.CurveToReplicateInitialPoint, [O(r), O(t), O(e), O(n)]);
}, Yt = function() {
  return V.of(K.ClosePath);
}, Wt = function(r, t) {
  return V.of(K.MoveTo, [O(r), O(t)]);
}, lt = function(r, t) {
  return V.of(K.LineTo, [O(r), O(t)]);
}, Xe = function() {
  return V.of(K.StrokePath);
}, gn = function() {
  return V.of(K.FillNonZero);
}, yn = function() {
  return V.of(K.FillNonZeroAndStroke);
}, Wi = function() {
  return V.of(K.EndPath);
}, Ha = function() {
  return V.of(K.NextLine);
}, Mi = function(r) {
  return V.of(K.ShowText, [r]);
}, zi = function() {
  return V.of(K.BeginText);
}, Li = function() {
  return V.of(K.EndText);
}, mn = function(r, t) {
  return V.of(K.SetFontAndSize, [Nr(r), O(t)]);
}, Va = function(r) {
  return V.of(K.SetTextLineHeight, [O(r)]);
}, Xn;
(function(r) {
...
var Xa = function(r, t, e, n, i, o) {
  return V.of(K.SetTextMatrix, [O(r), O(t), O(e), O(n), O(i), O(o)]);
}, Ui = function(r, t, e, n, i) {
  return Xa(mr(z(r)), br(z(r)) + xr(z(t)), -br(z(r)) + xr(z(e)), mr(z(r)), n, i);
}, bn = function(r) {
  return V.of(K.DrawObject, [Nr(r)]);
}, qa = function(r) {
  return V.of(K.NonStrokingColorGray, [O(r)]);
}, Ya = function(r) {
  return V.of(K.StrokingColorGray, [O(r)]);
}, Za = function(r, t, e) {
  return V.of(K.NonStrokingColorRgb, [O(r), O(t), O(e)]);
}, Ja = function(r, t, e) {
  return V.of(K.StrokingColorRgb, [O(r), O(t), O(e)]);
}, Qa = function(r, t, e, n) {
  return V.of(K.NonStrokingColorCmyk, [O(r), O(t), O(e), O(n)]);
}, $a = function(r, t, e, n) {
  return V.of(K.StrokingColorCmyk, [O(r), O(t), O(e), O(n)]);
}, _i = function(r) {
  return V.of(K.BeginMarkedContent, [Nr(r)]);
}, Ki = function() {
  return V.of(K.EndMarkedContent);
}, Zt;
(function(r) {
...
var Gi = function(r) {
...
}, C = 0, A = 0, G = 0, H = 0, Be = 0, Te = 0, Yn = /* @__PURE__ */ new Map([["A", 7], ["a", 7], ["C", 6], ["c", 6], ["H", 1], ["h", 1], ["L", 2], ["l", 2], ["M", 2], ["m", 2], ["Q", 4], ["q", 4], ["S", 4], ["s", 4], ["T", 2], ["t", 2], ["V", 1], ["v", 1], ["Z", 0], ["z", 0]]), ts = function(r) {
  ...
  return C = r[0], A = r[1], G = H = null, Be = C, Te = A, Wt(C, A);
}, m: function(r) {
  return C += r[0], A += r[1], G = H = null, Be = C, Te = A, Wt(C, A);
}, C: function(r) {
  return C = r[4], A = r[5], G = r[2], H = r[3], wt(r[0], r[1], r[2], r[3], r[4], r[5]);
}, c: function(r) {
  var t = wt(r[0] + C, r[1] + A, r[2] + C, r[3] + A, r[4] + C, r[5] + A);
  return G = C + r[2], H = A + r[3], C += r[4], A += r[5], t;
}, S: function(r) {
  (G === null || H === null) && (G = C, H = A);
  var t = wt(C - (G - C), A - (H - A), r[0], r[1], r[2], r[3]);
  return G = r[0], H = r[1], C = r[2], A = r[3], t;
}, s: function(r) {
  (G === null || H === null) && (G = C, H = A);
  var t = wt(C - (G - C), A - (H - A), C + r[0], A + r[1], C + r[2], A + r[3]);
  return G = C + r[0], H = A + r[1], C += r[2], A += r[3], t;
}, Q: function(r) {
  return G = r[0], H = r[1], C = r[2], A = r[3], rr(r[0], r[1], C, A);
}, q: function(r) {
  var t = rr(r[0] + C, r[1] + A, r[2] + C, r[3] + A);
  return G = C + r[0], H = A + r[1], C += r[2], A += r[3], t;
}, T: function(r) {
  G === null || H === null ? (G = C, H = A) : (G = C - (G - C), H = A - (H - A));
  var t = rr(G, H, r[0], r[1]);
  return G = C - (G - C), H = A - (H - A), C = r[0], A = r[1], t;
}, t: function(r) {
  G === null || H === null ? (G = C, H = A) : (G = C - (G - C), H = A - (H - A));
  var t = rr(G, H, C + r[0], A + r[1]);
  ...
  return C = r[0], A = r[1], G = H = null, lt(C, A);
}, l: function(r) {
  return C += r[0], A += r[1], G = H = null, lt(C, A);
}, H: function(r) {
  return C = r[0], G = H = null, lt(C, A);
}, h: function(r) {
  return C += r[0], G = H = null, lt(C, A);
}, V: function(r) {
  return A = r[0], G = H = null, lt(C, A);
}, v: function(r) {
  return A += r[0], G = H = null, lt(C, A);
}, Z: function() {
  var r = Yt();
  ...
  e = Math.abs(e), n = Math.abs(n), G = d * (s - r) * 0.5 + f * (u - t) * 0.5, H = d * (u - t) * 0.5 - f * (s - r) * 0.5;
  var v = G * G / (e * e) + H * H / (n * n);
  v > 1 && (v = Math.sqrt(v), e *= v, n *= v);
  var g = d / e, y = f / e, m = -f / n, S = d / n, b = g * s + y * u, F = m * s + S * u, P = g * r + y * t, I = m * r + S * t, D = (P - b) * (P - b) + (I - F) * (I - F), U = 1 / D - 0.25;
  U < 0 && (U = 0);
  var L = Math.sqrt(U);
  o === i && (L = -L);
  var et = 0.5 * (b + P) - L * (I - F), rt = 0.5 * (F + I) + L * (P - b), it = Math.atan2(F - rt, b - et), ht = Math.atan2(I - rt, P - et), _ = ht - it;
  _ < 0 && o === 1 ? _ += 2 * Math.PI : _ > 0 && o === 0 && (_ -= 2 * Math.PI);
  for (var $ = Math.ceil(Math.abs(_ / (Math.PI * 0.5 + 1e-3))), ot = [], bt = 0; bt < $; bt++) {
    var Et = it + bt * _ / $, se = it + (bt + 1) * _ / $;
  ...
  var t, e, n;
  return X([ct(), r.graphicsState && ie(r.graphicsState), r.color && oe(r.color), r.borderColor && qe(r.borderColor), Ve(r.borderWidth), r.borderLineCap && zr(r.borderLineCap), Mr((t = r.borderDashArray) !== null && t !== void 0 ? t : [], (e = r.borderDashPhase) !== null && e !== void 0 ? e : 0)], r.rotate === void 0 ? us({ x: r.x, y: r.y, xScale: r.xScale, yScale: r.yScale }) : cs({ x: r.x, y: r.y, xScale: r.xScale, yScale: r.yScale, rotate: (n = r.rotate) !== null && n !== void 0 ? n : B(0) }), [r.color && r.borderWidth ? yn() : r.color ? gn() : r.borderColor ? Xe() : Yt(), ft()]).filter(Boolean);
}, fs = function(r, t) {
  var e, n, i;
  return X([ct(), t.graphicsState && ie(t.graphicsState), kt(t.x, t.y), me(vt((e = t.rotate) !== null && e !== void 0 ? e : B(0))), t.scale ? Ue(t.scale, -t.scale) : Ue(1, -1), t.color && oe(t.color), t.borderColor && qe(t.borderColor), t.borderWidth && Ve(t.borderWidth), t.borderLineCap && zr(t.borderLineCap), Mr((n = t.borderDashArray) !== null && n !== void 0 ? n : [], (i = t.borderDashPhase) !== null && i !== void 0 ? i : 0)], is(r), [t.color && t.borderWidth ? yn() : t.color ? gn() : t.borderColor ? Xe() : Yt(), ft()]).filter(Boolean);
}, hs = function(r) {
  ...
  var t = ge({ x: r.x, y: r.y, width: r.width, height: r.height, borderWidth: r.borderWidth, color: r.color, borderColor: r.borderColor, rotate: B(0), xSkew: B(0), ySkew: B(0) });
  ...
  var t = z(r.x), e = z(r.y), n = z(r.width), i = z(r.height), o = ge({ x: t, y: e, width: n, height: i, borderWidth: r.borderWidth, color: r.color, borderColor: r.borderColor, rotate: B(0), xSkew: B(0), ySkew: B(0) }), a = Fn(r.textLines, { color: r.textColor, font: r.font, size: r.fontSize, rotate: B(0), xSkew: B(0), ySkew: B(0) });
  return X([ct()], o, a, [ft()]);
}, Fn = function(r, t) {
  ...
  for (var t = z(r.x), e = z(r.y), n = z(r.width), i = z(r.height), o = z(r.lineHeight), a = z(r.borderWidth), s = z(r.padding), u = t + a / 2 + s, c = e + a / 2 + s, f = n - (a / 2 + s) * 2, d = i - (a / 2 + s) * 2, v = [Wt(u, c), lt(u, c + d), lt(u + f, c + d), lt(u + f, c), Yt(), Ni(), Wi()], g = ge({ x: t, y: e, width: n, height: i, borderWidth: r.borderWidth, color: r.color, borderColor: r.borderColor, rotate: B(0), xSkew: B(0), ySkew: B(0) }), y = [], m = 0, S = r.selectedLines.length; m < S; m++) {
    ...
    y.push.apply(y, ge({ x: b.x - s, y: b.y - (o - b.height) / 2, width: n - a, height: b.height + (o - b.height) / 2, borderWidth: 0, color: r.selectedColor, borderColor: void 0, rotate: B(0), xSkew: B(0), ySkew: B(0) }));
  }
  var F = Fn(r.textLines, { color: r.textColor, font: r.font, size: r.fontSize, rotate: B(0), xSkew: B(0), ySkew: B(0) }), P = X([_i("Tx"), ct()], F, [ft(), Ki()]);
...
var Yi = 4, Zi = 500, Ji = function(r, t, e, n) {
  ...
  for (var s = i.heightAtSize(n), u = s + s * 0.2, c = [], f = o.x, d = o.y, v = o.x + o.width, g = o.y + o.height, y = o.y + o.height, m = 0, S = a.length; m < S; m++) for (var b = a[m]; b !== void 0; ) {
    var F = As(b, o.width, i, n), P = F.line, I = F.encoded, D = F.width, U = F.remainder, L = e === ut.Left ? o.x : e === ut.Center ? o.x + o.width / 2 - D / 2 : e === ut.Right ? o.x + o.width - D : o.x;
    y -= u, L < f && (f = L), y < d && (d = y), L + D > v && (v = L + D), y + s > g && (g = y + s), c.push({ text: P, encoded: I, width: D, height: s, x: L, y }), b = U == null ? void 0 : U.trim();
  }
  ...
  for (var s = i.width / o, u = n.heightAtSize(e, { descender: false }), c = i.y + (i.height / 2 - u / 2), f = [], d = i.x, v = i.y, g = i.x + i.width, y = i.y + i.height, m = 0, S = 0; m < o; ) {
    var b = ni(a, S), F = b[0], P = b[1], I = n.encodeText(F), D = n.widthOfTextAtSize(F, e), U = i.x + (s * m + s / 2), L = U - D / 2;
    L < d && (d = L), c < v && (v = c), L + D > g && (g = L + D), c + u > y && (y = c + u), f.push({ text: a, encoded: I, width: D, height: u, x: L, y: c }), m += 1, S += P;
  }
...
`);
  ...
  var n, i, o, a, s, u = Bt(t), c = Bt(r.acroField), f = Jt(t), d = Jt(r.acroField), v = t.getRectangle(), g = t.getAppearanceCharacteristics(), y = t.getBorderStyle(), m = g == null ? void 0 : g.getCaptions(), S = (n = m == null ? void 0 : m.normal) !== null && n !== void 0 ? n : "", b = (o = (i = m == null ? void 0 : m.down) !== null && i !== void 0 ? i : S) !== null && o !== void 0 ? o : "", F = (a = y == null ? void 0 : y.getWidth()) !== null && a !== void 0 ? a : 0, P = Kt(g == null ? void 0 : g.getRotation()), I = ne(v, P), D = I.width, U = I.height, L = $t(R(R({}, v), { rotation: P })), et = Q(0, 0, 0), rt = yt(g == null ? void 0 : g.getBorderColor()), it = yt(g == null ? void 0 : g.getBackgroundColor()), ht = yt(g == null ? void 0 : g.getBackgroundColor(), 0.8), _ = { x: F, y: F, width: D - F * 2, height: U - F * 2 }, $ = Sr(S, { alignment: ut.Center, fontSize: f ?? d, font: e, bounds: _ }), ot = Sr(b, { alignment: ut.Center, fontSize: f ?? d, font: e, bounds: _ }), bt = Math.min($.fontSize, ot.fontSize), Et = (s = u ?? c) !== null && s !== void 0 ? s : et;
  Tt(u || f !== void 0 ? t : r.acroField, Et, e, bt);
  var se = { x: 0 + F / 2, y: 0 + F / 2, width: D - F, height: U - F, borderWidth: F, borderColor: rt, textColor: Et, font: e.name, fontSize: bt };
  return { normal: X(L, Qn(R(R({}, se), { color: it, textLines: [$.line] }))), down: X(L, Qn(R(R({}, se), { color: ht, textLines: [ot.line] }))) };
}, Es = function(r, t, e) {
  var n, i, o, a, s = Bt(t), u = Bt(r.acroField), c = Jt(t), f = Jt(r.acroField), d = t.getRectangle(), v = t.getAppearanceCharacteristics(), g = t.getBorderStyle(), y = (n = r.getText()) !== null && n !== void 0 ? n : "", m = (i = g == null ? void 0 : g.getWidth()) !== null && i !== void 0 ? i : 0, S = Kt(v == null ? void 0 : v.getRotation()), b = ne(d, S), F = b.width, P = b.height, I = $t(R(R({}, d), { rotation: S })), D = Q(0, 0, 0), U = yt(v == null ? void 0 : v.getBorderColor()), L = yt(v == null ? void 0 : v.getBackgroundColor()), et, rt, it = r.isCombed() ? 0 : 1, ht = { x: m + it, y: m + it, width: F - (m + it) * 2, height: P - (m + it) * 2 };
  if (r.isMultiline()) {
    var _ = Qi(y, { alignment: r.getAlignment(), fontSize: c ?? f, font: e, bounds: ht });
    et = _.lines, rt = _.fontSize;
  } else if (r.isCombed()) {
    var _ = Ds(y, { fontSize: c ?? f, font: e, bounds: ht, cellCount: (o = r.getMaxLength()) !== null && o !== void 0 ? o : 0 });
    et = _.cells, rt = _.fontSize;
  } else {
    var _ = Sr(y, { alignment: r.getAlignment(), fontSize: c ?? f, font: e, bounds: ht });
    et = [_.line], rt = _.fontSize;
  }
  var $ = (a = s ?? u) !== null && a !== void 0 ? a : D;
  Tt(s || c !== void 0 ? t : r.acroField, $, e, rt);
  var ot = { x: 0 + m / 2, y: 0 + m / 2, width: F - m, height: P - m, borderWidth: m ?? 0, borderColor: U, textColor: $, font: e.name, fontSize: rt, color: L, textLines: et, padding: it };
  return X(I, Xi(ot));
}, Rs = function(r, t, e) {
  var n, i, o, a = Bt(t), s = Bt(r.acroField), u = Jt(t), c = Jt(r.acroField), f = t.getRectangle(), d = t.getAppearanceCharacteristics(), v = t.getBorderStyle(), g = (n = r.getSelected()[0]) !== null && n !== void 0 ? n : "", y = (i = v == null ? void 0 : v.getWidth()) !== null && i !== void 0 ? i : 0, m = Kt(d == null ? void 0 : d.getRotation()), S = ne(f, m), b = S.width, F = S.height, P = $t(R(R({}, f), { rotation: m })), I = Q(0, 0, 0), D = yt(d == null ? void 0 : d.getBorderColor()), U = yt(d == null ? void 0 : d.getBackgroundColor()), L = 1, et = { x: y + L, y: y + L, width: b - (y + L) * 2, height: F - (y + L) * 2 }, rt = Sr(g, { alignment: ut.Left, fontSize: u ?? c, font: e, bounds: et }), it = rt.line, ht = rt.fontSize, _ = (o = a ?? s) !== null && o !== void 0 ? o : I;
  Tt(a || u !== void 0 ? t : r.acroField, _, e, ht);
  var $ = { x: 0 + y / 2, y: 0 + y / 2, width: b - y, height: F - y, borderWidth: y ?? 0, borderColor: D, textColor: _, font: e.name, fontSize: ht, color: U, textLines: [it], padding: L };
  return X(P, Xi($));
}, js = function(r, t, e) {
  var n, i, o = Bt(t), a = Bt(r.acroField), s = Jt(t), u = Jt(r.acroField), c = t.getRectangle(), f = t.getAppearanceCharacteristics(), d = t.getBorderStyle(), v = (n = d == null ? void 0 : d.getWidth()) !== null && n !== void 0 ? n : 0, g = Kt(f == null ? void 0 : f.getRotation()), y = ne(c, g), m = y.width, S = y.height, b = $t(R(R({}, c), { rotation: g })), F = Q(0, 0, 0), P = yt(f == null ? void 0 : f.getBorderColor()), I = yt(f == null ? void 0 : f.getBackgroundColor()), D = r.getOptions(), U = r.getSelected();
  r.isSorted() && D.sort();
  for (var L = "", et = 0, rt = D.length; et < rt; et++) L += D[et], et < rt - 1 && (L += `
`);
  for (var it = 1, ht = { x: v + it, y: v + it, width: m - (v + it) * 2, height: S - (v + it) * 2 }, _ = Qi(L, { alignment: ut.Left, fontSize: s ?? u, font: e, bounds: ht }), $ = _.lines, ot = _.fontSize, bt = _.lineHeight, Et = [], et = 0, rt = $.length; et < rt; et++) {
    var se = $[et];
    U.includes(se.text) && Et.push(et);
  }
...
` + oe(n).toString();
  ...
  return t.prototype.check = function() {
    ...
    var f = this.createWidget({ x: (i = n.x) !== null && i !== void 0 ? i : 0, y: (o = n.y) !== null && o !== void 0 ? o : 0, width: (a = n.width) !== null && a !== void 0 ? a : 50, height: (s = n.height) !== null && s !== void 0 ? s : 50, textColor: n.textColor, backgroundColor: n.backgroundColor, borderColor: n.borderColor, borderWidth: (u = n.borderWidth) !== null && u !== void 0 ? u : 0, rotate: (c = n.rotate) !== null && c !== void 0 ? c : B(0), hidden: n.hidden, page: e.ref }), d = this.doc.context.register(f.dict);
  ...
  return t.prototype.getOptions = function() {
    ...
    var i, o, a, s, u, c, f;
    p(e, "page", [[Dt, "PDFPage"]]), xe(n), n || (n = {}), "textColor" in n || (n.textColor = Q(0, 0, 0)), "backgroundColor" in n || (n.backgroundColor = Q(1, 1, 1)), "borderColor" in n || (n.borderColor = Q(0, 0, 0)), "borderWidth" in n || (n.borderWidth = 1);
    var d = this.createWidget({ x: (i = n.x) !== null && i !== void 0 ? i : 0, y: (o = n.y) !== null && o !== void 0 ? o : 0, width: (a = n.width) !== null && a !== void 0 ? a : 200, height: (s = n.height) !== null && s !== void 0 ? s : 50, textColor: n.textColor, backgroundColor: n.backgroundColor, borderColor: n.borderColor, borderWidth: (u = n.borderWidth) !== null && u !== void 0 ? u : 0, rotate: (c = n.rotate) !== null && c !== void 0 ? c : B(0), hidden: n.hidden, page: e.ref }), v = this.doc.context.register(d.dict);
  ...
  return t.prototype.getOptions = function() {
    ...
    var i, o, a, s, u, c, f;
    p(e, "page", [[Dt, "PDFPage"]]), xe(n), n || (n = {}), "textColor" in n || (n.textColor = Q(0, 0, 0)), "backgroundColor" in n || (n.backgroundColor = Q(1, 1, 1)), "borderColor" in n || (n.borderColor = Q(0, 0, 0)), "borderWidth" in n || (n.borderWidth = 1);
    var d = this.createWidget({ x: (i = n.x) !== null && i !== void 0 ? i : 0, y: (o = n.y) !== null && o !== void 0 ? o : 0, width: (a = n.width) !== null && a !== void 0 ? a : 200, height: (s = n.height) !== null && s !== void 0 ? s : 100, textColor: n.textColor, backgroundColor: n.backgroundColor, borderColor: n.borderColor, borderWidth: (u = n.borderWidth) !== null && u !== void 0 ? u : 0, rotate: (c = n.rotate) !== null && c !== void 0 ? c : B(0), hidden: n.hidden, page: e.ref }), v = this.doc.context.register(d.dict);
    this.acroField.addWidget(v);
    var g = (f = n.font) !== null && f !== void 0 ? f : this.doc.getForm().getDefaultFont();
    this.updateWidgetAppearance(d, g), e.node.addAnnot(v);
  }, t.prototype.needsAppearancesUpdate = function() {
...
var Dt = function() {
  ...
  return r.prototype.setRotation = function(t) {
    ...
    for (var f = this.setOrEmbedFont(e.font), d = f.oldFont, v = f.newFont, g = f.newFontKey, y = e.size || this.fontSize, m = e.wordBreaks || this.doc.defaultWordBreaks, S = function(L) {
      return v.widthOfTextAtSize(L, y);
    }, b = e.maxWidth === void 0 ? ei(Ke(t)) : lo(t, m, e.maxWidth, S), F = new Array(b.length), P = 0, I = b.length; P < I; P++) F[P] = v.encodeText(b[P]);
    var D = this.maybeEmbedGraphicsState({ opacity: e.opacity, blendMode: e.blendMode }), U = this.getContentStream();
    U.push.apply(U, os(F, { color: (n = e.color) !== null && n !== void 0 ? n : this.fontColor, font: g, size: y, rotate: (i = e.rotate) !== null && i !== void 0 ? i : B(0), xSkew: (o = e.xSkew) !== null && o !== void 0 ? o : B(0), ySkew: (a = e.ySkew) !== null && a !== void 0 ? a : B(0), x: (s = e.x) !== null && s !== void 0 ? s : this.x, y: (u = e.y) !== null && u !== void 0 ? u : this.y, lineHeight: (c = e.lineHeight) !== null && c !== void 0 ? c : this.lineHeight, graphicsState: D })), e.font && (d ? this.setFont(d) : this.resetFont());
    ...
    v.push.apply(v, Vi(f, { x: (n = e.x) !== null && n !== void 0 ? n : this.x, y: (i = e.y) !== null && i !== void 0 ? i : this.y, width: (o = e.width) !== null && o !== void 0 ? o : t.size().width, height: (a = e.height) !== null && a !== void 0 ? a : t.size().height, rotate: (s = e.rotate) !== null && s !== void 0 ? s : B(0), xSkew: (u = e.xSkew) !== null && u !== void 0 ? u : B(0), ySkew: (c = e.ySkew) !== null && c !== void 0 ? c : B(0), graphicsState: d }));
    ...
    v.push.apply(v, as(u, { x: (n = e.x) !== null && n !== void 0 ? n : this.x, y: (i = e.y) !== null && i !== void 0 ? i : this.y, xScale: f, yScale: d, rotate: (o = e.rotate) !== null && o !== void 0 ? o : B(0), xSkew: (a = e.xSkew) !== null && a !== void 0 ? a : B(0), ySkew: (s = e.ySkew) !== null && s !== void 0 ? s : B(0), graphicsState: c }));
    ...
    S.push.apply(S, ge({ x: (e = t.x) !== null && e !== void 0 ? e : this.x, y: (n = t.y) !== null && n !== void 0 ? n : this.y, width: (i = t.width) !== null && i !== void 0 ? i : 150, height: (o = t.height) !== null && o !== void 0 ? o : 100, rotate: (a = t.rotate) !== null && a !== void 0 ? a : B(0), xSkew: (s = t.xSkew) !== null && s !== void 0 ? s : B(0), ySkew: (u = t.ySkew) !== null && u !== void 0 ? u : B(0), borderWidth: (c = t.borderWidth) !== null && c !== void 0 ? c : 0, color: (f = t.color) !== null && f !== void 0 ? f : void 0, borderColor: (d = t.borderColor) !== null && d !== void 0 ? d : void 0, borderDashArray: (v = t.borderDashArray) !== null && v !== void 0 ? v : void 0, borderDashPhase: (g = t.borderDashPhase) !== null && g !== void 0 ? g : void 0, graphicsState: m, borderLineCap: (y = t.borderLineCap) !== null && y !== void 0 ? y : void 0 }));
