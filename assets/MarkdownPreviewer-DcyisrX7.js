import { u as T, r as h, R as d, j as e, H } from "./index-OUpguYFg.js";
import { R as S } from "./RelatedTools-dQ1AUZ0r.js";
import { A as u } from "./arrow-left-right-BKEH1CcY.js";
import { F as C } from "./tools-B3OPepIK.js";
import { P as I } from "./printer-_6KKQSDv.js";
import { C as M } from "./copy-BogRq2Ao.js";
import { T as z } from "./trash-2-Csqesl1R.js";
import { M as L, r as R } from "./index-CIFy3PKE.js";
import { E } from "./eye-BOsdHd5p.js";
import { D as N } from "./download-DqlBxbZM.js";
...
`, G = () => {
  const w = `https://onlinetoolsvault.com${T().pathname.replace(/\/+$/, "")}/`, [m, p] = h.useState(`## Markdown syntax guide
...
This web site is using \`js\`.`), [o, c] = h.useState("split"), [i, f] = h.useState(true), g = d.useRef(null), b = d.useRef(null), n = d.useRef(false);
  d.useEffect(() => {
    if (!i || o !== "split") return;
