const __vite__mapDeps=(i,m=__vite__mapDeps,d=(m.f||(m.f=["assets/plugin-BWxyaa3V.js","assets/index-OUpguYFg.js","assets/index-Cv0roaG_.css","assets/doc-DG-4VZqw.js","assets/standalone-Bk8aH2NW.js","assets/standalone-CihvUZad.js","assets/___vite-browser-external_commonjs-proxy-CTUmEzTL.js","assets/__vite-browser-external-Dk_eJUSQ.js","assets/index-BYFqHt7P.js","assets/index-DEbk4XN2.js"])))=>i.map(i=>d[i]);
import { r as f, j as e, _ as d, __tla as __tla_0 } from "./index-OUpguYFg.js";
import { R as N } from "./RelatedTools-dQ1AUZ0r.js";
import { T as q } from "./ToolLayout-CuKFTkh4.js";
import { F as C } from "./monacoLoader-C7Yskktp.js";
import { U as D } from "./upload-Dhp0AOOy.js";
import { C as B } from "./check-CzYxOQpM.js";
import { C as $ } from "./copy-BogRq2Ao.js";
import { T as H } from "./trash-2-Csqesl1R.js";
import { A as J } from "./alert-circle-Dw9mwAgZ.js";
import { l as V } from "./tools-B3OPepIK.js";
import { Z as z } from "./zap-C2842ZXr.js";
import { S as Q } from "./shield-BrCBnKXk.js";
let ge;
  ...
  ge = ({ initialLanguage: i = "html", seoTitle: l = "Code Formatter - Free Online Multi-Language Beautifier", seoDescription: c = "Free online code formatter. Support for C, C++, Java, Python, SQL, XML, JSON, and more. Beautify your code instantly.", aboutTitle: s, aboutContent: p = Z, aboutExtra: r = ee, features: h = te, faqs: o = ae }) => {
    ...
    const E = (t) => !t || typeof t != "string" ? t : t.split(/(\*\*.*?\*\*)/g).map((a, u) => a.startsWith("**") && a.endsWith("**") ? e.jsx("strong", {
      ...
      xml: (t) => m(t, {
        ...
        const a = await d(() => import("./plugin-BWxyaa3V.js"), __vite__mapDeps([0,1,2,3]));
        return [
          a.default || a
        ];
      }),
      ...
      php: (t) => m(t, {
        ...
        const a = await d(() => import("./standalone-Bk8aH2NW.js").then((u) => u.s), __vite__mapDeps([4,1,2,5,6,7]));
        return [
          a.default || a
        ];
      }),
      java: (t) => m(t, {
        ...
        const a = await d(() => import("./index-BYFqHt7P.js"), __vite__mapDeps([8,1,2,5,3]));
        return [
          a.default || a
        ];
      }),
      sql: async (t) => {
        const { format: a } = await d(async () => {
          const { format: u } = await import("./index-DEbk4XN2.js");
          return {
            format: u
          };
