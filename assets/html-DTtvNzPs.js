...
var _e2, _Ln_instances, t_fn, _a2;
var sr = Object.defineProperty, or = (e) => {
  throw TypeError(e);
}, an = (e, t, r) => t in e ? sr(e, t, { enumerable: true, configurable: true, writable: true, value: r }) : e[t] = r, ur = (e, t) => {
  for (var r in t) sr(e, r, { get: t[r], enumerable: true });
}, xt = (e, t, r) => an(e, typeof t != "symbol" ? t + "" : t, r), sn = (e, t, r) => t.has(e) || or("Cannot " + r), xe = (e, t, r) => (sn(e, t, "read from private field"), r ? r.call(e) : t.get(e)), on = (e, t, r) => t.has(e) ? or("Cannot add the same private member more than once") : t instanceof WeakSet ? t.add(e) : t.set(e, r), un = {};
ur(un, { languages: () => eo, options: () => ro, parsers: () => Zr, printers: () => Fo });
...
}, mn = dn, lr = "string", cr = "array", pr = "cursor", ht = "indent", dt = "align", hr = "trim", mt = "group", gt = "fill", ft = "if-break", _t = "indent-if-break", dr = "line-suffix", mr = "line-suffix-boundary", Z = "line", gr = "label", Ct = "break-parent", fr = /* @__PURE__ */ new Set([pr, ht, dt, hr, mt, gt, ft, _t, dr, mr, Z, gr, Ct]);
function gn(e) {
...
function L(e, t = wn) {
  return Cr(e, (r) => typeof r == "string" ? ee(t, r.split(`
`)) : r);
}
var vn = mn;
function O(e) {
...
var S = { type: Z }, k = { type: Z, soft: true }, kn = { type: Z, hard: true }, v = [kn, ve], bn = { type: Z, hard: true, literal: true }, wn = [bn, ve], vr = Object.freeze({ character: "'", codePoint: 39 }), Sr = Object.freeze({ character: '"', codePoint: 34 }), yn = Object.freeze({ preferred: vr, alternate: Sr }), Dn = Object.freeze({ preferred: Sr, alternate: vr });
function xn(e, t) {
  let { preferred: r, alternate: n } = t === true || t === "'" ? yn : Dn, { length: a } = e, i = 0, s = 0;
  for (let o = 0; o < a; o++) {
...
var Ln = (_a2 = class {
  constructor(e) {
    __privateAdd(this, _Ln_instances);
    __privateAdd(this, _e2);
    __privateSet(this, _e2, new Set(e));
  }
  getLeadingWhitespaceCount(e) {
    let t = __privateGet(this, _e2), r = 0;
  ...
  hasTrailingWhitespace(e) {
    return __privateGet(this, _e2).has(Q(0, e, -1));
  }
  trimStart(e) {
    let t = this.getLeadingWhitespaceCount(e);
    return e.slice(t);
  ...
  split(e, t = false) {
    let r = `[${Bn([...__privateGet(this, _e2)].join(""))}]+`, n = new RegExp(t ? `(${r})` : r, "u");
    return e.split(n);
  }
  ...
  dedentString(e) {
    let t = __privateMethod(this, _Ln_instances, t_fn).call(this, e);
    return t === 0 ? e : e.split(`
`).map((r) => r.slice(t)).join(`
`);
  }
}, _e2 = new WeakMap(), _Ln_instances = new WeakSet(), t_fn = function(e) {
...
function Ar(e, t, r) {
  ...
  if (e.kind === "yaml" && delete t.value, e.kind === "attribute") {
    ...
    n === "style" || n === "class" || n === "srcset" && (r.fullName === "img" || r.fullName === "source") || n === "allow" && r.fullName === "iframe" || n.startsWith("on") || n.startsWith("@") || n.startsWith(":") || n.startsWith(".") || n.startsWith("#") || n.startsWith("v-") || n === "vars" && r.fullName === "style" || (n === "setup" || n === "generic") && r.fullName === "script" || n === "slot-scope" || n.startsWith("(") || n.startsWith("[") || n.startsWith("*") || n.startsWith("bind") || n.startsWith("i18n") || n.startsWith("on-") || n.startsWith("ng-") || (a == null ? void 0 : a.includes("{{")) ? delete t.value : a && (t.value = b(0, a, /'|&quot;|&apos;/gu, '"'));
  }
  if (e.kind === "docType" && (t.value = b(0, e.value.toLowerCase(), /\s+/gu, " ")), e.kind === "angularControlFlowBlock" && ((_a3 = e.parameters) == null ? void 0 : _a3.children)) for (let n of t.parameters.children) qn.has(e.name) ? delete n.expression : n.expression = n.expression.trim();
...
function Vn(e, t, r, n) {
  ...
  return /^\s*$/u.test(i) ? "" : N(i, e, { parser: "__ng_directive", __isInHtmlAttribute: false }, te);
}
...
function ra(e, t) {
  ...
  return (_a3 = ea(r, t.language) ?? Nt(r, t.physicalFile) ?? Nt(r, t.file) ?? Bt(r, t.physicalFile) ?? Bt(r, t.file) ?? (ta == null ? void 0 : ta(r, t.physicalFile))) == null ? void 0 : _a3.parsers[0];
}
var vt = ra, kr = Symbol.for("PRETTIER_IS_FRONT_MATTER");
function na(e) {
  return !!(e == null ? void 0 : e[kr]);
}
var qe = na, ie = 3;
function aa(e) {
  let t = e.slice(0, ie);
...
...`, r)), a === -1) return;
  let s = a + 1 + ie, o = e.charAt(s + 1);
  if (!/\s?/u.test(o)) return;
  let l = e.slice(0, s), c;
  return { language: i, explicitLanguage: n || null, value: e.slice(r + 1, a), startDelimiter: t, endDelimiter: l.slice(-ie), raw: l, start: { line: 1, column: 0, index: 0 }, end: { index: l.length, get line() {
    return c ?? (c = l.split(`
`)), c.length;
  }, get column() {
    return c ?? (c = l.split(`
...
function wr(e, t) {
  return !!(e.kind === "ieConditionalComment" && e.lastChild && !e.lastChild.isSelfClosing && !e.lastChild.endSourceSpan || e.kind === "ieConditionalComment" && !e.complete || J(e) && e.children.some((r) => r.kind !== "text" && r.kind !== "interpolation") || At(e, t) && !I(e, t) && e.kind !== "interpolation");
}
function He(e) {
  return e.kind === "attribute" || !e.parent || !e.prev ? false : ha(e.prev);
}
function ha(e) {
...
function I(e, t) {
  return e.kind === "element" && (e.fullName === "script" || e.fullName === "style" || e.fullName === "svg:style" || e.fullName === "svg:script" || e.fullName === "mj-style" && t.parser === "mjml" || Ae(e) && (e.name === "script" || e.name === "style"));
}
function da(e, t) {
...
function Na(e, t) {
  ...
  let r = false;
  if (e.kind === "element" && e.namespace === "svg") if (xa(e, (n) => n.fullName === "svg:foreignObject")) r = true;
  ...
  switch (t.htmlWhitespaceSensitivity) {
    ...
    case "ignore":
      return "block";
    default:
      if (e.kind === "element" && (!e.namespace || r || Ae(e)) && Object.prototype.hasOwnProperty.call(Lt, e.name)) return Lt[e.name];
  }
  return oa;
}
function Fr(e) {
  return e.kind === "element" && (!e.namespace || Ae(e)) && Object.prototype.hasOwnProperty.call(Ot, e.name) ? Ot[e.name] : ua;
}
function Pr(e) {
  return b(0, b(0, e, "&apos;", "'"), "&quot;", '"');
}
...
function Ve(e, t) {
  return re(e, t) && !Ba.has(e.fullName);
}
function re(e, t) {
  return t.parser === "vue" && e.kind === "element" && e.parent.kind === "root" && e.fullName.toLowerCase() !== "html";
}
function At(e, t) {
  return re(e, t) && (Ve(e, t) || e.attrMap.lang && e.attrMap.lang !== "html");
}
function La(e) {
  let t = e.fullName;
...
function Oa(e, t) {
  let r = e.parent;
  if (!re(r, t)) return false;
  let n = r.fullName, a = e.fullName;
  return n === "script" && a === "setup" || n === "style" && a === "vars";
}
function Ir(e, t = e.value) {
  return e.parent.isWhitespaceSensitive ? e.parent.isIndentationSensitive ? L(t) : L(x.dedentString(br(t)), v) : ee(S, x.split(t));
}
function Rr(e, t) {
...
async function Ia(e, t, r) {
  ...
  for (let [i, s] of n.split(qr).entries()) if (i % 2 === 0) a.push(L(s));
    ...
    a.push(A(["{{", O([S, await N(s, e, { parser: "__ng_interpolation", __isInHtmlInterpolation: true })]), S, "}}"]));
  } catch {
    a.push("{{", L(s), "}}");
  }
  return a;
}
var Ke = (e) => (t, r, n) => N(w(n.node), t, { parser: e }, te), Ra = [{ test(e) {
...
function Ka(e, t, r) {
  ...
  return a.length === 0 ? [""] : Se(a.map(({ name: i, value: s }, o) => [[i, ...s].join(" "), o === a.length - 1 ? fe(";") : [";", S]]));
}
function Pt(e) {
  return e === "	" || e === `
` || e === "\f" || e === "\r" || e === " ";
...
function ti(e) {
  ...
  function g() {
    let h = false, f, E, B, F, q = {}, R, De, X, ae, Xe;
    for (F = 0; F < n.length; F++) R = n[F], De = R[R.length - 1], X = R.substring(0, R.length - 1), ae = parseInt(X, 10), Xe = parseFloat(X), It.test(X) && De === "w" ? ((f || E) && (h = true), ae === 0 ? h = true : f = ae) : ei.test(X) && De === "x" ? ((f || E || B) && (h = true), Xe < 0 ? h = true : E = Xe) : It.test(X) && De === "h" ? ((B || E) && (h = true), ae === 0 ? h = true : B = ae) : h = true;
...
var si = ({ node: e }, t) => e.fullName === "style" && !t.parentParser && !e.value.includes("{{"), oi = async (e, t, r) => Se(await e(w(r.node), { parser: "css", __isHTMLStyleAttribute: true })), Ye = /* @__PURE__ */ new WeakMap();
function ui(e, t) {
  let { root: r } = e;
...
function li(e, t, r) {
  let n = w(r.node);
  return N(`type T<${n}> = any`, e, { parser: "babel-ts", __isEmbeddedTypescriptGenericParameters: true }, te);
}
function ci(e, t, r, n) {
  let a = w(r.node), i = ne(r, n) ? "babel-ts" : "babel";
  return N(`function _(${a}) {}`, e, { parser: i, __isVueBindings: true });
}
async function pi(e, t, r, n) {
  let a = w(r.node), { left: i, operator: s, right: o } = hi(a), l = ne(r, n);
  return [A(await N(`function _(${i}) {}`, e, { parser: l ? "babel-ts" : "babel", __isVueForBindingLeft: true })), " ", s, " ", await N(o, e, { parser: l ? "__ts_expression" : "__js_expression" })];
}
function hi(e) {
...
async function mi(e, t, r, n) {
  ...
  try {
    ...
    if (((_a3 = s.cause) == null ? void 0 : _a3.code) !== "BABEL_PARSER_SYNTAX_ERROR") throw s;
  }
  let a = w(r.node), i = ne(r, n) ? "__vue_ts_event_binding" : "__vue_event_binding";
  return N(a, e, { parser: i }, te);
}
function gi(e, t, r, n) {
  let a = w(r.node), i = ne(r, n) ? "__vue_ts_expression" : "__vue_expression";
  return N(a, e, { parser: i }, te);
}
function Vr(e, t, r, n) {
  let a = w(r.node), i = ne(r, n) ? "__ts_expression" : "__js_expression";
  return N(a, e, { parser: i }, te);
}
...
function Ci(e, t) {
  ...
  if (n) return Mr(r, t) ? [r.rawName, "=", n] : (_a3 = _i.find(({ test: a }) => a(e, t))) == null ? void 0 : _a3.print;
}
function Ei(e) {
...
var vi = Ci, ke = (e) => e.sourceSpan.start.offset, Ue = (e) => e.sourceSpan.end.offset;
function et(e, t) {
  return [e.isSelfClosing ? "" : Si(e, t), he(e, t)];
}
function Si(e, t) {
  return e.lastChild && _e(e.lastChild) ? "" : [Ai(e, t), Tt(e, t)];
}
function he(e, t) {
  return (e.next ? z(e.next) : we(e.parent)) ? "" : [be(e, t), W(e, t)];
}
function Ai(e, t) {
  return we(e) ? be(e.lastChild, t) : "";
}
function W(e, t) {
  return _e(e) ? Tt(e.parent, t) : We(e) ? kt(e.next, t) : "";
}
function Tt(e, t) {
  if (Ur(e, t)) return "";
  switch (e.kind) {
...
function we(e) {
  var _a3;
  return ((_a3 = e.lastChild) == null ? void 0 : _a3.isTrailingSpaceSensitive) && !e.lastChild.hasTrailingSpaces && !D(St(e.lastChild)) && !J(e);
}
function _e(e) {
...
function ki(e, t, r) {
  ...
  let a = ((_a3 = n.prev) == null ? void 0 : _a3.kind) === "comment" && Ti(n.prev.value), i = typeof a == "boolean" ? () => a : Array.isArray(a) ? (p) => a.includes(p.rawName) : () => false, s = e.map(({ node: p }) => i(p) ? L(t.originalText.slice(ke(p), Ue(p))) : r(), "attrs"), o = n.kind === "element" && n.fullName === "script" && n.attrs.length === 1 && n.attrs[0].fullName === "src" && n.children.length === 0, l = t.singleAttributePerLine && n.attrs.length > 1 && !re(n, t) ? v : S, c = [O([o ? " " : S, ee(l, s)])];
  return n.firstChild && ze(n.firstChild) || n.isSelfClosing && we(n.parent) || o ? c.push(n.isSelfClosing ? " " : "") : c.push(t.bracketSameLine ? n.isSelfClosing ? " " : "" : n.isSelfClosing ? S : k), c;
}
function bi(e) {
...
function tt(e, t, r) {
  let { node: n } = e;
  return [de(n, t), ki(e, t, r), n.isSelfClosing ? "" : bi(n)];
}
function de(e, t) {
  return e.prev && We(e.prev) ? "" : [$(e, t), kt(e, t)];
}
function $(e, t) {
  return ze(e) ? bt(e.parent) : z(e) ? be(e.prev, t) : "";
}
var Rt = "<!doctype";
function kt(e, t) {
  switch (e.kind) {
...
function wi(e, t) {
  ...
  return e.lastChild && _e(e.lastChild) ? n += Tt(e, t).length : we(e) && (n -= be(e.lastChild, t).length), t.originalText.slice(r, n);
}
...
function Di(e, t) {
  ...
  switch (r.kind) {
    case "element":
      ...
      if (!r.isSelfClosing && At(r, t)) {
        ...
        return n ? async (a, i) => {
          ...
          return o || (l = await a(br(s), { parser: n, __embeddedInHtml: true }), o = l === ""), [$(r, t), A(tt(e, t, i)), o ? "" : v, l, o ? "" : v, et(r, t), W(r, t)];
        } : void 0;
      }
      break;
    case "text":
      if (I(r.parent, t)) {
        ...
        if (n) return async (a) => {
          ...
          return [ve, $(r, t), await a(i, s), W(r, t)];
        };
      } else if (r.parent.kind === "interpolation") return async (n) => {
        let a = { __isInHtmlInterpolation: true, __embeddedInHtml: true };
        return t.parser === "angular" ? a.parser = "__ng_interpolation" : t.parser === "vue" ? a.parser = ne(e, t) ? "__vue_ts_expression" : "__vue_expression" : a.parser = "__js_expression", [O([S, await n(r.value, a)]), r.parent.next && z(r.parent.next) ? " " : S];
      };
      break;
    case "attribute":
      return vi(e, t);
    ...
    case "angularLetDeclarationInitializer":
      return (n) => N(r.value, n, { parser: "__ng_binding", __isInHtmlAttribute: false });
  }
}
var xi = Di, se = null;
function me(e) {
  if (se !== null && typeof se.property) {
    let t = se;
    return se = me.prototype = null, t;
  }
  return se = me.prototype = e ?? /* @__PURE__ */ Object.create(null), new me();
}
var Ni = 10;
for (let e = 0; e <= Ni; e++) me();
function Bi(e) {
  return me(e);
}
...
function zr(e) {
  let t = Ue(e);
  return e.kind === "element" && !e.endSourceSpan && Et(e.children) ? Math.max(t, zr(Q(0, e.children, -1))) : t;
}
function oe(e, t, r) {
  let n = e.node;
  if (He(n)) {
    let a = zr(n);
    return [$(n, t), L(x.trimEnd(t.originalText.slice(ke(n) + (n.prev && We(n.prev) ? kt(n).length : 0), a - (n.next && z(n.next) ? be(n, t).length : 0)))), W(n, t)];
  }
  return r();
}
function Be(e, t) {
  return D(e) && D(t) ? e.isTrailingSpaceSensitive ? e.hasTrailingSpaces ? Ge(t) ? v : S : "" : Ge(t) ? v : k : We(e) && (He(t) || t.firstChild || t.isSelfClosing || t.kind === "element" && t.attrs.length > 0) || e.kind === "element" && e.isSelfClosing && z(t) ? "" : !t.isLeadingSpaceSensitive || Ge(t) || z(t) && e.lastChild && _e(e.lastChild) && e.lastChild.lastChild && _e(e.lastChild.lastChild) ? v : t.hasLeadingSpaces ? S : k;
}
function wt(e, t, r) {
  let { node: n } = e;
  if (Dr(n)) return [ve, ...e.map(() => {
    let i = e.node, s = i.prev ? Be(i.prev, i) : "";
    return [s ? [s, Ne(i.prev) ? v : ""] : "", oe(e, t, r)];
  }, "children")];
  ...
  return e.map(({ node: i, index: s }) => {
    if (D(i)) {
      if (i.prev && D(i.prev)) {
        let h = Be(i.prev, i);
        if (h) return Ne(i.prev) ? [v, v, oe(e, t, r)] : [h, oe(e, t, r)];
      }
      return oe(e, t, r);
    }
    let o = [], l = [], c = [], p = [], C = i.prev ? Be(i.prev, i) : "", g = i.next ? Be(i, i.next) : "";
    return C && (Ne(i.prev) ? o.push(v, v) : C === v ? o.push(v) : D(i.prev) ? l.push(C) : l.push(fe("", k, { groupId: a[s - 1] }))), g && (Ne(i) ? D(i.next) && p.push(v, v) : g === v ? D(i.next) && p.push(v) : c.push(g)), [...o, A([...l, A([oe(e, t, r), ...c], { id: a[s] })]), ...p];
  }, "children");
}
function zi(e, t, r) {
  let { node: n } = e, a = [];
  $i(e) && a.push("} "), a.push("@", n.name), n.parameters && a.push(" (", A(r("parameters")), ")"), a.push(" {");
  let i = $r(n);
  return n.children.length > 0 ? (n.firstChild.hasLeadingSpaces = true, n.lastChild.hasTrailingSpaces = true, a.push(O([v, wt(e, t, r)])), i && a.push(v, "}")) : i && a.push("}"), A(a, { shouldBreak: true });
}
function $r(e) {
  var _a3, _b;
  return !(((_a3 = e.next) == null ? void 0 : _a3.kind) === "angularControlFlowBlock" && ((_b = Wi.get(e.name)) == null ? void 0 : _b.has(e.next.name)));
}
function $i(e) {
  let { previous: t } = e;
  return (t == null ? void 0 : t.kind) === "angularControlFlowBlock" && !He(t) && !$r(t);
}
function ji(e, t, r) {
  return [O([k, ee([";", S], e.map(r, "children"))]), k];
}
function Xi(e, t, r) {
  let { node: n } = e;
  return [de(n, t), A([n.switchValue.trim(), ", ", n.type, n.cases.length > 0 ? [",", O([S, ee(S, e.map(r, "cases"))])] : "", k]), he(n, t)];
}
function Gi(e, t, r) {
  let { node: n } = e;
...
function Ki(e, t, r) {
  ...
  let a = n.children.length === 1 && (n.firstChild.kind === "interpolation" || n.firstChild.kind === "angularIcuExpression") && n.firstChild.isLeadingSpaceSensitive && !n.firstChild.hasLeadingSpaces && n.lastChild.isTrailingSpaceSensitive && !n.lastChild.hasTrailingSpaces, i = Symbol("element-attr-group-id"), s = (p) => A([A(tt(e, t, r), { id: i }), p, et(n, t)]), o = (p) => a ? Tn(p, { groupId: i }) : (I(n, t) || Ve(n, t)) && n.parent.kind === "root" && t.parser === "vue" && !t.vueIndentScriptAndStyle ? p : O(p), l = () => a ? fe(k, "", { groupId: i }) : n.firstChild.hasLeadingSpaces && n.firstChild.isLeadingSpaceSensitive ? S : n.firstChild.kind === "text" && n.isWhitespaceSensitive && n.isIndentationSensitive ? An(k) : k, c = () => (n.next ? z(n.next) : we(n.parent)) ? n.lastChild.hasTrailingSpaces && n.lastChild.isTrailingSpaceSensitive ? " " : "" : a ? fe(k, "", { groupId: i }) : n.lastChild.hasTrailingSpaces && n.lastChild.isTrailingSpaceSensitive ? S : (n.lastChild.kind === "comment" || n.lastChild.kind === "text" && n.isWhitespaceSensitive && n.isIndentationSensitive) && new RegExp(`\\n[\\t ]{${t.tabWidth * (e.ancestors.length - 1)}}$`, "u").test(n.lastChild.value) ? "" : k;
  return n.children.length === 0 ? s(n.hasDanglingSpaces && n.isDanglingSpaceSensitive ? S : "") : s([Ca(n) ? ve : "", o([l(), wt(e, t, r)]), c()]);
}
var P = function(e) {
...
var Ht = { name: "custom-elements" }, Vt = { name: "no-errors-schema" }, ce = function(e) {
...
var Qi = class {
      ...
      i.forEach((c) => {
        if (c.length > 0) switch (c[0]) {
          case "*":
            ...
            break;
          case "!":
            t.set(c.substring(1), Zi);
            break;
          case "#":
            t.set(c.substring(1), es);
            break;
          case "%":
  ...
  hasProperty(e, t, r) {
    if (r.some((n) => n.name === Vt.name)) return true;
    if (e.indexOf("-") > -1) {
      if (Mt(e) || qt(e)) return false;
      if (r.some((n) => n.name === Ht.name)) return true;
    }
    return (this._schema.get(e.toLowerCase()) || this._schema.get("unknown")).has(t);
  }
  hasElement(e, t) {
    return t.some((r) => r.name === Vt.name) || e.indexOf("-") > -1 && (Mt(e) || qt(e) || t.some((r) => r.name === Ht.name)) ? true : this._schema.has(e.toLowerCase());
  }
  securityContext(e, t, r) {
    r && (t = this.getMappedPropName(t)), e = e.toLowerCase(), t = t.toLowerCase();
    let n = Ut()[e + "|" + t];
    return n || (n = Ut()["*|" + t], n || ce.NONE);
  }
  getMappedPropName(e) {
    return jr.get(e) ?? e;
  }
...
If '${e}' is a directive input, make sure the directive is imported by the current module.` } : { error: false };
  ...
  allKnownAttributesOfElement(e) {
    ...
    return Array.from(t.keys()).map((r) => as.get(r) ?? r);
  }
...
var m = class {
  constructor({ closedByChildren: e, implicitNamespacePrefix: t, contentType: r = P.PARSABLE_DATA, closedByParent: n = false, isVoid: a = false, ignoreFirstLf: i = false, preventNamespaceInheritance: s = false, canSelfClose: o = false } = {}) {
    this.closedByChildren = {}, this.closedByParent = false, e && e.length > 0 && e.forEach((l) => this.closedByChildren[l] = true), this.isVoid = a, this.closedByParent = n || a, this.implicitNamespacePrefix = t || null, this.contentType = r, this.ignoreFirstLf = i, this.preventNamespaceInheritance = s, this.canSelfClose = o ?? a;
  }
  isClosedByChild(e) {
...
function Es(e, t, r, n = {}) {
  let a = new Ts(new Gr(e, t), r, n);
  return a.tokenize(), new Cs(Ns(a.tokens), a.errors, a.nonNormalizedIcuExpressions);
}
var vs = /\r\n?/g;
function V(e) {
...
}(at || {}), As = ["@if", "@else", "@for", "@switch", "@case", "@default", "@empty", "@defer", "@placeholder", "@loading", "@error"], le = { start: "{{", end: "}}" }, Ts = class {
  constructor(e, t, r) {
    this._getTagContentType = t, this._currentTokenStart = null, this._currentTokenType = null, this._expansionCaseStack = [], this._openDirectiveCount = 0, this._inInterpolation = false, this._fullNameStack = [], this.tokens = [], this.errors = [], this.nonNormalizedIcuExpressions = [], this._tokenizeIcu = r.tokenizeExpansionForms || false, this._leadingTriviaCodePoints = r.leadingTriviaChars && r.leadingTriviaChars.map((a) => a.codePointAt(0) || 0), this._canSelfClose = r.canSelfClose || false, this._allowHtmComponentClosingTags = r.allowHtmComponentClosingTags || false;
    let n = r.range || { endPos: e.content.length, startPos: 0, startLine: 0, startCol: 0 };
    this._cursor = r.escapedString ? new Bs(e, n) : new Yr(e, n), this._preserveLineEndings = r.preserveLineEndings || false, this._i18nNormalizeLineEndingsInICUs = r.i18nNormalizeLineEndingsInICUs || false, this._tokenizeBlocks = r.tokenizeBlocks ?? true, this._tokenizeLet = r.tokenizeLet ?? true, this._selectorlessEnabled = r.selectorlessEnabled ?? false;
    try {
      this._cursor.init();
    } catch (a) {
      this.handleError(a);
...
`);
  ...
  _getBlockName() {
    ...
    return this._attemptCharCodeUntilFn((r) => Re(r) ? !e : xs(r) ? (e = true, false) : true), this._cursor.getChars(t).trim();
  }
  ...
  _getLetDeclarationName() {
    ...
    return this._attemptCharCodeUntilFn((r) => Ce(r) || r === 36 || r === 95 || t && je(r) ? (t = true, false) : true), this._cursor.getChars(e).trim();
  }
  _consumeLetDeclarationValue() {
    ...
    for (this._beginToken(u.LET_VALUE, e); this._cursor.peek() !== 0; ) {
      ...
      if (t === 59) break;
      Je(t) && (this._cursor.advance(), this._attemptCharCodeUntilFn((r) => r === 92 ? (this._cursor.advance(), false) : r === t)), this._cursor.advance();
    }
    this._endToken([this._cursor.getChars(e)]);
  }
  _tokenizeExpansionForm() {
    if (this.isExpansionFormStart()) return this._consumeExpansionFormStart(), true;
    if (ys(this._cursor.peek()) && this._isInExpansionForm()) return this._consumeExpansionCaseStart(), true;
  ...
  _endToken(e, t) {
    if (this._currentTokenStart === null) throw new K(this._cursor.getSpan(t), "Programming error - attempted to end a token when there was no start to the token");
    if (this._currentTokenType === null) throw new K(this._cursor.getSpan(this._currentTokenStart), "Programming error - attempted to end a token which has no token type");
  ...
  handleError(e) {
    if (e instanceof yt && (e = this._createError(e.msg, this._cursor.getSpan(e.cursor))), e instanceof K) this.errors.push(e);
    else throw e;
  }
  _attemptCharCode(e) {
  ...
  _attemptCharCodeCaseInsensitive(e) {
    return Ds(this._cursor.peek(), e) ? (this._cursor.advance(), true) : false;
  }
  _requireCharCode(e) {
    let t = this._cursor.clone();
  ...
  _isBlockStart() {
    return this._cursor.peek() === 64 && As.some((e) => this._peekStr(e));
  }
  _isLetStart() {
  ...
  _consumeEntity(e) {
    ...
    if (this._cursor.advance(), this._attemptCharCode(35)) {
      ...
      if (this._attemptCharCodeUntilFn(bs), this._cursor.peek() != 59) {
        ...
        throw this._createError(Ss(i, this._cursor.getChars(t)), this._cursor.getSpan());
      }
      ...
      let r = this._cursor.clone();
      if (this._attemptCharCodeUntilFn(ws), this._cursor.peek() != 59) this._beginToken(e, t), this._cursor = r, this._endToken(["&"]);
      else {
        let n = this._cursor.getChars(r);
        this._cursor.advance();
        let a = Ee.hasOwnProperty(n) && Ee[n];
  ...
  _consumeComment(e) {
    this._beginToken(u.COMMENT_START, e), this._endToken([]), this._consumeRawText(false, () => this._attemptStr("-->")), this._beginToken(u.COMMENT_END), this._requireStr("-->"), this._endToken([]);
  }
  _consumeBogusComment(e) {
    this._beginToken(u.COMMENT_START, e), this._endToken([]), this._consumeRawText(false, () => this._cursor.peek() === 62), this._beginToken(u.COMMENT_END), this._cursor.advance(), this._endToken([]);
  }
  _consumeCdata(e) {
    this._beginToken(u.CDATA_START, e), this._endToken([]), this._consumeRawText(false, () => this._attemptStr("]]>")), this._beginToken(u.CDATA_END), this._requireStr("]]>"), this._endToken([]);
  }
  _consumeDocType(e) {
    this._beginToken(u.DOC_TYPE_START, e), this._endToken([]), this._consumeRawText(false, () => this._cursor.peek() === 62), this._beginToken(u.DOC_TYPE_END), this._cursor.advance(), this._endToken([]);
  }
  _consumePrefixAndName(e) {
    let t = this._cursor.clone(), r = "";
    for (; this._cursor.peek() !== 58 && !ks(this._cursor.peek()); ) this._cursor.advance();
    let n;
  ...
  _consumeTagOpen(e) {
    ...
    try {
      if (this._selectorlessEnabled && Oe(this._cursor.peek())) a = this._consumeComponentOpenStart(e), [n, r, t] = a.parts, r && (n += `:${r}`), t && (n += `:${t}`), this._attemptCharCodeUntilFn(_);
        ...
        if (!Ce(this._cursor.peek())) throw this._createError(V(this._cursor.peek()), this._cursor.getSpan(e));
  ...
  _consumeWithInterpolation(e, t, r, n) {
    ...
    for (; !r(); ) {
      ...
      this._attemptStr(le.start) ? (this._endToken([this._processCarriageReturns(a.join(""))], s), a.length = 0, this._consumeInterpolation(t, s, n), this._beginToken(e)) : this._cursor.peek() === 38 ? (this._endToken([this._processCarriageReturns(a.join(""))]), a.length = 0, this._consumeEntity(e), this._beginToken(e)) : a.push(this._readChar());
    }
  ...
  _consumeInterpolation(e, t, r) {
    let n = [];
    this._beginToken(e, t), n.push(le.start);
    let a = this._cursor.clone(), i = null, s = false;
    for (; this._cursor.peek() !== 0 && (r === null || !r()); ) {
      ...
      if (i === null) if (this._attemptStr(le.end)) {
        n.push(this._getProcessedChars(a, o)), n.push(le.end), this._endToken(n);
        return;
  ...
  isExpansionFormStart() {
    ...
    let e = this._cursor.clone(), t = this._attemptStr(le.start);
...
var Yr = class it {
  ...
  parse(e, t, r, n = false, a) {
    let i = (h) => (f, ...E) => h(f.toLowerCase(), ...E), s = n ? this.getTagDefinition : i(this.getTagDefinition), o = (h) => s(h).getContentType(), l = n ? a : i(a), c = Es(e, t, a ? (h, f, E, B) => {
      let F = l(h, f, E, B);
      return F !== void 0 ? F : o(h);
    } : o, r), p = r && r.canSelfClose || false, C = r && r.allowHtmComponentClosingTags || false, g = new Fs(c.tokens, s, p, C, n);
    return g.build(), new Ls(g.rootNodes, [...c.errors, ...g.errors]);
  }
}, Fs = class Qr {
  ...
  _consumeCdata(t) {
    ...
    this._addToParent(new ls(n, new d(t.sourceSpan.start, (a || r).sourceSpan.end), [r]));
  }
  _consumeComment(t) {
  ...
  _consumeExpansion(t) {
    ...
    this._addToParent(new cs(r.parts[0], n.parts[0], a, i, r.sourceSpan)), this._advance();
  }
  _parseExpansionCase() {
    let t = this._advance();
    ...
    return new ps(t.parts[0], i.rootNodes, s, t.sourceSpan, o);
  }
...
`) {
    ...
    if (a.length > 0) {
      let s = t.sourceSpan;
      this._addToParent(new us(a, new d(n.start, s.end, n.fullStart, n.details), r));
    }
  }
  _closeVoidElement() {
    var t;
  ...
  _consumeElementStartTag(t) {
    ...
    let i = this._getElementFullName(t, this._getClosestElementLikeParent()), s = this._getTagDefinition(i), o = false;
    if (this._peek.type === u.TAG_OPEN_END_VOID) {
      this._advance(), o = true;
      let E = this._getTagDefinition(i);
      this.canSelfClose || (E == null ? void 0 : E.canSelfClose) || Pe(i) !== null || (E == null ? void 0 : E.isVoid) || this.errors.push(T.create(i, t.sourceSpan, `Only void, custom and foreign elements can be self closed "${t.parts[1]}"`));
    } else this._peek.type === u.TAG_OPEN_END && (this._advance(), o = false);
    let l = this._peek.sourceSpan.fullStart, c = new d(t.sourceSpan.start, l, t.sourceSpan.fullStart), p = new d(t.sourceSpan.start, l, t.sourceSpan.fullStart), C = new d(t.sourceSpan.start.moveBy(1), t.sourceSpan.end), g = new H(i, n, a, [], o, c, p, void 0, C, (s == null ? void 0 : s.isVoid) ?? false), h = this._getContainer(), f = h !== null && !!(!((r = this._getTagDefinition(h)) === null || r === void 0) && r.isClosedByChild(g.name));
  ...
  _popContainer(t, r, n) {
    ...
    for (let s = this._containerStack.length - 1; s >= 0; s--) {
      ...
      (o instanceof G || !(!((i = this._getTagDefinition(o)) === null || i === void 0) && i.closedByParent)) && (a = true);
    }
    return false;
  }
  _consumeAttr(t) {
    let r = ge(t.parts[0], t.parts[1]), n = t.sourceSpan.end, a;
    ...
    return new hs(r, i, new d(t.sourceSpan.start, n, t.sourceSpan.fullStart), t.sourceSpan, c, s.length > 0 ? s : void 0, void 0);
  }
  _consumeDirective(t) {
    ...
    return new gs(t.parts[0], r, s, i, a);
  }
  _consumeBlockOpen(t) {
    let r = [];
  ...
  _consumeIncompleteBlock(t) {
    ...
    let n = this._peek.sourceSpan.fullStart, a = new d(t.sourceSpan.start, n, t.sourceSpan.fullStart), i = new d(t.sourceSpan.start, n, t.sourceSpan.fullStart), s = new G(t.parts[0], r, [], a, t.sourceSpan, i);
    this._pushContainer(s, false), this._popContainer(null, G, null), this.errors.push(T.create(t.parts[0], a, `Incomplete block "${t.parts[0]}". If you meant to write the @ character, you should use the "&#64;" HTML entity instead.`));
  }
  _consumeLet(t) {
    let r = t.parts[0], n, a;
  ...
  _getElementFullName(t, r) {
    return ge(this._getPrefix(t, r), t.parts[1]);
  }
  ...
  _getComponentTagName(t, r) {
    ...
    return !n && !a ? null : !n && a ? a : ge(n, a || "ng-component");
  }
  _getPrefix(t, r) {
    var n;
    let a, i;
...
function er(e, t) {
  return Ee[t] !== void 0 ? Ee[t] || e : /^#x[a-f0-9]+$/i.test(t) ? String.fromCodePoint(parseInt(t.slice(2), 16)) : /^#\d+$/.test(t) ? String.fromCodePoint(parseInt(t.slice(1), 10)) : e;
}
var Ps = class extends Os {
  constructor() {
    super(rt);
  }
  parse(e, t, r, n = false, a) {
...
}, Qe = null, Is = () => (Qe || (Qe = new Ps()), Qe);
function ot(e, t = {}) {
  let { canSelfClose: r = false, allowHtmComponentClosingTags: n = false, isTagNameCaseSensitive: a = false, getTagContentType: i, tokenizeAngularBlocks: s = false, tokenizeAngularLetDeclaration: o = false, enableAngularSelectorlessSyntax: l = false } = t;
  return Is().parse(e, "angular-html-parser", { tokenizeExpansionForms: s, canSelfClose: r, allowHtmComponentClosingTags: n, tokenizeBlocks: s, tokenizeLet: o, selectorlessEnabled: l }, a, i);
}
var Rs = [qs, Hs, Us, zs, $s, Gs, js, Xs, Ks, Ws];
function Ms(e, t) {
  for (let r of Rs) r(e, t);
  return e;
}
function qs(e) {
  e.walk((t) => {
...
function Us(e) {
  return Vs(e, (t) => t.kind === "cdata", (t) => `<![CDATA[${t.value}]]>`);
}
function Ws(e) {
  let t = (r) => {
    var _a3, _b;
    return r.kind === "element" && r.attrs.length === 0 && r.children.length === 1 && r.firstChild.kind === "text" && !x.hasWhitespaceCharacter(r.children[0].value) && !r.firstChild.hasLeadingSpaces && !r.firstChild.hasTrailingSpaces && r.isLeadingSpaceSensitive && !r.hasLeadingSpaces && r.isTrailingSpaceSensitive && !r.hasTrailingSpaces && ((_a3 = r.prev) == null ? void 0 : _a3.kind) === "text" && ((_b = r.next) == null ? void 0 : _b.kind) === "text";
  };
  e.walk((r) => {
    if (r.children) for (let n = 0; n < r.children.length; n++) {
      let a = r.children[n];
...
function $s(e, t) {
  e.walk((r) => {
    ...
    if (!a) for (let s = 0; s < n.length; s++) {
      ...
      c ? (o.value = c, o.sourceSpan = new d(o.sourceSpan.start.moveBy(l.length), o.sourceSpan.end.moveBy(-p.length)), l && (C && (C.hasTrailingSpaces = true), o.hasLeadingSpaces = true), p && (o.hasTrailingSpaces = true, g && (g.hasLeadingSpaces = true))) : (r.removeChild(o), s--, (l || p) && (C && (C.hasTrailingSpaces = true), g && (g.hasLeadingSpaces = true)));
    }
...
function Js(e, t, r) {
  ...
  switch (n.kind) {
    ...
    case "ieConditionalEndComment":
      return [de(n), he(n)];
    case "interpolation":
      return [de(n, t), ...e.map(r, "children"), he(n, t)];
    case "text": {
    ...
    case "docType":
      return [A([de(n, t), " ", b(0, n.value.replace(/^html\b/iu, "html"), /\s+/gu, " ")]), he(n, t)];
    case "comment":
      return [$(n, t), L(t.originalText.slice(ke(n), Ue(n))), W(n, t)];
    case "attribute": {
...
var Qs = { features: { experimental_frontMatterSupport: { massageAstNode: true, embed: true, print: true } }, preprocess: Ys, print: Js, insertPragma: Ui, massageAstNode: Hn, embed: xi, getVisitorKeys: Ii }, Zs = Qs, eo = [{ name: "Angular", type: "markup", aceMode: "html", extensions: [".component.html"], tmScope: "text.html.basic", aliases: ["xhtml"], codemirrorMode: "htmlmixed", codemirrorMimeType: "text/html", parsers: ["angular"], vscodeLanguageIds: ["html"], filenames: [], linguistLanguageId: 146 }, { name: "HTML", type: "markup", aceMode: "html", extensions: [".html", ".hta", ".htm", ".html.hl", ".inc", ".xht", ".xhtml"], tmScope: "text.html.basic", aliases: ["xhtml"], codemirrorMode: "htmlmixed", codemirrorMimeType: "text/html", parsers: ["html"], vscodeLanguageIds: ["html"], linguistLanguageId: 146 }, { name: "Lightning Web Components", type: "markup", aceMode: "html", extensions: [], tmScope: "text.html.basic", aliases: ["xhtml"], codemirrorMode: "htmlmixed", codemirrorMimeType: "text/html", parsers: ["lwc"], vscodeLanguageIds: ["html"], filenames: [], linguistLanguageId: 146 }, { name: "MJML", type: "markup", aceMode: "html", extensions: [".mjml"], tmScope: "text.mjml.basic", aliases: ["MJML", "mjml"], codemirrorMode: "htmlmixed", codemirrorMimeType: "text/html", parsers: ["mjml"], filenames: [], vscodeLanguageIds: ["mjml"], linguistLanguageId: 146 }, { name: "Vue", type: "markup", aceMode: "vue", extensions: [".vue"], tmScope: "source.vue", codemirrorMode: "vue", codemirrorMimeType: "text/x-vue", parsers: ["vue"], vscodeLanguageIds: ["vue"], linguistLanguageId: 391 }], tr = { bracketSameLine: { category: "Common", type: "boolean", default: false, description: "Put > of opening tags on the last line instead of on a new line." }, singleAttributePerLine: { category: "Common", type: "boolean", default: false, description: "Enforce single attribute per line in HTML, Vue and JSX." } }, rr = "HTML", to = { bracketSameLine: tr.bracketSameLine, htmlWhitespaceSensitivity: { category: rr, type: "choice", default: "css", description: "How to handle whitespaces in HTML.", choices: [{ value: "css", description: "Respect the default value of CSS display property." }, { value: "strict", description: "Whitespaces are considered sensitive." }, { value: "ignore", description: "Whitespaces are considered insensitive." }] }, singleAttributePerLine: tr.singleAttributePerLine, vueIndentScriptAndStyle: { category: rr, type: "boolean", default: false, description: "Indent script and style tags in Vue files." } }, ro = to, Zr = {};
ur(Zr, { angular: () => Bo, html: () => Do, lwc: () => Oo, mjml: () => No, vue: () => Lo });
function no(e, t) {
  let r = new SyntaxError(e + " (" + t.loc.start.line + ":" + t.loc.start.column + ")");
  return Object.assign(r, t);
}
var ao = no, io = { canSelfClose: true, normalizeTagName: false, normalizeAttributeName: false, allowHtmComponentClosingTags: false, isTagNameCaseSensitive: false, shouldParseFrontMatter: true };
function en(e) {
  return { ...io, ...e };
}
function tn(e) {
...
var Ze = /* @__PURE__ */ new Map([["*", /* @__PURE__ */ new Set(["accesskey", "autocapitalize", "autocorrect", "autofocus", "class", "contenteditable", "dir", "draggable", "enterkeyhint", "exportparts", "hidden", "id", "inert", "inputmode", "is", "itemid", "itemprop", "itemref", "itemscope", "itemtype", "lang", "nonce", "part", "popover", "slot", "spellcheck", "style", "tabindex", "title", "translate", "writingsuggestions"])], ["a", /* @__PURE__ */ new Set(["charset", "coords", "download", "href", "hreflang", "name", "ping", "referrerpolicy", "rel", "rev", "shape", "target", "type"])], ["applet", /* @__PURE__ */ new Set(["align", "alt", "archive", "code", "codebase", "height", "hspace", "name", "object", "vspace", "width"])], ["area", /* @__PURE__ */ new Set(["alt", "coords", "download", "href", "hreflang", "nohref", "ping", "referrerpolicy", "rel", "shape", "target", "type"])], ["audio", /* @__PURE__ */ new Set(["autoplay", "controls", "crossorigin", "loop", "muted", "preload", "src"])], ["base", /* @__PURE__ */ new Set(["href", "target"])], ["basefont", /* @__PURE__ */ new Set(["color", "face", "size"])], ["blockquote", /* @__PURE__ */ new Set(["cite"])], ["body", /* @__PURE__ */ new Set(["alink", "background", "bgcolor", "link", "text", "vlink"])], ["br", /* @__PURE__ */ new Set(["clear"])], ["button", /* @__PURE__ */ new Set(["command", "commandfor", "disabled", "form", "formaction", "formenctype", "formmethod", "formnovalidate", "formtarget", "name", "popovertarget", "popovertargetaction", "type", "value"])], ["canvas", /* @__PURE__ */ new Set(["height", "width"])], ["caption", /* @__PURE__ */ new Set(["align"])], ["col", /* @__PURE__ */ new Set(["align", "char", "charoff", "span", "valign", "width"])], ["colgroup", /* @__PURE__ */ new Set(["align", "char", "charoff", "span", "valign", "width"])], ["data", /* @__PURE__ */ new Set(["value"])], ["del", /* @__PURE__ */ new Set(["cite", "datetime"])], ["details", /* @__PURE__ */ new Set(["name", "open"])], ["dialog", /* @__PURE__ */ new Set(["closedby", "open"])], ["dir", /* @__PURE__ */ new Set(["compact"])], ["div", /* @__PURE__ */ new Set(["align"])], ["dl", /* @__PURE__ */ new Set(["compact"])], ["embed", /* @__PURE__ */ new Set(["height", "src", "type", "width"])], ["fieldset", /* @__PURE__ */ new Set(["disabled", "form", "name"])], ["font", /* @__PURE__ */ new Set(["color", "face", "size"])], ["form", /* @__PURE__ */ new Set(["accept", "accept-charset", "action", "autocomplete", "enctype", "method", "name", "novalidate", "target"])], ["frame", /* @__PURE__ */ new Set(["frameborder", "longdesc", "marginheight", "marginwidth", "name", "noresize", "scrolling", "src"])], ["frameset", /* @__PURE__ */ new Set(["cols", "rows"])], ["h1", /* @__PURE__ */ new Set(["align"])], ["h2", /* @__PURE__ */ new Set(["align"])], ["h3", /* @__PURE__ */ new Set(["align"])], ["h4", /* @__PURE__ */ new Set(["align"])], ["h5", /* @__PURE__ */ new Set(["align"])], ["h6", /* @__PURE__ */ new Set(["align"])], ["head", /* @__PURE__ */ new Set(["profile"])], ["hr", /* @__PURE__ */ new Set(["align", "noshade", "size", "width"])], ["html", /* @__PURE__ */ new Set(["manifest", "version"])], ["iframe", /* @__PURE__ */ new Set(["align", "allow", "allowfullscreen", "allowpaymentrequest", "allowusermedia", "frameborder", "height", "loading", "longdesc", "marginheight", "marginwidth", "name", "referrerpolicy", "sandbox", "scrolling", "src", "srcdoc", "width"])], ["img", /* @__PURE__ */ new Set(["align", "alt", "border", "crossorigin", "decoding", "fetchpriority", "height", "hspace", "ismap", "loading", "longdesc", "name", "referrerpolicy", "sizes", "src", "srcset", "usemap", "vspace", "width"])], ["input", /* @__PURE__ */ new Set(["accept", "align", "alpha", "alt", "autocomplete", "checked", "colorspace", "dirname", "disabled", "form", "formaction", "formenctype", "formmethod", "formnovalidate", "formtarget", "height", "ismap", "list", "max", "maxlength", "min", "minlength", "multiple", "name", "pattern", "placeholder", "popovertarget", "popovertargetaction", "readonly", "required", "size", "src", "step", "type", "usemap", "value", "width"])], ["ins", /* @__PURE__ */ new Set(["cite", "datetime"])], ["isindex", /* @__PURE__ */ new Set(["prompt"])], ["label", /* @__PURE__ */ new Set(["for", "form"])], ["legend", /* @__PURE__ */ new Set(["align"])], ["li", /* @__PURE__ */ new Set(["type", "value"])], ["link", /* @__PURE__ */ new Set(["as", "blocking", "charset", "color", "crossorigin", "disabled", "fetchpriority", "href", "hreflang", "imagesizes", "imagesrcset", "integrity", "media", "referrerpolicy", "rel", "rev", "sizes", "target", "type"])], ["map", /* @__PURE__ */ new Set(["name"])], ["menu", /* @__PURE__ */ new Set(["compact"])], ["meta", /* @__PURE__ */ new Set(["charset", "content", "http-equiv", "media", "name", "scheme"])], ["meter", /* @__PURE__ */ new Set(["high", "low", "max", "min", "optimum", "value"])], ["object", /* @__PURE__ */ new Set(["align", "archive", "border", "classid", "codebase", "codetype", "data", "declare", "form", "height", "hspace", "name", "standby", "type", "typemustmatch", "usemap", "vspace", "width"])], ["ol", /* @__PURE__ */ new Set(["compact", "reversed", "start", "type"])], ["optgroup", /* @__PURE__ */ new Set(["disabled", "label"])], ["option", /* @__PURE__ */ new Set(["disabled", "label", "selected", "value"])], ["output", /* @__PURE__ */ new Set(["for", "form", "name"])], ["p", /* @__PURE__ */ new Set(["align"])], ["param", /* @__PURE__ */ new Set(["name", "type", "value", "valuetype"])], ["pre", /* @__PURE__ */ new Set(["width"])], ["progress", /* @__PURE__ */ new Set(["max", "value"])], ["q", /* @__PURE__ */ new Set(["cite"])], ["script", /* @__PURE__ */ new Set(["async", "blocking", "charset", "crossorigin", "defer", "fetchpriority", "integrity", "language", "nomodule", "referrerpolicy", "src", "type"])], ["select", /* @__PURE__ */ new Set(["autocomplete", "disabled", "form", "multiple", "name", "required", "size"])], ["slot", /* @__PURE__ */ new Set(["name"])], ["source", /* @__PURE__ */ new Set(["height", "media", "sizes", "src", "srcset", "type", "width"])], ["style", /* @__PURE__ */ new Set(["blocking", "media", "type"])], ["table", /* @__PURE__ */ new Set(["align", "bgcolor", "border", "cellpadding", "cellspacing", "frame", "rules", "summary", "width"])], ["tbody", /* @__PURE__ */ new Set(["align", "char", "charoff", "valign"])], ["td", /* @__PURE__ */ new Set(["abbr", "align", "axis", "bgcolor", "char", "charoff", "colspan", "headers", "height", "nowrap", "rowspan", "scope", "valign", "width"])], ["template", /* @__PURE__ */ new Set(["shadowrootclonable", "shadowrootcustomelementregistry", "shadowrootdelegatesfocus", "shadowrootmode", "shadowrootserializable"])], ["textarea", /* @__PURE__ */ new Set(["autocomplete", "cols", "dirname", "disabled", "form", "maxlength", "minlength", "name", "placeholder", "readonly", "required", "rows", "wrap"])], ["tfoot", /* @__PURE__ */ new Set(["align", "char", "charoff", "valign"])], ["th", /* @__PURE__ */ new Set(["abbr", "align", "axis", "bgcolor", "char", "charoff", "colspan", "headers", "height", "nowrap", "rowspan", "scope", "valign", "width"])], ["thead", /* @__PURE__ */ new Set(["align", "char", "charoff", "valign"])], ["time", /* @__PURE__ */ new Set(["datetime"])], ["tr", /* @__PURE__ */ new Set(["align", "bgcolor", "char", "charoff", "valign"])], ["track", /* @__PURE__ */ new Set(["default", "kind", "label", "src", "srclang"])], ["ul", /* @__PURE__ */ new Set(["compact", "type"])], ["video", /* @__PURE__ */ new Set(["autoplay", "controls", "crossorigin", "height", "loop", "muted", "playsinline", "poster", "preload", "src", "width"])]]), so = /* @__PURE__ */ new Set(["a", "abbr", "acronym", "address", "applet", "area", "article", "aside", "audio", "b", "base", "basefont", "bdi", "bdo", "bgsound", "big", "blink", "blockquote", "body", "br", "button", "canvas", "caption", "center", "cite", "code", "col", "colgroup", "command", "content", "data", "datalist", "dd", "del", "details", "dfn", "dialog", "dir", "div", "dl", "dt", "em", "embed", "fencedframe", "fieldset", "figcaption", "figure", "font", "footer", "form", "frame", "frameset", "h1", "h2", "h3", "h4", "h5", "h6", "head", "header", "hgroup", "hr", "html", "i", "iframe", "image", "img", "input", "ins", "isindex", "kbd", "keygen", "label", "legend", "li", "link", "listing", "main", "map", "mark", "marquee", "math", "menu", "menuitem", "meta", "meter", "multicol", "nav", "nextid", "nobr", "noembed", "noframes", "noscript", "object", "ol", "optgroup", "option", "output", "p", "param", "picture", "plaintext", "pre", "progress", "q", "rb", "rbc", "rp", "rt", "rtc", "ruby", "s", "samp", "script", "search", "section", "select", "selectedcontent", "shadow", "slot", "small", "source", "spacer", "span", "strike", "strong", "style", "sub", "summary", "sup", "svg", "table", "tbody", "td", "template", "textarea", "tfoot", "th", "thead", "time", "title", "tr", "track", "tt", "u", "ul", "var", "video", "wbr", "xmp"]), Fe = { attrs: true, children: true, cases: true, expression: true }, nr = /* @__PURE__ */ new Set(["parent"]), Y, ut, lt, oo = class pe {
  ...
  map(t) {
    ...
    for (let n in Fe) {
      let a = this[n];
      if (a) {
        let i = lo(a, (s) => s.map(t));
        r !== a && (r || (r = new pe({ parent: this.parent })), r.setProperty(n, i));
      }
    }
  ...
  createChild(t) {
    let r = t instanceof pe ? t.clone() : new pe(t);
...
Y = /* @__PURE__ */ new WeakSet(), ut = function() {
...
var co = [{ regex: /^(?<openingTagSuffix>\[if(?<condition>[^\]]*)\]>)(?<data>.*?)<!\s*\[endif\]$/su, parse: ho }, { regex: /^\[if(?<condition>[^\]]*)\]><!$/u, parse: mo }, { regex: /^<!\s*\[endif\]$/u, parse: go }];
function po(e, t) {
  if (e.value) for (let { regex: r, parse: n } of co) {
...
function ho(e, t, r) {
  let { openingTagSuffix: n, condition: a, data: i } = t.groups, s = 4 + n.length, o = e.sourceSpan.start.moveBy(s), l = o.moveBy(i.length), [c, p] = (() => {
    try {
      return [true, r(i, o).children];
    } catch {
      return [false, [{ kind: "text", value: i, sourceSpan: new d(o, l) }]];
    }
  })();
...
var fo = class extends fs {
  ...
  visit(e, { parseOptions: t }) {
    So(e), Ao(e, t), ko(e, t), To(e);
  }
};
function _o(e, t, r, n) {
  Kr(new fo(), e.children, { parseOptions: r }), t && e.children.unshift(t);
  let a = new uo(e);
  return a.walk((i) => {
    if (i.kind === "comment") {
      let s = po(i, n);
...
function Co(e) {
  if (e.kind === "block") {
    ...
    e.parameters = { kind: "angularControlFlowBlockParameters", children: e.parameters, sourceSpan: new d(e.parameters[0].sourceSpan.start, Q(0, e.parameters, -1).sourceSpan.end) };
  }
}
function Eo(e) {
...
function Ao(e, t) {
  if (e.kind === "element") {
    ...
    !e.namespace || e.namespace === r.implicitNamespacePrefix || Ae(e) ? e.tagDefinition = r : e.tagDefinition = rt("");
  }
}
function To(e) {
...
function ko(e, t) {
  if (e.kind === "element" && (t.normalizeTagName && (!e.namespace || e.namespace === e.tagDefinition.implicitNamespacePrefix || Ae(e)) && (e.name = ar(e.name, (r) => so.has(r))), t.normalizeAttributeName)) for (let r of e.attrs) r.namespace || (r.name = ar(r.name, (n) => Ze.has(e.name) && (Ze.get("*").has(n) || Ze.get(e.name).has(n))));
}
function rn(e, t) {
...
function ct(e) {
  ...
  throw ao(t, { loc: { start: { line: r.line + 1, column: r.col + 1 }, end: { line: n.line + 1, column: n.col + 1 } }, cause: e });
}
function yo(e, t, r, n, a, i) {
  let { offset: s } = n, o = b(0, t.slice(0, s), /[^\n]/gu, " ") + r, l = nn(o, e, { ...a, shouldParseFrontMatter: false }, i);
  l.sourceSpan = new d(n, Q(0, l.children, -1).sourceSpan.end);
  let c = l.children[0];
...
function nn(e, t, r, n = {}) {
  ...
  return _o(C, g, c, (h, f) => yo(t, e, h, f, c, n));
}
var Dt = en({ name: "html", normalizeTagName: true, normalizeAttributeName: true, allowHtmComponentClosingTags: true });
function ye(e) {
  let t = en(e), r = t.name === "vue" ? bo : rn;
  return { parse: (n, a) => nn(n, r, t, a), hasPragma: Hi, hasIgnorePragma: Vi, astFormat: "html", locStart: ke, locEnd: Ue };
}
var Do = ye(Dt), xo = /* @__PURE__ */ new Set(["mj-style", "mj-raw"]), No = ye({ ...Dt, name: "mjml", shouldParseAsRawText: (e) => xo.has(e) }), Bo = ye({ name: "angular", tokenizeAngularBlocks: true, tokenizeAngularLetDeclaration: true }), Lo = ye({ name: "vue", isTagNameCaseSensitive: true, shouldParseAsRawText(e, t, r, n) {
  return e.toLowerCase() !== "html" && !r && (e !== "template" || n.some(({ name: a, value: i }) => a === "lang" && i !== "html" && i !== "" && i !== void 0));
} }), Oo = ye({ name: "lwc", canSelfClose: false }), Fo = { html: Zs };
export {
  un as default,
  eo as languages,
  ro as options,
