import { r as n, j as e, d as v } from "./index-kvHMSlMz.js";
import { R as w } from "./RelatedTools-MRR-Qda3.js";
import { T as j } from "./ToolLayout-oJb9wW2S.js";
import { u as P } from "./index-DLj2mJNx.js";
import { P as D } from "./PDFButton-DbqzjGkP.js";
import "./UPNG-YrU8YmuG.js";
import "./index-DCxsHD6U.js";
import { F as k } from "./FileSaver.min-u48MqOKk.js";
import { g as a } from "./tools-a9iFm4Dg.js";
import { D as p } from "./download-CwTTEu6n.js";
import { S as F } from "./shield-DUetJzrR.js";
import "./_commonjs-dynamic-modules-TDtrdbi3.js";
import "./___vite-browser-external_commonjs-proxy-l9cRvqQv.js";
  ...
  const [s, l] = n.useState(null), [t, m] = n.useState(""), [i, d] = n.useState(false), u = async () => {
    if (!(!s || !t)) {
      ...
      try {
        ...
        console.error(r), ((r == null ? void 0 : r.message) || "").toLowerCase().includes("invalid characters") ? alert("Your password contains unsupported characters. Please use only standard Latin letters, numbers, and common symbols.") : alert("Failed to protect PDF. Please try a different file.");
      } finally {
        d(false);
      }
    }
